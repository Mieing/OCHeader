@class AWESearchEventDispather, AWESearchCoverTagView, NSDictionary, NSString, AWESearchCoverTagComponentModel, UIView;
@protocol AWESearchContainerProtocol, AWESearchComponentProtocol;

@interface AWESearchCoverTagComponent : AWESearchComponent <AWESearchCoverTagComponentProvider>

@property (retain, nonatomic) UIView *contentView;
@property (retain, nonatomic) AWESearchCoverTagView *tagView;
