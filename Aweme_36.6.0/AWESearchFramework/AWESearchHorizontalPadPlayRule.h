...
@interface AWESearchHorizontalPadPlayRule : NSObject <AWESearchAutoPlayRuleProtocol>
...
@property (weak, nonatomic) UIView<AWESearchAutoPlayCardProtocol> *currentActiveViewInWaterFallLayout;
