@class AWESearchEventDispather, AWESearchBottomInteractorModel, AWESearchBottomInteractorView, NSDictionary, NSString, NSMutableArray;
@protocol AWESearchContainerProtocol, AWESearchComponentProtocol;

@interface AWESearchBottomInteractorComponent : AWESearchComponent <AWESearchBottomInteractorComponentProvider>

@property (retain, nonatomic) AWESearchBottomInteractorView *contentView;
