@class AWESearchEventDispather, AWESearchRightTopInfoModel, UIImageView, NSDictionary, NSString;
@protocol AWESearchContainerProtocol, AWESearchComponentProtocol;

@interface AWESearchRightTopInfoComponent : AWESearchComponent <AWESearchRightTopInfoComponentProvider>

@property (retain, nonatomic) AWESearchRightTopInfoModel *infoModel;
