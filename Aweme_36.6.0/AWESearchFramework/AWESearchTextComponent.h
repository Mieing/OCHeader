@class AWESearchEventDispather, NSString, NSDictionary, UILabel, AWESearchTextComponentModel, UIView;
@protocol AWESearchContainerProtocol, AWESearchComponentProtocol;

@interface AWESearchTextComponent : AWESearchComponent <AWESearchTextComponentProvider>

@property (retain, nonatomic) UIView *contentView;
@property (retain, nonatomic) UILabel *textLabel;
@property (retain, nonatomic) AWESearchTextComponentModel *model;
