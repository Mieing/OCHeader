@class NSString, AWEGeneralSearchVideoCardModel, AWESearchVideoCardAuthorInfoView, UIView, AWEAwemeModel;

@interface AWESearchVideoCardAuthorInfoComponent : AWESearchComponent <AWESearchVideoCardAuthorInfoComponentProtocol>

@property (retain, nonatomic) UIView *contentView;
@property (retain, nonatomic) AWESearchVideoCardAuthorInfoView *authorInfoView;
