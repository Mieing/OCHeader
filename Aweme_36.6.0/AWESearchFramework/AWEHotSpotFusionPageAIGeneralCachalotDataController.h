...
@interface AWEHotSpotFusionPageAIGeneralCachalotDataController : AWEGeneralCachalotDataController

@property (retain, nonatomic) UIViewController *hotSpotFusionAIParamsProvider;
