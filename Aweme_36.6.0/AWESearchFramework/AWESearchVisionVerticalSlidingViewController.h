@class NSString, AWESearchScanDataContext, AWESearchVerticalScrollView, NSMutableArray;
@protocol AWESearchVerticalSlidingViewControllerGestureDelegate, AWESearchVerticalSlidingViewControllerDelegate;

@interface AWESearchVisionVerticalSlidingViewController : UIViewController <UIScrollViewDelegate, AWESearchVerticalScrollViewGestureDelegate, AWESearchScanResultChildViewControllerProtocol>
