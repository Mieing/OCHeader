@class NSString, AWEGeneralSearchVideoCardModel, AWEAwemeModel, UIView, AWESearchAlbumHorizontalLayoutController;

@interface AWESearchAlbumHorizontalComponent : AWESearchComponent <AWESearchAlbumHorizontalComponentProtocol, AWEZoomTransitionOuterContextProvider, AWESearchAlbumHorizontalLayoutControllerDelegate>

@property (retain, nonatomic) UIView *contentView;
@property (retain, nonatomic) AWEAwemeModel *model;
@property (retain, nonatomic) AWEGeneralSearchVideoCardModel *bindedModel;
@property (retain, nonatomic) AWESearchAlbumHorizontalLayoutController *albumHorizontalLayoutController;
