@class NSString, AWESearchHotSpotConfigModel, BDXBridgeEventSubscriber, AWETopicRedButtonEntranceView, AWEHotSpotPublishEntranceBaseView;

@interface AWEHotSpotPublishEntranceManager : NSObject <AWEGeneralSearchPublishEntranceManagerProtocol>
...
@property (retain, nonatomic) AWEHotSpotPublishEntranceBaseView *entranceView;
@property (nonatomic) BOOL topicEntranceViewHasFold;
@property (nonatomic) BOOL hotSearchButtonIsHide;
@property (retain, nonatomic) AWETopicRedButtonEntranceView *foldIconView;
