@class AWESearchAIGCService, NSString;
...
@property (copy, nonatomic) NSString *containerValue;
@property (nonatomic) BOOL enableFullPage;
...
- (id)AIGCResultContextWithViewModel:(id)a0;
