@class AWESearchEventDispather, NSString, UIImageView, NSDictionary, UILabel, UIView;
@protocol AWESearchContainerProtocol, AWESearchComponentProtocol;

@interface AWESearchLikeComponent : AWESearchComponent <AWESearchLikeComponentProvider>
