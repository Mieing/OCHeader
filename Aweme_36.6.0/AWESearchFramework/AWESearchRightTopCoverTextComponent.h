@class AWESearchRightTopCoverTextComponentModel, AWESearchEventDispather, AWESearchRightTopCoverTextView, NSDictionary, UIView, NSString;
@protocol AWESearchContainerProtocol, AWESearchComponentProtocol;

@interface AWESearchRightTopCoverTextComponent : AWESearchComponent <AWESearchRightTopCoverTextComponentProvider>

@property (retain, nonatomic) UIView *contentView;
@property (retain, nonatomic) AWESearchRightTopCoverTextComponentModel *coverTextModel;
@property (retain, nonatomic) AWESearchRightTopCoverTextView *coverTextView;
