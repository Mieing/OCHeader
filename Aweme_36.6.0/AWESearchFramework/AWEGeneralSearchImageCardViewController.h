@class AWEGeneralSearchVideoImageView, NSString, UIViewController;
@protocol AWESearchVideoRecommendedWordViewProtocol, AWEModernFeedCellContext, AWEModernFeedCellFrameProtocol;

@interface AWEGeneralSearchImageCardViewController : UIViewController <AWEModernFeedCellControllerProtocol, AWEGeneralSearchVideoCardContext, AWESearchModernVideoProtocol>

@property (retain, nonatomic) AWEGeneralSearchVideoImageView *videoCardView;
...
- (void)selectPreferAlbumBitRate:(id)a0;
