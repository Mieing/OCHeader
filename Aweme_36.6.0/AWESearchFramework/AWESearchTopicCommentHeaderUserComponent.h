@class AWESearchEventDispather, NSString, NSDictionary, AWEGeneralSearchModel, UIView, AWESearchTopicCommentHeaderUserView;
@protocol AWESearchContainerProtocol, AWESearchComponentProtocol;

@interface AWESearchTopicCommentHeaderUserComponent : AWESearchComponent <AWESearchTopicCommentHeaderUserComponentProtocol, AWESearchComponentBusinessProtocol>

@property (retain, nonatomic) UIView *contentView;
@property (retain, nonatomic) AWESearchTopicCommentHeaderUserView *userView;
