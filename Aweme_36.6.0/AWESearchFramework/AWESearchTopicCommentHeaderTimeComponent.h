@class AWESearchEventDispather, NSString, NSDictionary, AWEGeneralSearchModel, UILabel, UIView;
@protocol AWESearchContainerProtocol, AWESearchComponentProtocol;

@interface AWESearchTopicCommentHeaderTimeComponent : AWESearchComponent <AWESearchTopicCommentHeaderTimeComponentProtocol, AWESearchComponentBusinessProtocol>
