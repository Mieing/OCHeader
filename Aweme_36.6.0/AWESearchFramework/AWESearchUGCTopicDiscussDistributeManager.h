...
@protocol AWESearchUGCTopicDiscussDistributeManagerDelegate;

@interface AWESearchUGCTopicDiscussDistributeManager : NSObject
...
@property (weak, nonatomic) id<AWESearchUGCTopicDiscussDistributeManagerDelegate> delegate;
