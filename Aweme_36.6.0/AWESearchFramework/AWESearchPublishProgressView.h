@class UIViewController, AWESearchTaskProgressView, NSString, UITapGestureRecognizer;
@protocol AWEPublishCancelDialogProtocol;

@interface AWESearchPublishProgressView : UIView <AWEPublishTaskMessage, AWEPublishCancelDialogDelegate>

@property (retain, nonatomic) AWESearchTaskProgressView *currentTaskView;
@property (retain, nonatomic) AWESearchTaskProgressView *nextTaskView;
