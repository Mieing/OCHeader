@class NSString, AWEAwemeModel, UIView, AWEFeedGoodProductsCardCellViewController, UIViewController;
@protocol UIScrollViewDelegate;

@interface AWEFeedGoodProductsCardTableViewCell : UITableViewCell <AWEFeedTableViewCellProtocol>

@property (retain, nonatomic) AWEFeedGoodProductsCardCellViewController *viewController;
