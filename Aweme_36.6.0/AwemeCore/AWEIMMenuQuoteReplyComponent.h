...
@interface AWEIMMenuQuoteReplyComponent : AWEIMComponentBase <AWEIMMessageListMenuProtocol>
...
- (BOOL)p_showQuoteReplyMenuItem:(id)a0;
- (BOOL)shouldBlockByAIReverseWithMsgContext:(id)a0;
