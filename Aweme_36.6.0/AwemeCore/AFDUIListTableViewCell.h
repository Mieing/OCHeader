@class UIView, NSArray, AFDUIListCellActionButton, UIImageView, UIButton, AWEUserNameLabel, MASConstraint, UILabel, UIColor;

@interface AFDUIListTableViewCell : UITableViewCell
...
@property (retain, nonatomic) AFDUIListCellActionButton *actionButton;
...
- (void)configContentViewColor:(id)a0;
