...
@interface DTURLRequestOperationMXXTIY : NSOperation <NSURLConnectionDataDelegate>
...
- (void)_flex_swizzle_dbf24c88_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_dfe14300_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_2f776a15_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_85ca117f_connection:(id)a0 didReceiveData:(id)a1;
