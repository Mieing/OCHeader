@class IESLLPOICityDetailOldFeedComponentView, NSString, AWEAwemeModel;

@interface IESLLPOICityDetailOldFeedComponentViewModel : LLDitoComponentViewModel <IESLLPOISyncFeedExtensionGetModelProtocol, IESLLPOIDetailNGViewModelZoomTransitionProtocol, IESLLPOIDetailNGListCellProtocol>

@property (retain, nonatomic) AWEAwemeModel *aweme;
@property (weak, nonatomic) IESLLPOICityDetailOldFeedComponentView *cell;
