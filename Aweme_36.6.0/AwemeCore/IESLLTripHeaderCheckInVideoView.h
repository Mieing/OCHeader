@class UIImageView, IESLLTripHeaderCheckInAvatars, UILabel, UIView;

@interface IESLLTripHeaderCheckInVideoView : UIView

@property (retain, nonatomic) IESLLTripHeaderCheckInAvatars *iconGroup;
