@class AWEGDUserBasicInfo, NSString, NSArray;

@interface AWEGDUserInfo : MTLModel <MTLJSONSerializing>

@property (retain, nonatomic) AWEGDUserBasicInfo *user_basic_info;
