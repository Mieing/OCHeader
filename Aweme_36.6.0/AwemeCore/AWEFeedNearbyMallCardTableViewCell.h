@class UIViewController, NSString, AWEAwemeModel, UIView, AWEFeedNearbyMallCardCellViewController;
@protocol UIScrollViewDelegate;

@interface AWEFeedNearbyMallCardTableViewCell : UITableViewCell <AWEFeedTableViewCellProtocol>

@property (retain, nonatomic) AWEFeedNearbyMallCardCellViewController *viewController;
