@class IESLLTempoAnimationContext, NSString, IESLLTempoContext, UIView, AWEPOITempoHotelAddressInfoView, NSMutableArray;
@protocol IESLLTempoNodeProtocol, IESLLTempoWidgetProtocol;

@interface AWEPOITempoHotelAddressInfoWidget : IESLLTempoBaseWidget <IESLLTempoWidgetProtocol>

@property (weak, nonatomic) AWEPOITempoHotelAddressInfoView *nodeView;
