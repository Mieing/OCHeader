...
@interface IESLiveECGoodsPreloadRequestImpl : IESLivePreloadRequestBaseImpl <IESLiveECGoodsPreloadRequest>
...
@property (nonatomic) BOOL shouldAutoOpenGoodsDetail;
@property (nonatomic) BOOL shouldAutoOpenGoodsOrder;
...
- (BOOL)shouldAutoOpenGoodsDetailOrOrder;
- (void).cxx_destruct;
- (id)actionType;
- (id)storageManager;
- (id)roomID;
