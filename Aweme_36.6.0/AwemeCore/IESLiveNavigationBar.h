@class UIColor, NSString, UIFont, UIImage, UILabel, UIView, UIButton;

@interface IESLiveNavigationBar : UIView <PuzzleNavigationBarProtocol>
...
- (void)setLeftButtonActionHandler:(id /* block */)a0;
- (void)setRightButtonActionHandler:(id /* block */)a0;
- (void).cxx_destruct;
- (void)commonInit;
