@class AWEGrouponResourceOfPopupModel, NSMutableArray;

@interface AWEGrouponDialogLynxContainer : NSObject

@property (retain, nonatomic) AWEGrouponResourceOfPopupModel *lastModel;
