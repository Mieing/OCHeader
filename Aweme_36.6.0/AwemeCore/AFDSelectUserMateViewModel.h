...
@interface AFDSelectUserMateViewModel : NSObject <AFDSelectUserViewModelProtocol>

@property (nonatomic) BOOL isRequestOnAir;
@property (retain, nonatomic) NSMutableArray *topSelectedCellViewModels;
@property (retain, nonatomic) NSMutableArray *mateCellViewModels;
...
- (BOOL)isEmptyData;
- (void)p_fetchMateDataWithCompletion:(id /* block */)a0;
...
- (void)recoverUserSelectForFriends;
- (void)addDataSourceWithDataList:(id)a0 completion:(id /* block */)a1;
