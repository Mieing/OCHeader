@class AWEIMShapeView, AWEIMMessage, NSString, UIView, YYLabel;

@interface AWEIMTextLinkMessageTableViewCell : AWEIMUserMessageTableViewCell <AWEIMGradientBubbleProtocol>

@property (retain, nonatomic) AWEIMShapeView *bubbleView;
...
+ (id)textLayoutWithMessage:(id)a0;
+ (id)identifier;
