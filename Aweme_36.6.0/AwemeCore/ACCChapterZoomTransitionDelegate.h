...
@protocol DVEPreviewTransitionContextProvider, ACCChapterZoomTransitionOuterContextProvider, UIViewControllerContextTransitioning;

@interface ACCChapterZoomTransitionDelegate : NSObject <UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate, DVEPreviewTransitionDelegateProtocol>
