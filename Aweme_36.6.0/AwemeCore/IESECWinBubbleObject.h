@class NSString, IESECWinHeaderBubbleModel;

@interface IESECWinBubbleObject : NSObject <IGListDiffable, IESECWinFeedFlowLayoutProtocol>

@property (nonatomic) struct UIEdgeInsets { double top; double left; double bottom; double right; } edge;
@property (retain, nonatomic) IESECWinHeaderBubbleModel *bubble;
