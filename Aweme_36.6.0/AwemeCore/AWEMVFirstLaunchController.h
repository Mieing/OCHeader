...
@interface AWEMVFirstLaunchController : AWEDCFeedBaseController <AWEMVFirstLaunchControllerProtocol, AWEMVDataPluginProtocol>
...
- (void)setupObserverForBackgroundLaunch;
- (void).cxx_destruct;
