...
+ (BOOL)anchorCanOpenGame:(id)a0;
+ (BOOL)anchorCanOpenGame:(id)a0 isGame:(BOOL)a1;
+ (BOOL)nativeGameOpenCameraCapture;
+ (id)syncVideoStreamIMConfig;
+ (BOOL)liveEnableShareScreenForNativeAppInVideoChatRoom:(id)a0;
+ (BOOL)enableInteractiveShowOptimize;
...
+ (BOOL)liveEnableCommonCastScreenForNativeAppInSingleVideoRoom:(id)a0;
