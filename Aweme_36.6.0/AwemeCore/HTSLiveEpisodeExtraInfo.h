@class HTSLiveEpisodePreviewBottom, HTSLiveVSGiftPannel, HTSLiveVSLinkInfo, NSMutableArray, NSString, HTSLiveWatchInfo, HTSLiveEpisodeMod, HTSLiveEpisodePremierePlay, HTSLiveVSBar, HTSLiveVSPremiereToast, NSMutableDictionary, HTSLiveImage, HTSLiveMainCameraMatchInfo, HTSLiveSharePosterInfo, HTSLiveVSPannelIcon, HTSLiveTitleIcon, GPBInt32ObjectDictionary, HTSLiveVSConfigDrawer, HTSLiveVSItemComment, HTSLiveMultiTab, HTSLiveVSWatermark, HTSLiveCommentConfig, HTSLiveVSCameraInfo, HTSLiveMatchRoomInfo, HTSLiveEpisodePreviewImage, HTSLiveMultiCameraBasicInfo;
...
@property (retain, nonatomic) NSMutableDictionary *privilegeInfoV2;
@property (readonly, nonatomic) unsigned long long privilegeInfoV2_Count;
