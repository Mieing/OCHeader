@class NSArray, UICollectionView, NSMutableSet, AWEECOMIMPageTrackUtil, NSString;

@interface AWEECOMIMMoreView : UIView <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>

@property (retain, nonatomic) UICollectionView *collectionView;
@property (copy, nonatomic) NSArray *items;
@property (retain, nonatomic) NSMutableSet *didTrackViewEventItemTitleSet;
