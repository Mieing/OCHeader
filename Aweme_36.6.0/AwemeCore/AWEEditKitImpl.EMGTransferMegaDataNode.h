...
@interface AWEEditKitImpl.EMGTransferMegaDataNode : NSObject <AEKEditMediaGenreTransferNode> {
    void /* unknown type, empty encoding */ context;
    void /* unknown type, empty encoding */ singleMegaNode;
    void /* unknown type, empty encoding */ multiMegaNode;
