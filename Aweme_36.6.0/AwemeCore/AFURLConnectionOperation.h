...
- (void)_flex_swizzle_aef8d54d_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_9ad84529_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_41bb1022_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_45ce7db1_connection:(id)a0 didReceiveData:(id)a1;
- (id)_flex_swizzle_f8ba8b11_connection:(id)a0 willSendRequest:(id)a1 redirectResponse:(id)a2;
