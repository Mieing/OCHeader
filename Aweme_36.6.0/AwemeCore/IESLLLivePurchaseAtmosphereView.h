@class CAGradientLayer, NSArray, IESLLLivePurchaseAtmosphereConfig, IESLLLivePurchaseAtmosphereViewModel, UIView, UILabel, BDImageView;
...
@property (retain, nonatomic) IESLLLivePurchaseAtmosphereConfig *config;
@property (retain, nonatomic) IESLLLivePurchaseAtmosphereViewModel *viewModel;
@property (retain, nonatomic) IESLLLivePurchaseAtmosphereViewModel *waitViewModel;
