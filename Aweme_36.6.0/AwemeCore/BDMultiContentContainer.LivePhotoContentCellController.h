@interface BDMultiContentContainer.LivePhotoContentCellController : BDMultiContentContainer.BaseDefaultContentCellController <BDMultiContentContainer.BaseDefaultContentZoomDelegate> {
