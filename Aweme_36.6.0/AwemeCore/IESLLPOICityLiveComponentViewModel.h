@class NSString, NSArray, IESLLPOICityLiveComponentView, AWEAwemeModel;

@interface IESLLPOICityLiveComponentViewModel : LLDitoComponentViewModel <AWEPOIDetailNGAutoPlayUtilObjectProtocol, IESLLPOISyncFeedExtensionGetModelProtocol, IESLLPOIDetailNGViewModelZoomTransitionProtocol>
...
@property (weak, nonatomic) IESLLPOICityLiveComponentView *cell;
