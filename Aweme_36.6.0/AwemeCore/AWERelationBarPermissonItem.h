...
@interface AWERelationBarPermissonItem : NSObject <AWEAfterPublishAdvanceSettingItemProtocol>
...
- (void)postDownloadPermissionSetting:(id)a0 withCompletion:(id /* block */)a1;
- (void).cxx_destruct;
