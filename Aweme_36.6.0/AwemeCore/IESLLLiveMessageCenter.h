@class NSMutableDictionary, IESLLLiveDataCenterHandler, BDXBridgeEventSubscriber, NSString, NSMutableArray;
@protocol NSLocking;

@interface IESLLLiveMessageCenter : NSObject <IESLLLiveMessageHandler, IESLLLiveMessageCenterProtocol>

@property (retain, nonatomic) IESLLLiveDataCenterHandler *dataCenterHandler;
