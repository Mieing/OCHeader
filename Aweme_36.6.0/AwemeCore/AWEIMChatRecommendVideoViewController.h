@class AWEIMHalfScreenContainerViewController, NSString, AWEIMEmoticonLoadingView, AWEIMChatRecommendVideoContentView, AWEIMChatRecommendVideoContext, AWEIMChatRecommendVideoTitleView;
