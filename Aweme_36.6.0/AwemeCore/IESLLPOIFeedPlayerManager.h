@class NSString;
@protocol IESLLBizPlayVideoProtocol, IESLLPOIFeedPlayerManagerDatasource, IESLLPOIPlayInteractionVCManagerProtocol, IESLLRichContentContainerViewControllerProtocol;

@interface IESLLPOIFeedPlayerManager : NSObject <IESLLPOIFeedPlayerManagerProtocol, IESLLPOIPlayInteractionVCManagerProtocol>
...
@property (weak, nonatomic) id<IESLLPOIFeedPlayerManagerDatasource> datasource;
@property (retain, nonatomic) id<IESLLBizPlayVideoProtocol> feedPlayer;
@property (retain, nonatomic) id<IESLLPOIPlayInteractionVCManagerProtocol> interactionManager;
@property (retain, nonatomic) id<IESLLRichContentContainerViewControllerProtocol> richContentContainer;
