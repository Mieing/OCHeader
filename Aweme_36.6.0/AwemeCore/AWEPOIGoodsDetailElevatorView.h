@class NSArray, AWEPOIGoodsDetailElevatorManger, NSString, UIView, NSMutableArray, DitoComponentViewModel;

@interface AWEPOIGoodsDetailElevatorView : UIView <AWEPOIGoodsDetailElevatorMangerDelegate>
...
@property (retain, nonatomic) AWEPOIGoodsDetailElevatorManger *manager;
