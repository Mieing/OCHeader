@class AWENearbyHalfClosedAction, NSString;

@interface AWENearbyGrouponTransitionManager : NSObject <AWELiveRoomMessage, AWENearbyGrouponZoomOuterContextProvider>
