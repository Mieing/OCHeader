@class NSString, IESLiveNewGiftPanelContext, UIView, IESLiveNewGiftPanelOperationItem;

@interface IESLiveDynamicGiftPanelListItem : NSObject <IESLiveNewGiftPanelItemProtocol>
