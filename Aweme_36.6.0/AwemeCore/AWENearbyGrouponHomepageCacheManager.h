@class AWENearbyGrouponListDataLocalCache;

@interface AWENearbyGrouponHomepageCacheManager : NSObject
...
@property (retain, nonatomic) AWENearbyGrouponListDataLocalCache *grouponListCacheInMem;
