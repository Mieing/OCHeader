...
@interface CAKAlbumZoomTransitionDelegate : NSObject <UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate, CAKAlbumTransitionDelegateProtocol>
...
- (BOOL)p_zoomTransitionExcluded:(id)a0;
