@class UIView, NSString, NSArray, DUXTabBarContainerController, AWEListDataController, DUXBasicSheet, AWEUILoadingView, DUXTabBar, NSMutableArray, DUXButton, UILabel;
