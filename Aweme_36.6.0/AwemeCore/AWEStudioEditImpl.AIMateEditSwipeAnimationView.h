@interface AWEStudioEditImpl.AIMateEditSwipeAnimationView : UIView {
    void /* unknown type, empty encoding */ delegate;
    void /* unknown type, empty encoding */ previewFrame;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_wiperCycleLayer;
