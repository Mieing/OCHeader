@class ACCVideoEditFlowControlViewModel, UIView, NSNumber, DUXActionSheet, NSString, UIImageView, UIButton, AWEStudioEditFlowControlFeatureConfig, NSObject, AFDFrequencyCountRule, UILabel, ACCAnimatedButton;
@protocol ACCEditViewStateProtocol, ACCEditMusicServiceProtocol, ACCMultiStyleAlertProtocol, AWEStudioAIMateEditAIGCTaskPublicAPI, ACCLoadingViewProtocol, ACCEditClipV1ServiceProtocol, ACCVideoEditTipsService, ACCSelectTemplateServiceProtocol, ACCAIUnifyLoadingServiceProtocol, ACCSideslipPropService, ACCNewActionSheetProtocol, ACCStudioShareService, ACCPublishServiceProtocol, ACCEditPublishSettingsServiceProtocol, ACCEditTransitionServiceProtocol, ACCRichTextEditorServiceProtocol, ACCAIImageToLiveEditServiceProtocol, ACCSequenceAlbumChooseFrameServiceProtocol, ACCQuickSaveService, ACCEditScanServiceProtocol, ACCAIGCEffectServiceProtocol, ACCInfoStickerServiceProtocol, ACCVideoEditBottomControlService, ACCStickerServiceProtocol, ACCEditorOneClickFilmService, ACCEditViewContainer, ACCStudioAIMemoriesService, ACCSequenceEditServiceProtocol, ACCQuickFlashStickerServiceProtocol, ACCEditServiceProtocol, AWEStudioAIMateEditFeaturePublicAPI;

@interface ACCVideoEditFlowControlComponent : ACCFeatureComponent <ACCPublishServiceMessage, ACCVideoEditTipsServiceSubscriber, ACCVideoEditBottomControlSubscriber, ACCTouchSensingViewSubscriberProtocol, ACCEditSessionLifeCircleEvent, ACCEditScanServiceSubscriber, ACCVideoEditFlowControlSubscriber, ACCEditViewHolderComponentProtocol, ACCStickerServiceSubscriber, ACCCreativePathMessage, ACCPanelViewDelegate, DUXActionSheetDelegate>
...
@property (retain, nonatomic) AWEStudioEditFlowControlFeatureConfig *featureConfig;
...
@property (retain, nonatomic) AFDFrequencyCountRule *storyPublishButtonPopoverRule;
@property (nonatomic) BOOL hasShowedStoryPublishButtonPopover;
...
@property (retain, nonatomic) DUXActionSheet *gainAIAssetActionSheet;
@property (nonatomic) BOOL isDismissForWidget;
...
- (void)handleResourceValidationFailedNotification:(id)a0;
- (void)handleMemoriesThemeSecondaryEditExitNotification:(id)a0;
- (void)closeForWidget;
- (void)p_handlePublishButtonClickedAction;
...
- (BOOL)p_enableAfterRender;
- (void)p_setBackCoverIfNeeded;
- (void)logNextButton;
...
- (void)aigcBackClickedWithType:(unsigned long long)a0;
- (void)p_aiMateLeaveEditPage;
- (void)beforeSaveDraftUpdateRepoData;
- (id /* block */)getSaveDraftBlock;
...
- (BOOL)p_showAIAssetAlertIfNeeded;
- (id /* block */)p_shortPathAlbumImageAlertConfig;
- (id /* block */)p_AIGCTemplateUnifyAlertConfig;
- (id /* block */)p_AIMateEditAlertConfig;
- (BOOL)backToShootNeedAlert:(BOOL)a0;
- (void)p_cancelSaveToAlbumTaskIfNeeded;
...
- (void)setSlientAnchorIfNeeded:(BOOL)a0;
...
- (void)showDailyPostAIAssetRewardSheet:(id)a0 isAIMV:(BOOL)a1;
- (BOOL)p_shouldStayInRecorder;
- (void)p_saveCurrentDraftThenFinishCreateScene:(id /* block */)a0;
- (void)feedbackForCancelIfNeeded;
...
- (void)p_aiMateTrackExitEditPage:(BOOL)a0;
...
- (void)exitEditPageWithCompletionBlock:(id /* block */)a0;
...
- (void)updateCloseFriendsStoryPublishButtonWithIsCloseFriendsSelected:(BOOL)a0 isFriendsSelected:(BOOL)a1;
- (void)updateFriendsDailyPublishButtonDisplay;
- (void)configPublishButtonIconWithUserAvatar:(id)a0;
- (BOOL)isCoveredForStoryPublishButtonPopoverWithTargetView:(id)a0;
