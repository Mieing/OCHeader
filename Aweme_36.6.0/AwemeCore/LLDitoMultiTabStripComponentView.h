@class NSString, LLDitoMultiTabStripComponentViewModel, UICollectionView, UIView, LLDitoMultiTabDataModel;

@interface LLDitoMultiTabStripComponentView : LLDitoComponentView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, LLDitoMultiTabDelegateProtocol>

@property (weak, nonatomic) LLDitoMultiTabStripComponentViewModel *viewModel;
...
@property (retain, nonatomic) LLDitoMultiTabDataModel *startModel;
