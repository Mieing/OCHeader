@class NLETrack_OC, NSString, AEKTextStickerResource, ACCURS, NSArray, AEKElementDiffableNode, NSDictionary, NLETrackSlot_OC, AEKRenderGeometryImpl, AEKRenderTimeImpl, NLESegmentTextSticker_OC;
@protocol AEKBaseTextStickerExtraData, AEKSimpleTextStickerData, AEKBaseTextStickerExtraOperator;

@interface AEKSimpleTextStickerOperatorImpl : AEKBaseRenderEditor <AEKSimpleTextStickerData, AEKSimpleTextStickerOperator, AEKElementDiffableNode>
...
@property (readonly, nonatomic) id<AEKBaseTextStickerExtraData> extra;
...
@property (readonly, nonatomic) id<AEKSimpleTextStickerData> data;
@property (readonly, nonatomic) id<AEKBaseTextStickerExtraOperator> extraOperator;
