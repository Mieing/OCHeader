@class IESECShopSearchOldHistoryHeader, NSString, UICollectionView, NSMutableArray;
@protocol IESECShopSearchOldHistoryViewDelegate;

@interface IESECShopSearchOldHistoryView : UIView <UICollectionViewDelegate, UICollectionViewDataSource, IESECShopSearchOldHistoryLayoutDelegate>

@property (retain, nonatomic) IESECShopSearchOldHistoryHeader *headerView;
...
@property (weak, nonatomic) id<IESECShopSearchOldHistoryViewDelegate> delegate;
