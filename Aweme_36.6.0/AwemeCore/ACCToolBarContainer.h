@class ACCToolBarSectionFoldView, UIView, NSArray, ACCCameraSubscription, ACCToolBarItemsModel, AWEVideoPublishViewModel, NSString, NSMutableArray, ACCToolBarCommonViewLayout, ACCToolBarContainerConfig;
@protocol ACCBarItemSortDataSource;

@interface ACCToolBarContainer : NSObject <UIGestureRecognizerDelegate, ACCToolBarContainerInterface, ACCToolBarCommonProtocol>
...
+ (struct CGSize { double x0; double x1; })verticalItemSize;
+ (struct CGSize { double x0; double x1; })horizontalItemSize;
