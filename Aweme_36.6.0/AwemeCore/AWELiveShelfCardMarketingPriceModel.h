@class NSString, NSNumber, AWELiveShelfCardMarketingPriceExpressionModel;

@interface AWELiveShelfCardMarketingPriceModel : MTLModel <MTLJSONSerializing>
...
@property (retain, nonatomic) AWELiveShelfCardMarketingPriceExpressionModel *secondPrice;
@property (retain, nonatomic) AWELiveShelfCardMarketingPriceExpressionModel *thirdPrice;
