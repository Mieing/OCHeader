@class UIView, NSString, NSArray, IESLiveLongPressViewModel, NSDictionary, UIButton, NSMutableArray, UICollectionView;

@interface IESLiveLongPressAdDislikePanelCell : UICollectionViewCell <UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)configWithModel:(id)a0 andLongPressView:(id)a1;
