@class UIView, NSString, AWENearbyC2TopAngleMaskView, NSMutableDictionary, AWENearbyHalfScreenAnimation, NSMutableArray, UIViewController, AWENearbyHalfScreenDismissAnimationController, AWENearbyOpenSubPageModel;
@protocol AWENearbyGrouponSubPageViewControllerProtocol, AWENearbySubpageVCDelegate;

@interface AWENearbySubpageVCManager : NSObject <AWENearbyHalfScreenDismissAnimationProvider, AWENearbyGrouponSubPageContianerHelper, AWERouterDelegate, AWENearbyC2FeedEventMessage>
...
@property (retain, nonatomic) AWENearbyC2TopAngleMaskView *topAngleView;
...
@property (retain, nonatomic) AWENearbyHalfScreenDismissAnimationController *dismissController;
...
@property (weak, nonatomic) id<AWENearbySubpageVCDelegate> delegate;
@property (weak, nonatomic) AWENearbyHalfScreenAnimation *currentDismissAnimation;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
