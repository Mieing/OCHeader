...
- (id)initWithCPPModel:(struct shared_ptr<CutSame::CoverMaterials> { struct CoverMaterials *x0; struct __shared_weak_count *x1; })a0;
- (struct shared_ptr<CutSame::CoverMaterials> { struct CoverMaterials *x0; struct __shared_weak_count *x1; })cppmodel;
- (id)copyToNewObject;
- (void)copyCategoryToNewObject:(id)a0;
- (void)setCPPModel:(struct shared_ptr<CutSame::CoverMaterials> { struct CoverMaterials *x0; struct __shared_weak_count *x1; })a0;
- (void).cxx_destruct;
- (id).cxx_construct;
