@class NSString, UIView, IESLLDitoPOIMallPageContext, UITableView;
@protocol IESLLDitoPOIMallTableViewFilterContentViewDelegate;

@interface IESLLPOIDetailNGPOIMallFilterContentView : UIView <UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate>
...
@property (weak, nonatomic) id<IESLLDitoPOIMallTableViewFilterContentViewDelegate> delegate;
