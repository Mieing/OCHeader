@interface AWERecommendToFriendSwiftBizUI.RecommendToFriendNineGridListInputView : UIView <AWEGrowingTextViewDelegate> {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_maxTextCountNoticeLabel;
