@class NSString, AWESearchGSInfoModel, NSDictionary, AWEEcommerceGuideSearchV2Model, CAGradientLayer, UIButton, AWESearchGuideSearchSlidingTabBar, AWESearchGuideSearchView;

@interface AWESearchGuideSearchContainerView : UIView <AWESearchGuideSearchViewProtocol, AWESearchGuideSearchSlidingTabBarProtocol>

@property (retain, nonatomic) AWESearchGuideSearchSlidingTabBar *slidingTabBar;
...
@property (retain, nonatomic) AWESearchGuideSearchView *guideSearchView;
