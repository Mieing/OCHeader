...
@interface AWECommentSwiftModel.CommentPanelMediaFeedMultiImagePureModeConfiguration : NSObject <AWECommentMediaFeedConfigurationProtocol> {
    ...
    void /* unknown type, empty encoding */ allowEdit;
}
