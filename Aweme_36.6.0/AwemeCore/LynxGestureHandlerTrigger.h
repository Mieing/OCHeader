@class NSSet, LynxEventHandler, NSPointerArray, LynxGestureDetectorManager, LynxGestureFlingTrigger, LynxGestureArenaManager, LynxGestureVelocityTracker;
...
- (void)dispatchUIEventOnCurrentWinner:(id)a0 touches:(id)a1 event:(id)a2 member:(id)a3 touchEvent:(id)a4 flingPoint:(struct CGPoint { double x0; double x1; })a5;
