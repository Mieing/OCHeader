...
@protocol IESECShopForwardCoService, IESECShopEventService, IESECShopStateService;

@interface IESECShopLayoutBrandMainContainer : IESECShopLayoutBaseContainer <IESECShopLayoutBaseContainerDelegate, IESECShopEventSubscriber>
...
- (void)decorationContainerDidLayoutSubviews:(id)a0;
- (void).cxx_destruct;
- (id)init;
- (void)viewDidLoad;
