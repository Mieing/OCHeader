@class NSString, NSError, UIView, IESLLPOICardPerfDataModel;
@protocol LLDitoLynxContainerProtocol, BDXResourceProtocol;

@interface LLDitoLynxRenderTask : NSObject

@property (nonatomic) BOOL didEnd;
@property (copy, nonatomic) NSString *nodeTag;
@property (nonatomic) double renderStartTime;
@property (retain, nonatomic) UIView<LLDitoLynxContainerProtocol> *containerView;
