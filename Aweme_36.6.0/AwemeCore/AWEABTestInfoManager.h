...
+ (void)debugOverride_didRegisterWithPropertyName:(id)a0;
...
+ (id)abTestInfoModelWithPropertyName:(id)a0;
+ (id)allABTestPropertyList;
+ (id)allABTestInfoModels;
+ (void)registerBoolABTestCaseWithPropertyName:(id)a0 serverString:(id)a1 defaultValue:(BOOL)a2;
+ (void)registerEnumABTestCaseWithPropertyName:(id)a0 serverString:(id)a1 serverTestCaseDataArray:(id)a2 defaultValue:(long long)a3;
+ (void)registerNumberABTestCaseWithPropertyName:(id)a0 serverString:(id)a1 defaultValue:(id)a2;
+ (void)registerStringABTestCaseWithPropertyName:(id)a0 serverString:(id)a1 defaultValue:(id)a2;
+ (id)sharedManager;

- (void)saveABTestInfoModel:(id)a0 propertyName:(id)a1;
- (void).cxx_destruct;
- (id)init;
