@class NSString, UIImageView, UILabel, UIView, IESLivePlaybackSeekProgressText;

@interface IESLivePlaybackSeekPortraitPreview : UIView <IESLivePlaybackSeekPreview>
