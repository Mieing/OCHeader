@class VCMDLCaseInsensitiveDictionary, NSString, NSProgress, NSDictionary, NSMutableData, VCMDLImagerLoaderTask, NSNumber;

@interface BDDownloadMDLTask : BDDownloadTask <BDWebImageDownloadTaskResponseInfo>
...
@property (retain, nonatomic) VCMDLCaseInsensitiveDictionary *mdlResponseHeader;
@property (retain, nonatomic) VCMDLImagerLoaderTask *task;
