@class AWEAwemeModel, NSString, NSHashTable, AWEUILoadingView, NSObject, AFDNewSchoolStoryAutoPlayHandler, AFDNewSchoolStoryContainerContext, UITableView, UIViewController, NSMutableArray, NSNumber, AWEModernFeedSectionReusablePool;
