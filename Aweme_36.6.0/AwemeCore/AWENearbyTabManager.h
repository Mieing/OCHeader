@class NSString, NSDictionary, AWECityModel, AWENearbyCityAndContext, NSArray;

@interface AWENearbyTabManager : NSObject <AWENearbyTabManagerProtocol>
...
- (void)p_trackCityChangeDialogClick:(BOOL)a0;
- (void).cxx_destruct;
- (id)displayString;
- (void)addObserver;
