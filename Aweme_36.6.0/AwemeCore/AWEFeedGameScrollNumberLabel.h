...
@interface AWEFeedGameScrollNumberLabel : UIStackView <UITableViewDelegate, UITableViewDataSource, POPAnimationDelegate>
...
@property (nonatomic) long long decimalPointCount;
@property (retain, nonatomic) UIFont *textFont;
@property (retain, nonatomic) UIColor *textColor;
@property (nonatomic) struct CGPoint { double x; double y; } textOffset;
@property (nonatomic) struct CGPoint { double x; double y; } tableViewOffset;
...
- (void)countingToAmountWithDuration:(double)a0 baseDelayTime:(double)a1 bitIntervalDelayTime:(double)a2 timingFunction:(id)a3;
- (id)initWithAmountPattern:(id)a0 unitSize:(struct CGSize { double x0; double x1; })a1 unitSpacing:(double)a2 signWidth:(double)a3 textFont:(id)a4 textColor:(id)a5 textOffset:(struct CGPoint { double x0; double x1; })a6 unitBgImage:(id)a7 tableViewOffset:(struct CGPoint { double x0; double x1; })a8;
- (void)setAmountSimple:(id)a0;
- (id)getInitialStringWithAmountPattern:(id)a0;
- (void)createUnitBgs;
- (void)createUnits;
- (void)fixUnitBgs;
- (void)fixUnits;
- (void)countingToAmount:(id)a0 duration:(double)a1 baseDelayTime:(double)a2 bitIntervalDelayTime:(double)a3 timingFunction:(id)a4 roundsCount:(long long)a5 fromZero:(BOOL)a6;
