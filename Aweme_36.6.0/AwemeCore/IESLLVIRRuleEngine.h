@class IESLLVIRRuleUnitDispatchManager, NSMutableDictionary, NSLock;

@interface IESLLVIRRuleEngine : NSObject

@property (retain, nonatomic) IESLLVIRRuleUnitDispatchManager *dispatchManager;
