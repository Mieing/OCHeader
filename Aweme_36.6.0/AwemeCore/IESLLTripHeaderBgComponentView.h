@class IESLLTirpHeaderCarouselView, UIView, NSString, IESLLTripHeaderCheckInVideoView, IESLLPOIVideoMuteView, UIImageView, IESLLTirpHeaderTagListView, IESLLTripHeaderBgComponentViewModel, IESLLTirpHeaderGuideMaskView, IESLLPOIHeaderContentCrushRankView;

@interface IESLLTripHeaderBgComponentView : IESLLPOIDetailHeaderImageComponentBaseView <IESLLPOIHeaderCarouselDatasource, IESLLPOIHeaderCarouselDelegate, IESLLPOIVideoPlayerDelegate>

@property (retain, nonatomic) UIView *contentView;
@property (retain, nonatomic) IESLLTirpHeaderCarouselView *mediaListView;
@property (retain, nonatomic) IESLLTripHeaderCheckInVideoView *checkInVideoView;
@property (retain, nonatomic) IESLLTirpHeaderTagListView *tagListView;
@property (retain, nonatomic) IESLLTirpHeaderGuideMaskView *guideMask;
@property (weak, nonatomic) IESLLTripHeaderBgComponentViewModel *headerImageVM;
