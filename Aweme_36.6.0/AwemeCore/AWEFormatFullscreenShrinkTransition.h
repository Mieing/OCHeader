...
@interface AWEFormatFullscreenShrinkTransition : NSObject <AWETransitionContextProvider>
...
- (id)interactionViewControllerFromTarget:(id)a0;
- (id)topBarContainerFromTarget:(id)a0;
