...
+ (BOOL)defaultCancelTouchesInViewByIdentifier:(unsigned long long)a0;
+ (unsigned long long)gestureTypeWithIdentifier:(unsigned long long)a0;
+ (id)initRelatedRecognizerBy:(unsigned long long)a0;

- (id)initByIdentifier:(unsigned long long)a0;
- (BOOL)shouldBeginWithComponentContext:(id)a0;
- (void).cxx_destruct;
- (id)init;
