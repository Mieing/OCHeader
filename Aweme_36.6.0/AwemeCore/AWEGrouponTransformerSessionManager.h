@class AWEGrouponTransformerSessionTrackNode;

@interface AWEGrouponTransformerSessionManager : NSObject

@property (retain, nonatomic) AWEGrouponTransformerSessionTrackNode *homepageLife;
@property (retain, nonatomic) AWEGrouponTransformerSessionTrackNode *homepageFresh;
@property (retain, nonatomic) AWEGrouponTransformerSessionTrackNode *lifeDualIdpt;
