@class UIView, NSString, NSArray, CALayer, UIImageView, UITableView, UIViewController, UICollectionView;
...
@property (retain, nonatomic) CALayer *popMenuTopLayer;
...
- (id)downArrowImage;
- (id)upArrowImage;
- (void)showWithItems:(id)a0 byView:(id)a1 byRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 containerListView:(id)a3 showBlueLayer:(BOOL)a4;
- (void).cxx_destruct;
- (id)init;
