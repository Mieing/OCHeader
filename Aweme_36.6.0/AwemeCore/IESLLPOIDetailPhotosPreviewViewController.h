@class IESLLPOIAlbumCategoryInfoModel, NSString, IESLLPOIDetailPhotosPreviewUploaderInfoView, UILabel, UIView, UIButton;

@interface IESLLPOIDetailPhotosPreviewViewController : IESLLPOIDetailPhotosPreviewBaseViewController <IESLLPhotosPreviewFadeOutTransitionContextProvider, IESLLZoomTransitionInnerContextProvider>
...
@property (retain, nonatomic) IESLLPOIDetailPhotosPreviewUploaderInfoView *userInfoView;
@property (retain, nonatomic) IESLLPOIAlbumCategoryInfoModel *model;
