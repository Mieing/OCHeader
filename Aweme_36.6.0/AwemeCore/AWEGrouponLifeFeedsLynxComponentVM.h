@class NSNumber, AWEGrouponLifeFeedsLynxComponentView, NSMutableArray, AWEGrouponLifeFeedsLynxItem;
@protocol AnnieXCardModelProtocol;

@interface AWEGrouponLifeFeedsLynxComponentVM : AWEGrouponLifeFeedsBaseComponentVM
