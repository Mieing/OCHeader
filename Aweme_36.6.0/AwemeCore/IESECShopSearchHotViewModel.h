...
@interface IESECShopSearchHotViewModel : NSObject
...
- (void)fetchShopSearchHotWithPenetrateParams:(id)a0;
- (void)updateShopSearchHotArray:(id)a0;
- (void)refreshShopSearchHotWithSupplementCount:(unsigned long long)a0;
- (void)refreshShopSearchHot;
- (void)trackTrendingShowWithCount:(unsigned long long)a0;
