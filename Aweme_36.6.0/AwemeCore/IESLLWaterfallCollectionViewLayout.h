...
@interface IESLLWaterfallCollectionViewLayout : UICollectionViewLayout <IESLLNewCollectionViewWaterfallLayoutProtocol>

@property (weak, nonatomic) id<IESLLNewCollectionDelegateWaterfallLayout> delegate;
