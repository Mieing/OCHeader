@class NSString, NSMutableDictionary, HTSLiveMessageListNode, IESLivePublicScreenContext, NSArray, NSNumber, NSMutableArray;
...
- (void)armAndRefreshCell:(id)a0 withNode:(id)a1;
- (id)scrollDispatcher;
