@class UIImageView, UILabel, UIView, LLDitoPageContext;
@protocol IESLLPOIDetailTableViewLocationCellDelegate;

@interface IESLLPOIDetailTableViewLocationCell : IESLLPOIDetailTableViewCell
...
@property (weak, nonatomic) id<IESLLPOIDetailTableViewLocationCellDelegate> delegate;
