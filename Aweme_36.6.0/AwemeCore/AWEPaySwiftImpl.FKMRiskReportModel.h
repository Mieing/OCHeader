...
@interface AWEPaySwiftImpl.FKMRiskReportModel : MTLModel <MTLJSONSerializing, AWEPaySwiftImpl.FKMNetworkResponse> {
    void /* function */ retCode;
    void /* function */ retMsg;
    void /* function */ msgHint;
    void /* function */ clientAction;
}
...
@property (nonatomic, copy) NSString *clientAction;
