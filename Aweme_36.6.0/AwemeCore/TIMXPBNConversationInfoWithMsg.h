@class TIMXPBNSubConversation, NSString, TIMXPBNConvUnreadUnion, TIMXPBNConversationSettingInfo, TIMXPBNParticipant, TIMXPBNMessageBody, NSMutableArray, TIMXPBNParticipantsPage, TIMXPBNConversationCoreInfo;

@interface TIMXPBNConversationInfoWithMsg : GPBMessage
...
@property (retain, nonatomic) TIMXPBNMessageBody *lastMsgBody;
@property (nonatomic) BOOL hasLastMsgBody;
