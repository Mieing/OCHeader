@class NSMutableDictionary, NSString, NSOperationQueue, LLDitoPageContext;

@interface IESLLPOINetworkPrefetchManager : NSObject <IESLLPOINetworkPrefetchManagerProtocol>
