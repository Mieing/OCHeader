@interface IESLiveRevenueImpl.IESLiveRebornGiftSearchViewWrapper : NSObject <IESLiveRefactGiftPanelEventAction, IESLiveGiftPanelReaction, NSObject> {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_legacySearchItem;
