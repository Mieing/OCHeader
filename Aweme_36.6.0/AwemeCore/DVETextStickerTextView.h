@class DVETextStickerTextStorage, NSMutableArray, DVETextStickerLayoutManager;

@interface DVETextStickerTextView : UITextView
...
@property (readonly, nonatomic) DVETextStickerLayoutManager *dve_layoutManager;
@property (readonly, nonatomic) DVETextStickerTextStorage *dve_textStorage;
