@class AWEBasicModeTabBar, NSArray, AWEBaseRootNavigationController, NSString, UIViewController;
@protocol AWEBasicModeTabBarControllerDelegate, AWEBasicModeTabBarControllerDataSource;

@interface AWEBasicModeTabBarController : AWEBaseTabBarController <UITabBarControllerDelegate, AWEBaseRootNavigationControllerDelegate, AWEBasicModeTabBarButtonDelegate, AWEBasicModeTabBarDelegate> {
...
@property (retain, nonatomic) AWEBasicModeTabBar *awe_tabBar;
@property (retain, nonatomic) id<AWEBasicModeTabBarControllerDelegate> awe_bizDelegate;
@property (retain, nonatomic) id<AWEBasicModeTabBarControllerDataSource> awe_bizDataSource;
