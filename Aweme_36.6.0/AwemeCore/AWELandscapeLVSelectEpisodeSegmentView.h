...
@interface AWELandscapeLVSelectEpisodeSegmentView : UIView <UICollectionViewDelegate, UICollectionViewDataSource>
...
@property (weak, nonatomic) id<AWELandscapeLVSelectEpisodeSegmentViewDelegate> delegate;
