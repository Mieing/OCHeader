...
@interface IESECLivePromotionCardProviderBizFakeDelegate : NSObject <IESECLivePromotionCardProviderBizDelegate>

@property (retain, nonatomic) id<AWEECLivePromotionCardProviderBizDelegate> delegate;
