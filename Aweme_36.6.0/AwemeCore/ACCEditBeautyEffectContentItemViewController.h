@class NSString, NSMutableSet, UIButton;

@interface ACCEditBeautyEffectContentItemViewController : ACCEditBeautyEffectContentViewController

@property (retain, nonatomic) NSMutableSet *trackNodeIds;
@property (copy, nonatomic) NSString *resetTitle;
@property (retain, nonatomic) UIButton *backButton;
@property (nonatomic) BOOL isDisableDoBeautyStatus;
@property (copy, nonatomic) id /* block */ beautyEffectContentDidResetEffectItemAction;
@property (copy, nonatomic) id /* block */ beautyEffectContentDidResetStyleEffectItemAction;
@property (copy, nonatomic) id /* block */ beautyEffectContentDidSelectStyleEffectItemAction;
@property (copy, nonatomic) id /* block */ beautyEffectContentDidSelectStyleEffectHasChildAction;
@property (copy, nonatomic) id /* block */ beautyEffectContentDidTapBackAction;
@property (copy, nonatomic) id /* block */ beautyEffectContentDidSelectStyleMoreItemAction;
@property (copy, nonatomic) id /* block */ beautyEffectContentDidTrackItemAction;
@property (copy, nonatomic) id /* block */ beautyEffectContentDidUnDownloadAction;
@property (nonatomic) BOOL shouldShowBackButton;

- (id)effectContext;
- (void)disableDoBeautyAction;
- (void)enableDoBeautyAction;
- (void)navigationControllerRemoveGestureRecognizer;
- (void)setIsAppendStyleNodeBySplitelineNodeStatus:(BOOL)a0;
