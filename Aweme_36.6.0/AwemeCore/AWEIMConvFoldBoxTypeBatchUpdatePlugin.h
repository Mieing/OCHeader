...
@interface AWEIMConvFoldBoxTypeBatchUpdatePlugin : NSObject <TIMXDBConversationORMBatchUpdatePluginProtocol, TIMXDBConversationORMRealTimeUpdatePluginProtocol>
...
- (BOOL)p_foldBoxABTestMatchedWithConv:(id)a0;
- (void).cxx_destruct;
- (id)init;
- (id)targetVersion;
