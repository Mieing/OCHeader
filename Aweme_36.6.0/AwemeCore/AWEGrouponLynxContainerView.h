@class UIView, BDXContext, NSString, AWEGrouponLynxModel, LynxView, NSDictionary, AWEGrouponLynxConfig, AWEGrouponC2LynxPreloadModel;
@protocol AWEGrouponLynxContainerViewDelegate, AWEGrouponSharkLynxContainerViewDelegate, BDXViewContainerProtocol;

@interface AWEGrouponLynxContainerView : UIView <BDXContainerLifecycleProtocol, AWEGrouponSharkLynxContainerProtocol>

@property (retain, nonatomic) UIView<BDXViewContainerProtocol> *lynxContainer;
@property (retain, nonatomic) AWEGrouponLynxConfig *containerConfig;
...
@property (weak, nonatomic) id<AWEGrouponLynxContainerViewDelegate> delegate;
@property (weak, nonatomic) id<AWEGrouponSharkLynxContainerViewDelegate> lynxContainerDelegate;
@property (readonly, nonatomic) LynxView *lynxView;
@property (readonly, copy, nonatomic) NSString *containerID;
@property (retain, nonatomic) AWEGrouponLynxModel *lynxModel;
@property (retain, nonatomic) AWEGrouponC2LynxPreloadModel *preloadModel;
