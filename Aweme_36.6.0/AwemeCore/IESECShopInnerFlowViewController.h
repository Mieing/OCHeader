...
@interface IESECShopInnerFlowViewController : UIViewController <IGListAdapterDelegate, IGListAdapterDataSource, IGListDisplayDelegate, UIScrollViewDelegate, UICollectionViewDelegate, IESECShopSnapFlowLayoutDelegate> {
