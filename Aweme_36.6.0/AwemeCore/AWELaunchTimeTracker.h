...
- (void)p_trackerBgLaunchCountWithEnterForground:(BOOL)a0;
- (void)p_collectProcessDetail;
- (double)p_processStartTime;
- (void)p_trackerBGLEnterForgroundCountIfNeeded;
- (BOOL)p_trackLaunchTimeOnFirstBecomeActive;
- (void)p_collectDataAndFlush;
- (id)p_collectBGLaunchCountInfo;
- (BOOL)p_isLaunchFromBoot;
- (id)p_launchClosureCount;
- (int)p_launchClosureRecreate:(BOOL)a0;
- (id)metricTimeInfoWithName:(id)a0 startTime:(double)a1 endTime:(double)a2;
- (BOOL)p_enableLaunchInterval;
...
- (id)p_threadList;
- (id)p_taskFaults;
- (BOOL)p_collectBGLaunchCountEnable;
- (id)p_forgroundCountKeyForLaunchType:(long long)a0;
- (id)p_launchCountKeyForLaunchType:(long long)a0;
- (void)markLoggerInit;
- (BOOL)appendLaunchExpectationForEvent:(id)a0 params:(id)a1;
