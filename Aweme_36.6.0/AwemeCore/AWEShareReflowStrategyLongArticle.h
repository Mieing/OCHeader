...
@interface AWEShareReflowStrategyLongArticle : NSObject <AWEShareReflowStrategy>
...
- (id)reflowCardWithModel:(id)a0 tokenFromType:(long long)a1 trackParams:(id)a2 reportParams:(id)a3 turnToShareBlock:(id /* block */)a4;
- (void).cxx_destruct;
- (id)descriptionText;
- (id)tokenType;
