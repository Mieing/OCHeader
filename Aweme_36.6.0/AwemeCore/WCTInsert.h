...
- (BOOL)p_executeWithObjectsNew:(id)a0;
- (BOOL)p_executeWithObjectsOld:(id)a0;
- (BOOL)doInsertObjects:(id)a0 withError:(void *)a1;
- (id)initWithCore:(const void *)a0 andClass:(Class)a1 andTableName:(id)a2 andReplaceFlag:(BOOL)a3;
- (id)initWithCore:(const void *)a0 andProperties:(const void *)a1 andTableName:(id)a2 andReplaceFlag:(BOOL)a3;
- (BOOL)executeWithObjects:(id)a0;
- (void).cxx_destruct;
- (id).cxx_construct;
