...
@interface IESLocalLifeTrackerBizService : HTSService <IESLocalLifeTrackerBizService>
...
- (void)iesll_poi_trackEvent:(id)a0 params:(id)a1;
- (void)iesll_poi_trackEvent:(id)a0 params:(id)a1 btmInfo:(id)a2;
- (id)iesll_poi_lifeShareTrackSecInfoWithInfo:(id)a0;
- (id)iesll_poi_lifeShareTrackInfoWithSecInfo:(id)a0;
