@class IESLLTirpHeaderCarouselCollectionView, IESLLMyProxy, NSTimer, IESLLTirpHeaderFlowLayout, NSString, NSIndexPath;
@protocol IESLLPOIHeaderCarouselDelegate, IESLLPOIHeaderCarouselDatasource;

@interface IESLLTirpHeaderCarouselView : UIView <UICollectionViewDelegate, UICollectionViewDataSource>

@property (retain, nonatomic) IESLLTirpHeaderCarouselCollectionView *carouselView;
@property (nonatomic) long long numbers;
@property (nonatomic) long long currentIndex;
@property (nonatomic) long long infactIndex;
@property (nonatomic) BOOL isPause;
@property (retain, nonatomic) NSIndexPath *currentIndexPath;
@property (retain, nonatomic) IESLLMyProxy *timerProxy;
@property (retain, nonatomic) NSTimer *timer;
@property (weak, nonatomic) id<IESLLPOIHeaderCarouselDelegate> delegate;
@property (weak, nonatomic) id<IESLLPOIHeaderCarouselDatasource> datasource;
@property (readonly, nonatomic) IESLLTirpHeaderFlowLayout *flowLayout;
