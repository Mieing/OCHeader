...
@interface CachalotWaterFallMutipleColumnLayout : CachalotBaseLayout

@property (retain, nonatomic) NSNumber *customDivisionNumber;
@property (nonatomic) double customItemGap;
@property (nonatomic) struct UIEdgeInsets { double top; double left; double bottom; double right; } customPaddingInsets;
