@class IESLLRxModule, NSString;

@interface IESLLRxBaseStore : NSObject <IESLLRxStoreProtocol> {
    IESLLRxModule *_module;
}

@property (readonly, nonatomic) IESLLRxModule *module;
