@class NSDictionary, NSString, AWETheaterMoreFeedSectionItem;

@interface AWETheaterMoreDislikeViewModel : AWEDoubleColumnDislikeViewModel <AWEDoubleColumnDislikeVMProtocol>

@property (copy, nonatomic) NSDictionary *logExtraDict;
@property (retain, nonatomic) AWETheaterMoreFeedSectionItem *currentMoreSectionItem;
