@class IESLLTempoAnimationContext, IESLLPOITempoPOINameView, IESLLTempoContext, NSString, UIView, NSMutableArray;
@protocol IESLLTempoNodeProtocol, IESLLTempoWidgetProtocol;

@interface IESLLPOITempoPOINameWidget : IESLLTempoBaseWidget <IESLLTempoWidgetProtocol>

@property (weak, nonatomic) IESLLPOITempoPOINameView *nodeView;
