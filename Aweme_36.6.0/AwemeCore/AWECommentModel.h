@class AWECommentAdComponent, AWECommentInputImageContentModel, AWEUserModel, AWECommentIntentionComponentModel, NSDictionary, AWEAwemeModel, NSMutableArray, NSString, AWECodeGenCreateAwemeConfigModel, UIImage, AWECommentUserGuideInfoModel, AWECommentAttitudeModel, NSArray, AWECommentCellLayoutInfo, AWECommentCellViewModel, AWEURLModel, AWECommentUserAvatarSchema, AWEIMConversationInfoModel, AWEIMStickerModel, AWECommentAudioModel, AWECommentSurpriseEggModel, AWECommentLabelModel, AWECommentAnchorModel, AWECommentQualityStampModel, NSMutableAttributedString, AWECodeGenCommentReplyListConfigModel, AWECommentLiteInspireInfoModel, AWECommentExtraModel, AWERelationDynamicLable, AWECommentLynxEggModel, NSNumber;
