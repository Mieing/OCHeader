@class NSString, IESLLPOIDetailRouterInterceptor;
@protocol IESLLPOIFeedPlayerManagerProtocol;

@interface IESLLPOIDetailFeedViewResizeManagerExtension : IESLLPOIBaseExtension <IESLLPOIFeedPlayerManagerDatasource, LLVSDContainerDelegate>

@property (retain, nonatomic) id<IESLLPOIFeedPlayerManagerProtocol> feedManager;
@property (retain, nonatomic) IESLLPOIDetailRouterInterceptor *routerInterceptor;
