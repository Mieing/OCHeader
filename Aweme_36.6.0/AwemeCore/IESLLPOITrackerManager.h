...
@interface IESLLPOITrackerManager : NSObject <IESLLFusePOITrackerManagerProtocol>
...
+ (Class)aIESLLPOITrackerManagerLiteAdapterClass;
+ (id)sharedManager;
...
- (id)aIESLLPOITrackerManagerLiteAdapter;
- (void).cxx_destruct;
