...
@protocol UIViewControllerContextTransitioning, AWEECMallGoodsDetailZoomOuterContextProvider;

@interface AWEECMediaWrapperProductInteractiveShrinkTransition : NSObject <AWETransitionContextProvider>
...
@property (retain, nonatomic) UIViewController<AWEECMallGoodsDetailZoomOuterContextProvider> *toCP;
...
@property (nonatomic) long long ipadSizeScale;
