@class AWEECOMIMSubCardOrderCard, AWEECOMIMCardComponentCommonTitleView, AWEECOMIMCardComponentMultiAttributeLabelView, AWEECOMIMCardComponentOperationPanel;
...
@property (retain, nonatomic) AWEECOMIMCardComponentMultiAttributeLabelView *descView;
