...
@property (nonatomic) long long clientStart;
@property (nonatomic) long long taskCreate;
@property (nonatomic) long long networkStart;
@property (nonatomic) long long networkEnd;
@property (nonatomic) long long clientEnd;
