@class NSString, NSMutableSet, AWEBeautyResetAllView, AWEBeautyBackView;

@interface AWEBeautyContentItemViewController : AWEBeautyContentViewController

@property (nonatomic) BOOL shouldShowBackButton;
@property (nonatomic) BOOL shouldShowRestButton;
@property (copy, nonatomic) NSString *resetTitle;
@property (retain, nonatomic) AWEBeautyBackView *backButton;
@property (retain, nonatomic) AWEBeautyResetAllView *resetAllBeautyButton;
...
- (void)addBackBarItemIfNeeded;
- (void)addRestBarItemIfNeeded;
- (BOOL)isEditSceneStatus;
- (void)updatePageConfigWithCell:(id)a0 cellModel:(id)a1 isEditSceneStatus:(BOOL)a2;
