...
@interface LynxBackgroundRuntime : NSObject <LynxErrorReceiverProtocol> {
    ...
    long long _state;
    struct weak_ptr<lynx::piper::LynxModuleManager> { struct LynxModuleManager *__ptr_; struct __shared_weak_count *__cntrl_; } _weak_module_manager;
...
- (void)initDevTool;
- (struct weak_ptr<lynx::piper::LynxModuleManager> { struct LynxModuleManager *x0; struct __shared_weak_count *x1; })moduleManagerPtr;
