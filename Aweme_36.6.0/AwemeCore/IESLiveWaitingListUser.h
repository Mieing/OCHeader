@class NSString, IESLiveLinkHostInfo, HTSLiveJoinTeamfightInfo, IESLiveMicPosTagInfo, IESLiveListUserEventInfo, NSMutableArray, HTSLiveUser, IESLiveListUserTag, IESLiveUserHighScoreSongTag;
