@class AWEGrouponPageContext, NSString, NSTimer, AWEAwemeModel, UIView, AWEGrouponC2FeedLiveCardResouceContainerView, AWEGrouponC2FeedLiveCardContainerView;
@protocol AWEGrouponC2FeedCellDelegate, AWEGrouponC2FeedLiveCardContainerProtocol, AWELivePreviewStreamViewProtocol;

@interface AWEGrouponC2FeedLiveCardViewController : UIViewController <AWELivePreviewStreamViewDelegate, AWEGrouponC2ContainerFeedCellControllerProtocol, AWEGrouponC2ChildTrackerProtocol>

@property (weak, nonatomic) UIView<AWEGrouponC2FeedLiveCardContainerProtocol> *containerView;
@property (retain, nonatomic) AWEGrouponC2FeedLiveCardContainerView *cardContainerView;
@property (retain, nonatomic) AWEGrouponC2FeedLiveCardResouceContainerView *resourceCardContainerView;
