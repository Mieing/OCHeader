@class CAGradientLayer, NSString, UICollectionView, NSArray, AWEStoryProgressContainerConfig, NSMutableArray;
@protocol AWEStoryProgressSlideViewDelegate;

@interface AWEStoryProgressSlideView : UIView <UIGestureRecognizerDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
