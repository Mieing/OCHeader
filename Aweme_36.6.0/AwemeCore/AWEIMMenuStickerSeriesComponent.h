...
@interface AWEIMMenuStickerSeriesComponent : AWEIMComponentBase <AWEIMMessageListMenuProtocol>
...
- (void)checkEmoticonSeriesWithMessage:(id)a0;
- (void)p_checkSeriesWithMessage:(id)a0 enterFrom:(id)a1;
