@class AWEDCFeedSpacingConfig, NSArray, AWEDCFeedEmptyPageConfig, AWEDCFeedHeaderFooterConfig, AWEDCFeedColorConfig, AWEDCFeedPageLoadingConfig, AWEDCFeedTopAreaConfig, AWEDCFeedGradientBGViewConfig, AWEDCFeedDislikeConfig;
