...
@interface AWERecordBeautyDefaultDownloader : NSObject <AWERecordBeautyDownloaderProtocol>
...
- (void)p_downloadEffectList:(id /* block */)a0 ignoreRequestOpt:(BOOL)a1 threadOpt:(BOOL)a2;
- (void).cxx_destruct;
