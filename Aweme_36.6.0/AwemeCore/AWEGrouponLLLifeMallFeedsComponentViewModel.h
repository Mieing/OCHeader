@class UIScrollView, NSString, NSDictionary, AWEGrouponLifeFeedsViewController, AWEGrouponLifeFeedsLynxNestedItem, AWEGrouponLLLifeMallFeedsComponentView, UIView;

@interface AWEGrouponLLLifeMallFeedsComponentViewModel : LLDitoComponentViewModel <AWEGrouponLifeFeedsViewControllerDelegate, AWEGrouponLifeFeedsLynxNestedItemDelegate>
...
@property (retain, nonatomic) AWEGrouponLifeFeedsViewController *lifeFeedsVC;
@property (nonatomic) double layoutWidth;
@property (nonatomic) BOOL needShow;
@property (retain, nonatomic) AWEGrouponLifeFeedsLynxNestedItem *nestedItem;
@property (weak, nonatomic) AWEGrouponLLLifeMallFeedsComponentView *cell;
