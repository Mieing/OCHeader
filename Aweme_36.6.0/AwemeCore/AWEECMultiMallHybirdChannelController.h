@class NSString, IESECMallCategoryTabInfoModel, AWEECMallAnnieXViewController, AWEECMultiMallContainerModel, NSDate;

@interface AWEECMultiMallHybirdChannelController : NSObject <AWEECMultiMallChannelProtocol>

@property (retain, nonatomic) AWEECMallAnnieXViewController *hybirdMallVC;
