...
- (void)layoutToolbarButtons:(id)a0 withSameButtonSize:(struct CGSize { double x0; double x1; })a1 inContainerRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 horizontally:(BOOL)a3;
