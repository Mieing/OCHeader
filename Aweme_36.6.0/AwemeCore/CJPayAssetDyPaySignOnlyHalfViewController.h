@class CJPayDyPayProcessConfigModel, CJPayAssetDyPaySignOnlyViewManager, UIImageView, NSString, CJPayDyPaySignInfoQueryResponse, NSNumber;

@interface CJPayAssetDyPaySignOnlyHalfViewController : CJPayHalfPageBaseViewController <CJPayAssetDyPaySignOnlyViewManagerProtocol, CJPayAssetDyPaySignOnlyContentViewUIControlProtocol>
...
@property (retain, nonatomic) NSNumber *containerHeightScale;
