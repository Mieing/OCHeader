@class NSMutableDictionary, IESLLPOIAlbumSelectedStatus, NSString, IESLLPOIAlbumVideoPageModel, NSMutableArray;

@interface IESLLPOIAlbumDataProcessor : NSObject
...
@property (retain, nonatomic) IESLLPOIAlbumSelectedStatus *selectedStatus;
...
@property (retain, nonatomic) IESLLPOIAlbumVideoPageModel *videoInfo;
