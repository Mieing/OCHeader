...
- (BOOL)canShowIMInnerPushRightNow:(id)a0;
- (void)showPush:(id)a0;
- (BOOL)shouldSaveTheLastMsg;
- (double)polymericMessagesDelayTime;
- (void)delay:(long long)a0 PerformWithBlock:(id /* block */)a1;
- (id)attributedTitle:(id)a0 shouldHideDetailMsg:(BOOL)a1;
- (id)attributedContent:(id)a0 shouldHideDetailMsg:(BOOL)a1;
- (void)trackInnerPushEvent:(id)a0 trackID:(id)a1 model:(id)a2;
- (id)attributedOriginalContent:(id)a0;
- (void).cxx_destruct;
- (id)init;
- (void)dealloc;
