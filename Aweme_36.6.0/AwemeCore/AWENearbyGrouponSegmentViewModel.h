@class NSString, NSArray, AWENearbyGrouponBubbleModel, AWENearbyPageContext, NSDictionary, NSMutableDictionary, NSMutableArray, AWENearbyGrouponMutipleTabModel;

@interface AWENearbyGrouponSegmentViewModel : NSObject <AWENearbyGrouponBubbleViewMessage>
...
@property (retain, nonatomic) AWENearbyGrouponBubbleModel *tabBubbleModel;
