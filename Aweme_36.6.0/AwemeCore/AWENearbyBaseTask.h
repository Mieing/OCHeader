@class NSMutableDictionary, NSString, NSMutableSet, AWENearbyTaskModel, AWENearbyTaskExecuteContext;

@interface AWENearbyBaseTask : NSObject <AWENearbyTaskProtocol>

@property (retain, nonatomic) AWENearbyTaskModel *taskModel;
@property (retain, nonatomic) AWENearbyTaskExecuteContext *executeContext;
