@class SearchCachalotViewConfig, NSString, CachalotMainLoopIdleTaskManager, UIView, SearchCachalotContext, UIScrollView;
@protocol CachalotComponent, CachalotRenderPipelineComponentViewModel, UIScrollViewDelegate;

@interface AWESearchCachalotFullPageView : UIView <SearchCachalotViewInterface>

@property (retain, nonatomic) SearchCachalotViewConfig *config;
@property (retain, nonatomic) id<CachalotComponent> component;
...
@property (retain, nonatomic) id<CachalotRenderPipelineComponentViewModel> preCreateViewModel;
@property (retain, nonatomic) SearchCachalotContext *cachalotContext;
