@class RivalsRecommendResponse_RankSeasonInfo_QualifyInfo, NSString, RivalsRecommendResponse_RankSeasonInfo_ScoreInfo, HTSLiveImage, RivalsRecommendResponse_RankSeasonInfo_RankInfo;
