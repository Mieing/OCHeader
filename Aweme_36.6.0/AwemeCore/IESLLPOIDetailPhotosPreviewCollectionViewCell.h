@class NSString, NSArray, UIImage, IESLLPOILoadingView, UIImageView, IESLLPOIDetailPhotoBaseInfo, IESLLPOIDetailPhotosPreviewBaseViewController, UIScrollView;

@interface IESLLPOIDetailPhotosPreviewCollectionViewCell : UICollectionViewCell <UIScrollViewDelegate, IESLLPOIDetailPhotosPreviewBaseCellProtocol>
