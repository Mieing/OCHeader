...
@interface AWEIMMessageListExchangeImageEntryComponent : AWEIMComponentBase <AWEIMMessageListPlusPanelRegistry>
...
- (void)p_exchangeImageButtonClickedWithModelType:(unsigned long long)a0;
- (void).cxx_destruct;
