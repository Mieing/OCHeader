@class UIView, AWEIronManLandingPageCommonCollectionCell, AWEIronManLandingPageCommonItemModel, NSString, UIImageView, UIButton, AWEIronManLandingPageCollectionViewModel, AWEIronManLandingPageBottomBarView, UICollectionView, UILabel;

@interface AWEIronManLandingPageCollectionSectionView : UITableViewCell <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>

@property (weak, nonatomic) AWEIronManLandingPageCollectionViewModel *viewModel;
