@class NSMutableDictionary, MMKV, NSString, AWEInteractionMessageManagerConfig;

@interface AWEInteractionMessageManager : NSObject <AWEInteractionMessageManagerProtocol, AWEInteractionMessageDataObserverProtocol>

@property (retain, nonatomic) AWEInteractionMessageManagerConfig *config;
...
- (void)handleInteractionMessageData:(id)a0;
- (void).cxx_destruct;
