@class AWEEntertainmentMultipleEventsView, AWEPlayInteractionContext, NSString, AWECommonButtonInfoModel;
@protocol AWEPlayInteractionBottomButtonComponentProtocol;

@interface AWEPlayInteractionBottomButtonLongVideoComponentMultipleButtonViewModel : NSObject <AWEPlayInteractionBottomButtonLongVideoComponentViewModelProtocol>
