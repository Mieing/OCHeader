@class AWENearbyGrouponSegmentItemView, NSArray, NSString, UIScrollView, NSMutableArray, UIView;

@interface AWENearbyGrouponSegmentView : UIView <UIScrollViewDelegate>
...
@property (retain, nonatomic) AWENearbyGrouponSegmentItemView *recommendView;
@property (retain, nonatomic) AWENearbyGrouponSegmentItemView *scrollRecommendView;
