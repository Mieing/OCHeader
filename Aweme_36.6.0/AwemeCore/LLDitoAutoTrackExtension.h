@class NSMutableDictionary, NSDictionary, LLDitoEvent, LLDitoPageContext, NSString;
@protocol LLDitoExtensionContainerProtocol;

@interface LLDitoAutoTrackExtension : NSObject <LLDitoExtensionProtocol>
...
@property (retain, nonatomic) LLDitoEvent *quitPageEvent;
