@interface AWEMultiContentImpl.RichContentScrollController : AWEBaseController <UIScrollViewDelegate, AWEMultiContentImpl.RichContentScrollControllerProtocol> {
