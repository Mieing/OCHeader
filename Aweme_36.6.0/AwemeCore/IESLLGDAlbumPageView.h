@class IESLLGDAlbumScrollView, NSMutableDictionary, NSDictionary, IESLLGDAlbumDataProcessor, IESLLGoodsDetailPageContext, NSMutableArray, NSString;

@interface IESLLGDAlbumPageView : UIView <UIScrollViewDelegate>

@property (retain, nonatomic) NSDictionary *logParams;
@property (retain, nonatomic) NSMutableArray *pageIndexs;
@property (retain, nonatomic) IESLLGDAlbumScrollView *scrollView;
