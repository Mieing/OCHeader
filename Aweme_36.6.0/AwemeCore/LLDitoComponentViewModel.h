@class NSArray, NSString, LLDitoPageContext, NSNumber, LLDitoStyle;

@interface LLDitoComponentViewModel : NSObject <LLDitoComponentViewModel>
...
@property (retain, nonatomic) LLDitoStyle *style;
