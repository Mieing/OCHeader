@class UILongPressGestureRecognizer, AWELifeFeedsPageContext, AWELifeFeedsBaseComponentVM, NSString, UITapGestureRecognizer;
@protocol AWELifeFeedsBaseComponentViewPrivateDelegate;

@interface AWELifeFeedsBaseComponentView : UIView <UIGestureRecognizerDelegate, AWELifeFeedsAutoPlayProtocal>

@property (retain, nonatomic) UITapGestureRecognizer *tapGesture;
@property (retain, nonatomic) UILongPressGestureRecognizer *longPressGesture;
@property (weak, nonatomic) id<AWELifeFeedsBaseComponentViewPrivateDelegate> private_delegate;
@property (weak, nonatomic) AWELifeFeedsPageContext *pageContext;
@property (weak, nonatomic) AWELifeFeedsBaseComponentVM *viewModel;
