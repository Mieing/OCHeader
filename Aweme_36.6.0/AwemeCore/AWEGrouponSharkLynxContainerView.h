@class UIView, BDXContext, NSString, AWEGrouponSharkLynxConfig, LynxView, NSDictionary, AWEGrouponSharkLynxModel, AWEGrouponC2LynxPreloadModel;
@protocol AWEGrouponSharkLynxContainerViewDelegate, BDXViewContainerProtocol;

@interface AWEGrouponSharkLynxContainerView : UIView <BDXContainerLifecycleProtocol, AWEGrouponSharkLynxContainerProtocol>

@property (retain, nonatomic) UIView<BDXViewContainerProtocol> *lynxContainer;
@property (retain, nonatomic) AWEGrouponSharkLynxConfig *containerConfig;
