@class NSMutableDictionary, UICollectionView, AWEIMStrangerMultiTabHeaderView, NSDictionary, AWEIMTopNoticeTipView, UILabel, AWEIMStrangerPrivateMsgSettingTopTipInteractor, AWEIMStrangerReadStateTopTipViewInteractor, UIView, NSString, AWEIMStrangerTracker, AWEIMStrangerChatListViewModel, AWEIMPriorityQueueSyncDispatcher, AWEIMStrangerTrashChatListViewModel, NSArray, AWEIMStrangerBlockMessageTopTipViewInteractor;
...
@property (retain, nonatomic) UILabel *cleanAllLabel;
@property (retain, nonatomic) UIView *cleanAllLabelContainer;
