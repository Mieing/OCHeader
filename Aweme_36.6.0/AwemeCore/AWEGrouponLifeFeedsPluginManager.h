@class AWEGrouponLifeFeedsPageContext, NSMutableDictionary, NSString;

@interface AWEGrouponLifeFeedsPluginManager : NSObject <AWEGrouponLifeFeedsPluginProtocol>
