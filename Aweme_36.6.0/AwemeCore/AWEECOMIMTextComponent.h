@class UITableView, AWEECOMIMTextComponentModel, YYLabel, NSString, AWEECOMIMTextSelectable, _TtC13AWEECOMIMImpl22BDECIMFlowMarkdownView;
...
@property (retain, nonatomic) _TtC13AWEECOMIMImpl22BDECIMFlowMarkdownView *flowMarkdownView;
...
@property (copy, nonatomic) id /* block */ onLinkClick;
...
- (void)configSupportMarkdown:(BOOL)a0;
- (void)jumpUrlWithString:(id)a0;
- (void).cxx_destruct;
