@class ACCCameraSubscription, ACCEditBeautyFakeProgressSliderView, ACCEditBeautyPlayerProgressSlider, UIPanGestureRecognizer;

@interface ACCEditBeautyPlayerSliderProgressView : UIView

@property (retain, nonatomic) ACCEditBeautyPlayerProgressSlider *progressSlider;
