@class NSString, NSMutableDictionary, NSPointerArray, LLDitoPageContext, NSDictionary, IESLLPOIDynamicTrackConfigModel;

@interface IESLLPOIDynamicTrackUtil : NSObject
...
@property (retain, nonatomic) IESLLPOIDynamicTrackConfigModel *configModel;
...
- (void)didReceiveLLDitoPageModel:(id)a0 shouldAutomaticallyUpdateSession:(BOOL)a1;
