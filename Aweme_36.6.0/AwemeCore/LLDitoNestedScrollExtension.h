@class NSMutableDictionary, NSString, UIScrollView, LLDitoPageContext;
@protocol LLDitoExtensionContainerProtocol;

@interface LLDitoNestedScrollExtension : NSObject <LLDitoNestedScrollItemDelegate, LLDitoExtensionProtocol, LLDitoScrollViewDelegateProtocol_Private>
