@class AWELifeFeedsShowFeedbackTask, NSMutableArray, NSString;

@interface AWELifeFeedsFeedBackPlugin : AWELifeFeedsBasePlugin <AWELifeFeedsShowFeedbackTaskDelegate>

@property (retain, nonatomic) AWELifeFeedsShowFeedbackTask *currentTask;
