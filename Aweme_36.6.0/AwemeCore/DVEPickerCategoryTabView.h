...
@protocol DVEPickerCategoryUIConfigurationProtocol, DVEPickerCategoryTabViewDelegate;

@interface DVEPickerCategoryTabView : UIView <UICollectionViewDelegate, UICollectionViewDataSource>
...
@property (retain, nonatomic) id<DVEPickerCategoryUIConfigurationProtocol> UIConfig;
@property (weak, nonatomic) UIScrollView *contentScrollView;
@property (nonatomic) long long defaultSelectedIndex;
@property (weak, nonatomic) id<DVEPickerCategoryTabViewDelegate> delegate;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })calcuteCellPosition:(long long)a0;
- (void)reloadData;
- (void).cxx_destruct;
