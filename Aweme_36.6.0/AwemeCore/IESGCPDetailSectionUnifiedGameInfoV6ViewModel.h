@class NSString, NSArray, IESGCPPBGameImageBundler, IESGCPDetailSectionUnifiedGameInfoThemeConfig, IESGCPPBRankListAdditionalModel, IESGCPPBHeaderGameInfo, IESGCPPBGameImage, IESGCPPBVideoRankListEntrance, IESGCPPBGameDetailOfficialAccount;

@interface IESGCPDetailSectionUnifiedGameInfoV6ViewModel : IESGCPDetailBaseViewModel
