@class IESLiveLinkVideoFrame, IESLiveLinkRTCInteractSession, NSString, NSObject;
@protocol OS_dispatch_queue;

@interface IESLiveLinkRenderNode : IESLiveLinkBaseNode <IESLiveLinkInputNode> {
    struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } _mutexLock;
}

@property (retain, nonatomic) IESLiveLinkRTCInteractSession *renderSession;
...
- (id)initWithRenderSession:(id)a0 identifier:(id)a1;
- (void).cxx_destruct;
- (void)dealloc;
