@class NSString, UIScrollView, LLDitoPageContext, LLHalfContainerParams;
@protocol LLDitoExtensionContainerProtocol, LLDitoHalfContainerProtocol;

@interface IESLLPOIHalfContainerExtension : NSObject <UIGestureRecognizerDelegate, LLDitoExtensionProtocol, LLVSDContainerDelegate>

@property (weak, nonatomic) UIScrollView *scrollView;
@property (retain, nonatomic) LLHalfContainerParams *params;
