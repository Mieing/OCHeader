...
- (void)_flex_swizzle_6978cefc_URLSession:(id)a0 task:(id)a1 didCompleteWithError:(id)a2;
- (void)URLSession:(id)a0 dataTask:(id)a1 didReceiveResponse:(id)a2 completionHandler:(id /* block */)a3;
- (void)_flex_swizzle_f117363d_URLSession:(id)a0 dataTask:(id)a1 didReceiveData:(id)a2;
