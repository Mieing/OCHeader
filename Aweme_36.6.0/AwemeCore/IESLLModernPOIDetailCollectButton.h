@class NSString, IESLLPOIDetailCollectButtonConfig, IESLLPOICollectView, UILabel;

@interface IESLLModernPOIDetailCollectButton : UIButton

@property (retain, nonatomic) IESLLPOIDetailCollectButtonConfig *config;
@property (retain, nonatomic) NSString *theme;
@property (nonatomic) unsigned long long style;
@property (nonatomic) BOOL collected;
@property (retain, nonatomic) IESLLPOICollectView *collectImageView;
