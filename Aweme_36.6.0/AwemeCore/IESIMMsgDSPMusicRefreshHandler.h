...
@interface IESIMMsgDSPMusicRefreshHandler : AWEIMMsgBaseRefreshHandler <AWEIMMsgRefreshHandlerProtocol>
...
+ (BOOL)getUnavailableFlag:(id)a0;
+ (void)setUnavailableFlag:(BOOL)a0 uniqueId:(id)a1;
