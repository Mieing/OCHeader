@class NSString, UIBezierPath, RxCollectionLayoutItem, UICollectionViewLayoutAttributes, NSIndexPath;

@interface RxCollectionLayoutVisibleItem : NSObject <RxCollectionLayoutVisibleItem> {
    UICollectionViewLayoutAttributes *_backstore;
}

@property (readonly, nonatomic) UICollectionViewLayoutAttributes *layoutAttributes;
@property (readonly, nonatomic) RxCollectionLayoutItem *layoutItem;
