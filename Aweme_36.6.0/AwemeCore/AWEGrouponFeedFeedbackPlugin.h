@class NSString, AWEGrouponFeedShowFeedbackTask, NSMutableArray;

@interface AWEGrouponFeedFeedbackPlugin : AWEGrouponFeedBasePlugin <AWEGrouponFeedShowFeedbackTaskDelegate>

@property (retain, nonatomic) AWEGrouponFeedShowFeedbackTask *currentTask;
