@class NSString, UICollectionView, UIView, RxCollectionViewDiffableDataSource, NSMutableArray;
@protocol AWEIMInputActionBarDelegate;

@interface AWEIMInputActionBarStrangerBoxConversationEntryView : UIView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AWEIMInputActionBarProtocol>
