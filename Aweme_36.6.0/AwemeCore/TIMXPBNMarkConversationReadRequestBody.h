@class TIMXPBNThreadReadBadgeCountInfo, NSString, GPBInt32Int64Dictionary, NSMutableArray, TIMXPBNConvUnreadUnion;
...
@property (retain, nonatomic) TIMXPBNThreadReadBadgeCountInfo *threadReadBadgeCountInfo;
@property (nonatomic) BOOL hasThreadReadBadgeCountInfo;
