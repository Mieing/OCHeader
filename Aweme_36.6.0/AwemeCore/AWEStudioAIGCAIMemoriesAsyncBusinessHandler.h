...
@interface AWEStudioAIGCAIMemoriesAsyncBusinessHandler : NSObject <AWEStudioAIGCAsyncTaskBusinessHandlerProtocol>
...
+ (void)_fetchAndDownloadTemplateModelWithTemplateID:(id)a0 completion:(id /* block */)a1;
+ (void)preloadTemplateMusicIfNeededWithMusicId:(id)a0;
+ (void)_downloadTemplate:(id)a0 retryCount:(int)a1 completion:(id /* block */)a2;
+ (void)_fetchTemplateWithId:(id)a0 retryCount:(int)a1 completion:(id /* block */)a2;
