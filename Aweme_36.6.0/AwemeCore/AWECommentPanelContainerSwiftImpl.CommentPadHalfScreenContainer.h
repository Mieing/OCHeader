@interface AWECommentPanelContainerSwiftImpl.CommentPadHalfScreenContainer : AWECommentPanelContainerSwiftImpl.CommentBaseContainer <UIGestureRecognizerDelegate> {
    void /* unknown type, empty encoding */ hasFirstLoad;
