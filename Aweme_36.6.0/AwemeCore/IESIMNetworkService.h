...
@interface IESIMNetworkService : HTSService <IESIMNetworkService>
...
- (id)requestForJSONWithResponse:(id)a0;
- (id)requestWithNetworkProvider:(id)a0 fullCompletion:(id /* block */)a1;
...
- (id)requestUserIDFromResponse:(id)a0;
...
- (id)iesTaskWithTask:(id)a0;
- (unsigned long long)aweStrategyWithStrategy:(unsigned long long)a0;
- (id)networkStatus;
