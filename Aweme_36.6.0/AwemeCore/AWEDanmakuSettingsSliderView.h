...
- (void)configPointState:(id)a0 hidden:(BOOL)a1 currentValue:(double)a2;
- (id)configPointView:(long long)a0;
- (void)recoverPinValueWithIndexIfNeed:(long long)a0;
- (void)seekToValue:(double)a0 index:(long long)a1;
- (void)configSliderPointListHidden:(BOOL)a0;
- (void).cxx_destruct;
