@class NSString, AWEGrouponForwardTabCouponInfoModel, AWEURLModel;

@interface AWEGrouponForwardTabExtraInfoModel : MTLModel <MTLJSONSerializing>
...
@property (retain, nonatomic) AWEGrouponForwardTabCouponInfoModel *couponInfo;
