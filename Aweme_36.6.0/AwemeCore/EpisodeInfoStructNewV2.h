@class PayInfoV2, NSString, ContentChargeStructV2, UrlStructV2, LVideoEntranceDataV2, XiguaGuideV2, EntertainmentProductStructV2, EpisodeTitleV2, NSMutableArray, InteractControlV2, WaterMarkInfoV2, LVideoInfoV2;
...
@property (retain, nonatomic) EpisodeTitleV2 *titleInfo;
@property (nonatomic) BOOL hasTitleInfo;
...
@property (retain, nonatomic) WaterMarkInfoV2 *waterMark;
@property (nonatomic) BOOL hasWaterMark;
@property (retain, nonatomic) LVideoInfoV2 *videoInfo;
