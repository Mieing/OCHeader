@class NSString, AWEVerticalAlignedLabel, AWEOfflineVideoResourceCellModel, UIImageView, AWEOfflineVideoDownloadingGroupMarkView, AWEBinding, AWEOfflineVideoDownloadProgressView, UILabel;

@interface AWEOfflineVideoDownloadingGroupResourceCell : AWEIMSwipeCollectionViewCell <AWEOfflineVideoCenterCell>
...
@property (retain, nonatomic) AWEOfflineVideoDownloadingGroupMarkView *groupMarkView;
