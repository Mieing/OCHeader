@class AWEGrouponC2FeedAnchorView, UILabel, NSObject, UIViewController, AWEGrouponC2FeedInteractionView, AWEGrouponPageContext, UIView, NSString, NSMutableSet, AWEGouponC2FeedDualAnchorContainerView, AWEAwemeModel, AWEBinding, AWEGradientView, UIImageView;
@protocol AWEAwemePlayInteractionInteractorProtocol, AWEGrouponC2FeedCellDelegate, AWEAwemePlayVideoControllerProtocol, AWEAwemePlayVideoTrackProtocol, AWEAwemePlayVideoProtocol;

@interface AWEGrouponC2FeedVideoViewController : UIViewController <AWEPlayVideoDelegate, AWEPlayVideoMessage, AWEAwemeDetailTableViewControllerDelegate, AFDFullPageFeedContainerViewControllerDelegate, AWEGrouponC2ContainerFeedCellControllerProtocol, AWEGrouponC2ChildTrackerProtocol>
...
@property (retain, nonatomic) AWEGrouponC2FeedInteractionView *interactView;
