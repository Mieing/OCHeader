@class IESLiveButton, NSString, UISwitch, UIImageView, UILabel, IESLiveRevenueInteractSettingCellItem, UIButton;
@protocol IESLiveCompoundSubscription;

@interface IESLiveRevenueInteractSettingCell : UITableViewCell <UITextFieldDelegate>
...
@property (retain, nonatomic) IESLiveRevenueInteractSettingCellItem *item;
