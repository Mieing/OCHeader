...
@interface AnimaXView : UIView <AnimaXPlayerProtocol, AnimaXCompositionListenerProtocol> {
...
@property (nonatomic) BOOL enableDetachStop;
...
- (BOOL)updateSize:(double)a0 height:(double)a1;
- (void)updateAnimaXSurface;
- (void)initGPULayer;
- (void)resizeAnimaXSurface;
- (void)updateVisibilityState:(BOOL)a0 forType:(unsigned long long)a1;
- (BOOL)isSizeChangeWithinLimit:(double)a0 height:(double)a1;
