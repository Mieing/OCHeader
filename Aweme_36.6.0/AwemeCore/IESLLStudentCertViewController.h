@class UIView, IESLLCertProcessView, IESLLCertCheckPopupView, NSTimer, NSString, UIImageView, UIButton, IESLLStudentCertConfig, UIViewController, WKWebView;
@protocol IESLLHttpTask, BDXViewContainerProtocol, IESLLLoadingToastInterface, IESLLNavigationBarInterface, IESLLAlertDialogInterface;

@interface IESLLStudentCertViewController : UIViewController <BDXContainerLifecycleProtocol>
...
@property (retain, nonatomic) IESLLCertProcessView *certButtonView;
@property (retain, nonatomic) IESLLCertCheckPopupView *checkPopupView;
...
@property (retain, nonatomic) UIViewController<IESLLAlertDialogInterface> *successDialog;
@property (retain, nonatomic) IESLLStudentCertConfig *certConfig;
