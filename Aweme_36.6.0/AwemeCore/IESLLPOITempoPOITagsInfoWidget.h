@class IESLLTempoAnimationContext, NSArray, IESLLTempoContext, NSString, UIView, IESLLPOITempoPOITagsInfoView, NSMutableArray;
@protocol IESLLTempoNodeProtocol, IESLLTempoWidgetProtocol;

@interface IESLLPOITempoPOITagsInfoWidget : IESLLTempoBaseWidget <IESLLTempoWidgetProtocol>

@property (weak, nonatomic) IESLLPOITempoPOITagsInfoView *nodeView;
