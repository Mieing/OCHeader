@class NSString, UICollectionViewCell, IESLiveFeedDrawerOperationBannerItemModel;
@protocol IESLiveFeedDrawerOperationCellProtocol;

@interface IESLiveFeedDrawerOperationBannerSectionController : IESLiveFeedDrawerListItemSectionController <IGListDisplayDelegate>

@property (retain, nonatomic) IESLiveFeedDrawerOperationBannerItemModel *item;
