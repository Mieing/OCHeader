...
- (id)initWithCPPModel:(struct shared_ptr<CutSame::MaterialTextTemplate> { struct MaterialTextTemplate *x0; struct __shared_weak_count *x1; })a0;
...
- (void)setCPPModel:(struct shared_ptr<CutSame::MaterialTextTemplate> { struct MaterialTextTemplate *x0; struct __shared_weak_count *x1; })a0;
- (void).cxx_destruct;
- (id).cxx_construct;
