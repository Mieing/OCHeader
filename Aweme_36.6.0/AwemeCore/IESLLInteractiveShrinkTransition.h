...
@protocol IESLLZoomTransitionInnerContextProvider, IESLLZoomTransitionOuterContextProvider;

@interface IESLLInteractiveShrinkTransition : NSObject <AWETransitionContextProvider>
...
@property (retain, nonatomic) UIViewController<IESLLZoomTransitionInnerContextProvider> *fromCP;
@property (retain, nonatomic) UIViewController<IESLLZoomTransitionOuterContextProvider> *toCP;
