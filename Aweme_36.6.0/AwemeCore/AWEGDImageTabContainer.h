@class NSMutableArray, AWEGDImageTabModel, NSString, UIScrollView, UILabel, UIView;

@interface AWEGDImageTabContainer : UIView <UIScrollViewDelegate>
...
@property (readonly, nonatomic) AWEGDImageTabModel *tabModel;
