@class NSString, AWEGrouponDynamicEventSubscriber, AWEBinding, UICollectionView;

@interface AWEGrouponDynamicFeedCell : AWEGrouponC2BaseFeedCell <UIGestureRecognizerDelegate, AWEGrouponC2ContainerFeedCellProtocol>

@property (retain, nonatomic) AWEBinding *bindDigg;
@property (retain, nonatomic) AWEGrouponDynamicEventSubscriber *subscriber;
@property (retain, nonatomic) AWEGrouponDynamicEventSubscriber *subscriber2;
@property (retain, nonatomic) AWEGrouponDynamicEventSubscriber *subscriber3;
@property (retain, nonatomic) AWEGrouponDynamicEventSubscriber *subscriber4;
@property (retain, nonatomic) AWEGrouponDynamicEventSubscriber *subscriber5;
@property (retain, nonatomic) AWEGrouponDynamicEventSubscriber *subscriber6;
@property (retain, nonatomic) AWEGrouponDynamicEventSubscriber *cardPlayEvent;
@property (retain, nonatomic) AWEGrouponDynamicEventSubscriber *c2AdCardClick;
