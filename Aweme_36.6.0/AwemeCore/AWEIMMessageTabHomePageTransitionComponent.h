...
@interface AWEIMMessageTabHomePageTransitionComponent : AWEIMComponentBase <AWEIMMessageTabRootViewControllerProtocol>
...
+ (BOOL)imMessageDisableCreateTransitionComponent;
