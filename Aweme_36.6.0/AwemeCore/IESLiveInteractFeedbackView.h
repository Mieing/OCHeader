@class UITableView, NSString, IESLiveInteractFeedbackViewModel, IESLiveInteractFeedbackStyleConfig, UIView, RACCompoundDisposable;

@interface IESLiveInteractFeedbackView : UIView <UITableViewDelegate, UITableViewDataSource>

@property (retain, nonatomic) UITableView *tableView;
@property (retain, nonatomic) IESLiveInteractFeedbackViewModel *viewModel;
