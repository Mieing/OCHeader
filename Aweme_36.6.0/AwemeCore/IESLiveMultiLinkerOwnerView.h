...
@protocol HTSLiveViewHierarchyProvider, IESLiveInteractUserModel, IESLiveMultiLinkerProvider, IESLiveMessageInteractionModule, HTSLiveDiggAction;
...
@property (weak, nonatomic) id<IESLiveMessageInteractionModule> interactionModule;
