@class IESLLLiveCardInfoModel, NSString;
@protocol IESLLLiveExpoundCardComboAnimationDelegate;

@interface IESLLLiveExpoundCardComboAnimationManager : NSObject <IESLLLiveExpoundCardComboAnimationProtocol>

@property (retain, nonatomic) IESLLLiveCardInfoModel *currentCardModel;
@property (retain, nonatomic) IESLLLiveCardInfoModel *followCardModel;
@property (copy, nonatomic) id /* block */ dismissBlock;
@property (nonatomic) BOOL hadShowComboFlyOut;
@property (weak, nonatomic) id<IESLLLiveExpoundCardComboAnimationDelegate> delegate;
...
- (unsigned long long)liveExpoundCardAnimationType;
- (void).cxx_destruct;
