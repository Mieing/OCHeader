@class NSString, NSTimer, IESLLPOIDetailTempoComponentViewModel, UIView, NSNumber;
@protocol IESLLTempoContainerProtocol;

@interface IESLLPOIDetailTempoComponentView : LLDitoComponentView

@property (weak, nonatomic) IESLLPOIDetailTempoComponentViewModel *viewModel;
