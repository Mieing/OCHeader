...
@interface AWEQuickShareNewImageTaskCreatePublishModelHandler : NSObject <AWEQuickShareNewTaskCreatePublishModelService>
...
- (void)initParameterizedCreationWithEditComposer:(id)a0 publishComposer:(id)a1 storyModel:(id)a2;
