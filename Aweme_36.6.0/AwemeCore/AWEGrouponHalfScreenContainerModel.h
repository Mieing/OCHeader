@class UIView, NSString, AWENearbyHalfStyleConfigModel, NSArray, AWEGrouponHalfShowAction, AWENearbyHalfClosedAction, NSDictionary, AWEGrouponHalfScreenGesturesInfo;
