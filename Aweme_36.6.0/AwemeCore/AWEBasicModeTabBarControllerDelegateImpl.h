@class NSString, AWEBasicModeTabBarUpdateSelectedOptions;

@interface AWEBasicModeTabBarControllerDelegateImpl : NSObject <AWEUserMessage, AWEBasicModeTabBarControllerDelegate>

@property (retain, nonatomic) AWEBasicModeTabBarUpdateSelectedOptions *selectedOptions;
