@class NSString, IESLiveNewGiftPanelContext, UIView, IESLiveGiftBuffLynxViewModel;

@interface IESLiveNewGiftPanelBuffCardItem : NSObject <IESLiveNewGiftPanelItemProtocol>
