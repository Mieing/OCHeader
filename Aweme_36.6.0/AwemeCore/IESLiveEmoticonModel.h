...
@property (nonatomic) unsigned long long lowPcuGuideChatType;
@property (copy, nonatomic) NSString *emoticonLabelStr;
@property (copy, nonatomic) NSString *emoticonDescription;
