...
@protocol IESLiveUserService, IESLiveMessageInteractionXRoomModule, IESLivePlayerControlViewHierarchyProvider, IESLiveSmallGiftConfigurationProtocol, IESLiveMessageListLayoutService, IESLiveGiftGlobalModule, HTSLiveMessageFilterAdapter, IESClearSceneInterface, HTSLiveViewHierarchyProvider, IESLiveRoomService, IESLiveFaceGiftRouter, HTSLiveNativeAnimationEventAction, IESLiveGiftFullLinkMonitor, HTSLiveGiftRouter, IESLiveMessageInteractionModule, IESLiveDanmakuService, IESLiveRevenueInteractModule;

@interface IESLiveRebornGiftAnimationStore : NSObject <IESLiveGiftPlayerDelegate, HTSLiveMessageSubscriber, HTSLiveSmallGiftAction, HTSLiveAudienceActions, IESLiveAutoRotateAction, IESLiveGameOpenPlatformShareScreenActionsAdapter, IESLiveUserEnterEffectNodeDelegate, IESLiveInteractAction, IESLiveAnchorRoomStatusChangeEvents, IESLivePublicScreenLayoutSubscriber, IESLiveEffectsDownloadConfigMonitor, IESLiveGiftAnimationStoreProtocol>
...
@property (retain, nonatomic) id<IESLiveMessageInteractionModule> messageInteractionModule;
@property (retain, nonatomic) id<IESLiveMessageInteractionXRoomModule> messageInteractionXModule;
