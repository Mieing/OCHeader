...
+ (id)sessionWithContext_new:(id)a0;
...
- (void)_flex_swizzle_6ae57752_URLSession:(id)a0 task:(id)a1 didCompleteWithError:(id)a2;
- (void)URLSession:(id)a0 dataTask:(id)a1 didReceiveResponse:(id)a2 completionHandler:(id /* block */)a3;
- (void)_flex_swizzle_4f2f1d41_URLSession:(id)a0 dataTask:(id)a1 didReceiveData:(id)a2;
