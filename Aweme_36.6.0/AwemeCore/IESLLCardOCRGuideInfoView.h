@class UIButton, IESLLOCRCardItemConfig, UIScrollView, UILabel, NSMutableArray;

@interface IESLLCardOCRGuideInfoView : UIView
...
@property (retain, nonatomic) IESLLOCRCardItemConfig *config;
