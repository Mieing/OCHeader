@interface IESIMGroupSettingsGroupCollectComponent : AWEIMComponentBase <IESIMChatSettingsItemProvider, AWEIMMediaDetailTransitionOuterContextProvider, AWEZoomTransitionOuterContextProvider, IESIMFriendsAlbumInflowListDataControllerDelegate, IESIMFriendsAlbumActionMessage> {
