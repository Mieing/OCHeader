...
+ (BOOL)enableAnchorStayTimeTrackOpt;
+ (id)sharedInstance;
...
- (void)handleAnchorDetailPageEnterEventWithContext:(id)a0;
- (void)handleCommonComponentEnterEventWithContext:(id)a0;
- (void)handleAnchorDetailPageDismissEventWithContext:(id)a0;
- (void)handleCommonComponentDismissEventWithContext:(id)a0;
- (void)handleAnchorDetailPageResetEventWithContext:(id)a0;
...
- (id)logInfoForAnchorTrackInfoModelList:(id)a0;
- (id)whiteListForDisableLifeCycleTrack;
- (BOOL)isAnchorTrackBasicConditionsSatisfiedWithContext:(id)a0;
- (id)getAnchorTrackInfoModelWithContext:(id)a0;
- (void).cxx_destruct;
