@class EEUIAnnotationCacheUIMore, NSString, EEUIAnnotationParser;

@interface EEUIAnnotationCache : EEUIAnnotationBase <EEUIAnnotationPrivate, EEUIAnnotation>

@property (nonatomic) struct shared_ptr<EffectTemplateEditor::UIAnnotationCache> { struct UIAnnotationCache *__ptr_; struct __shared_weak_count *__cntrl_; } annotationPtr;
@property (weak, nonatomic) EEUIAnnotationParser *annotationParser;
@property (retain, nonatomic) EEUIAnnotationCacheUIMore *uiMore;
