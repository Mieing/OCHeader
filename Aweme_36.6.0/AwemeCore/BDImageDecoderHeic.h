...
@property (nonatomic) struct TTHEIFContext { struct TTBytevc1DecoderContext *dec_ctx; struct TTHeifBox *heif_box; } context;
@property long long frames;
...
+ (long long)parseThumbLocationForHeicData:(id)a0 minDataSize:(long long *)a1;
+ (BOOL)isStaticHeicImage:(id)a0;
+ (BOOL)supportDecodeThumbFromHeicData;
+ (BOOL)isHDRData:(id)a0;
...
- (int)_heifDownsampleMode;
- (struct HeifOutputStream { unsigned int x0; char *x1; unsigned int x2; char *x3; unsigned long long *x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned long long x8; unsigned long long x9; unsigned char x10; char *x11; unsigned int x12; unsigned char x13; struct HeifColrInfo { unsigned int x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned char x4; } x14; int x15; })decodeAnimatedImageAtIndex:(unsigned long long)a0;
- (int)_heicDownsampleMode;
