...
@interface AWEECOMIMFTSMessageData : NSObject <WCTTableCoding, AWEECOMIMFTSMessageDataProtocol> {
...
+ (const void *)ss_msgId;
+ (const void *)ss_messageType;
+ (const void *)ss_aweType;
+ (id)swift_ss_msgId;
+ (id)swift_ss_messageType;
+ (id)swift_ss_aweType;
