@class BDCTWaitingView, NSString, UIImageView, UIImage, UILabel, BDCTIndicatorContentView, UIView;

@interface BDCTIndicatorView : UIView
...
@property (retain, nonatomic) BDCTWaitingView *indicatorWaitingView;
@property (retain, nonatomic) BDCTIndicatorContentView *contentView;
...
+ (void)showIndicatorForFollowMessage:(id)a0;
