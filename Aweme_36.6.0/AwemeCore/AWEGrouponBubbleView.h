@class AWEGrouponAttributedLabel, UIImageView, AWEGrouponBubbleModel, UILabel, UIButton;
...
@property (retain, nonatomic) AWEGrouponAttributedLabel *attributedLabel;
@property (nonatomic) BOOL didSetup;
@property (retain, nonatomic) AWEGrouponBubbleModel *model;
