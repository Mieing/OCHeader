@class NSString, AWEGrouponLifeFeedsLynxComponentVM, UIView, AWEGrouponLifeFeedsLynxItem, AWEGrouponLifeFeedsLynxPlugin;
@protocol AnnieXContainerBaseProtocol;

@interface AWEGrouponLifeFeedsLynxComponentView : AWEGrouponLifeFeedsBaseComponentView <AWEImageMonitorDelegate>
