...
@interface AWELivePreDanmakuSettingSliderView : UIView
...
@property (nonatomic) BOOL didLayoutForWidth;
@property (nonatomic) unsigned long long panStartIndex;
...
@property (copy, nonatomic) id /* block */ valueChangingBlock;
