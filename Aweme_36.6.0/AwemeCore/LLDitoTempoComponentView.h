@class _TtC8TempoiOS13TempoRootView, NSString, UIView, LLDitoTempoComponentViewModel;

@interface LLDitoTempoComponentView : LLDitoComponentView <TempoiOS.TempoRootViewDelegate>

@property (weak, nonatomic) LLDitoTempoComponentViewModel *viewModel;
