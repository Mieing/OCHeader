@class AWELifeFeedsNetworkImpl, NSDictionary, NSMutableDictionary, AWELifeFeedsDataParseTask;
@protocol AWENearbyModuleService;

@interface AWELifeFeedsFetchDataTask : NSObject

@property (retain, nonatomic) AWELifeFeedsNetworkImpl *networkImpl;
@property (retain, nonatomic) AWELifeFeedsDataParseTask *parseTask;
