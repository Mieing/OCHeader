@interface AWEFormatImpl.FormatLiveXPlayBottomLoadingView : UIView {
    void /* unknown type, empty encoding */ loadStatue;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_progressParentView;
