...
@interface BDPPluginAppInputComponent : BDPBridgeInstancePlugin

@property (retain, nonatomic) NSMapTable *views;

+ (unsigned long long)pluginMode;

- (id)componentIDKeyWithInstance:(id)a0 componentID:(id)a1;
...
- (void)showTextAreaKeyboardWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
- (void).cxx_destruct;
- (id)init;
