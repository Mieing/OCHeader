@class NSString, HTSLiveCommon, GPBInt32Array, NSMutableDictionary, NSMutableArray;
...
@property (retain, nonatomic) NSMutableArray *conditionsDetailArray;
@property (readonly, nonatomic) unsigned long long conditionsDetailArray_Count;
...
@property (copy, nonatomic) NSString *extraAwardUiConfig;
