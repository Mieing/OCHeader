...
@interface AWEFeedVideoLocalLifeAnchorV2UserActionUtils : NSObject <AWEUserMessage>

@property (retain, nonatomic) AWEAwemeModel *aweme;
@property (retain, nonatomic) NSArray *handleEventAry;
@property (nonatomic) BOOL hasStartMonitor;
@property (weak, nonatomic) id<AWEFeedVideoLocalLifeAnchorV2UserActionDelegate> userActionDelegate;
