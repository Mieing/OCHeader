...
+ (id)constModelWithSocialType:(unsigned long long)a0 effectModelInfo:(id)a1;

- (void)p_setupIconFontWithIsMention:(BOOL)a0;
- (id)initWithSocialType:(unsigned long long)a0 effectModelInfo:(id)a1;
- (void).cxx_destruct;
