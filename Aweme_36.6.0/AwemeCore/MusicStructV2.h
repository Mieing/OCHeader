...
@property (nonatomic) int maskCover;
@property (nonatomic) BOOL hasMaskCover;
@property (copy, nonatomic) NSString *passThrough;
@property (nonatomic) BOOL hasPassThrough;
@property (nonatomic) long long clipMaterialId;
@property (nonatomic) BOOL hasClipMaterialId;
@property (nonatomic) long long clipId;
@property (nonatomic) BOOL hasClipId;
@property (nonatomic) long long materialUseCount;
@property (nonatomic) BOOL hasMaterialUseCount;
@property (nonatomic) BOOL showOriginClip;
@property (nonatomic) BOOL hasShowOriginClip;
