@class IESLiveScreencastMultiDeviceObject, NSString, UIImage, BDCastServiceInfo;
@protocol IESLiveScreencastMultiDeviceSinkDelegate;

@interface IESLiveScreencastMultiDeviceSink : NSObject <BDCastSinkManagerDelegate>
...
@property (weak, nonatomic) id<IESLiveScreencastMultiDeviceSinkDelegate> delegate;
@property (nonatomic) BOOL useSourceBroadcast;
