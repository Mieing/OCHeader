...
@interface IESECLiveGoodsModelUpdaterV2 : NSObject <IESECLiveEventPlugin, IESECLiveMessageSubscriber, IESECLiveMessageSubscriber, IESECMessageSubscriber>
...
- (void)refreshGoodsViewModels:(id)a0 allGoodsViewModels:(id)a1 refreshMessage:(id)a2;
