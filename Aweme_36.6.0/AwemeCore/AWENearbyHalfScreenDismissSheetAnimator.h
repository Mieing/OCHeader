@class AWENearbyHalfScreenSheetAnimation, AWENearbyHalfScreenDismissAnimator;

@interface AWENearbyHalfScreenDismissSheetAnimator : AWENearbyHalfScreenDismissAnimator
