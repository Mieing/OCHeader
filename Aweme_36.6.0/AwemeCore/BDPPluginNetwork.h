@class NSRecursiveLock, NSMutableDictionary, NSTimer, BDPThreadSafeDictionary, NSArray, BDPUniqueID;

@interface BDPPluginNetwork : BDPBridgeInstancePlugin <BDPAPIInterruptionMessage> {
...
@property (retain, nonatomic) BDPThreadSafeDictionary *serverSendEventEvents;
@property (retain, nonatomic) NSTimer *serverEventTimer;
...
- (void)callbackError:(id /* block */)a0 appTask:(id)a1 stateChangeEventName:(id)a2 error:(id)a3 uniqueID:(id)a4 pageID:(long long)a5;
...
- (id)appendExtraFieldToHeader:(id)a0 forURL:(id)a1 uniqueID:(id)a2 from:(id)a3;
- (id)currentPagePath:(id)a0;
- (id)currentPageUrl:(id)a0;
- (id)startPagePath:(id)a0;
- (id)startPageUrl:(id)a0;
- (BOOL)isCurrentPageFP:(id)a0;
- (void)addCustomDataIfNeededWithRequestParam:(id)a0 uniqueID:(id)a1;
- (BOOL)addPriorityParam;
...
- (void)processEventSourceWithEvent:(id)a0 appTask:(id)a1 data:(id)a2 SSETaskID:(long long)a3 pageID:(long long)a4;
- (id)generateNewServerEventModel;
- (id)taskForId:(long long)a0;
- (void)_requestServiceWithParam:(id)a0 sid:(id)a1 callback:(id /* block */)a2 instance:(id)a3 startTime:(double)a4 sidCost:(double)a5;
...
- (void)stopAllBackgroundServerEventTask:(id)a0;
- (id)defaultSchemaSupportList:(id)a0;
- (void)createRequestTaskWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
- (void)createRequestTaskSyncWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
- (void)operateRequestTaskWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
- (void)createInnerRequestTaskSyncWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
...
- (void)createInnerEventSourceTaskSyncWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
- (void)createEventSourceTaskSyncWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
- (void)operateEventSourceTaskWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
...
- (void)preloadImagesWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
- (void)clearPrefetchCacheWithParam:(id)a0 callback:(id /* block */)a1 instance:(id)a2;
- (void).cxx_destruct;
- (id)init;
- (void)dealloc;
