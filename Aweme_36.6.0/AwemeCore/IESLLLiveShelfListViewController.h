@class IESLLLiveShelfHeaderLoadingView, UIViewController, NSString, CALayer, NSNumber, IESLLFeedRefreshFooter;
@protocol IESLLLiveShelfPagingListDelegate;

@interface IESLLLiveShelfListViewController : AWEBaseListViewController <UIScrollViewDelegate>
...
@property (retain, nonatomic) IESLLLiveShelfHeaderLoadingView *mjHeader;
...
@property (weak, nonatomic) UIViewController<IESLLLiveShelfPagingListDelegate> *delegate;
