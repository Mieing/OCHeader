@class HTSEventContext, NSString, IESLiveComponentContext, IESLivePetRabbitMessageQueue;
@protocol IESLiveRoomService, IESLivePetRabbitReaction;

@interface IESLivePetRabbitStore : NSObject <HTSLiveMessageSubscriber, HTSLiveMessageSubscriber>
