...
- (void)generateDownloadAndTaskReviewWithResultWithGeneratedImages:(id)a0 waterMarkImages:(id)a1 coverImages:(id)a2 videos:(id)a3 watermarkVideos:(id)a4 livePhoto:(id)a5 watermarkLivephoto:(id)a6 textResources:(id)a7 postProcessIdList:(id)a8 ugcEffectId:(id)a9 effectId:(id)a10 requestModel:(id)a11 resultModel:(id)a12 complete:(id /* block */)a13;
