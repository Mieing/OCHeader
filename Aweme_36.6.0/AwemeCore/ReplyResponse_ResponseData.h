@class IESLiveUserVersionInfo, NSString, IESLiveMultiLiveCoreInfo, IESLiveMultiRtcInfo, GPBInt64ObjectDictionary, IESLiveMultiChannelInfo, IESLiveAnchorLayoutInfo, NSMutableArray, IESLivePreRTCInfo, IESLiveAnchorLinkmicChannelInfo, IESLiveClientUIInfo;
...
@property (retain, nonatomic) IESLiveUserVersionInfo *inviteVersionInfo;
