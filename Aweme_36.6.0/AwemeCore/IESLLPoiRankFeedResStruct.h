@class NSArray, NSString, IESLLPoiRankConfigModel, IESLLifeURLModel;

@interface IESLLPoiRankFeedResStruct : MTLModel <MTLJSONSerializing>
...
@property (retain, nonatomic) IESLLifeURLModel *rankBarIconURL;
@property (retain, nonatomic) IESLLifeURLModel *rankFloatIconURL;
@property (copy, nonatomic) NSString *rankTopURL;
@property (copy, nonatomic) NSString *rankBottomURL;
@property (retain, nonatomic) IESLLPoiRankConfigModel *rankConfig;
