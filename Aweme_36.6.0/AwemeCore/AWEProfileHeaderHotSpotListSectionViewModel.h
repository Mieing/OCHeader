...
@interface AWEProfileHeaderHotSpotListSectionViewModel : AWEBaseListSectionViewModel <AWEProfileHeaderSectionViewModelProtocol>

@property (readonly, nonatomic) AWEProfileHeaderContext *context;
@property (readonly, nonatomic) double setionTopPadding;
