@class IESLiveMessageListBasePriorityQueue, NSMutableArray, NSString;
@protocol IESLivePublicScreenMonitorProtocol;

@interface IESLiveMessageFeaturedDataHandler : NSObject <IESLivePublicScreenMessageHandlerProtocol, IESLivePublicScreenNodeHandlerProtocol>
...
@property (retain, nonatomic) IESLiveMessageListBasePriorityQueue *aiMessagesQueue;
@property (retain, nonatomic) IESLiveMessageListBasePriorityQueue *aiNodesQueue;
...
- (id)allBufferNodes;
- (void)removeMessageAndNodeBufferWithMaxTotalCount:(long long)a0;
- (void)removeAllMessageAndNodeBuffersData;
- (void).cxx_destruct;
- (id)init;
