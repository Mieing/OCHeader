@class IESLiveGiveGiftTimeTraceTool, HTSLiveGiftStruct, HTSLiveText, HTSLiveSendTogether, NSDictionary, HTSLiveGiftTrayInfo, GPBInt64Array, HTSLiveUser, HTSLiveCommon, HTSLiveGiftIMPriority, NSMutableArray, HTSLiveGiftBanner, NSString, HTSLiveAnchorGiftData, HTSLiveRoomHotInfo, HTSLiveGiftMessage_TextEffect, HTSLiveExtraEffect, HTSLiveAssetEffectMixInfo, HTSLivePublicAreaCommon;
...
@property (copy, nonatomic) NSString *comboLimitCountText;
...
@property (nonatomic) BOOL useRoomMessage;
@property (nonatomic) long long count;

+ (long long)getSendGiftAbnormalType:(id)a0;
+ (id)sugarDaddyUserWithDisplayText:(id)a0 currentUser:(id)a1;
+ (id)messagesGiftSendResponseData:(id)a0 sendUser:(id)a1 toUser:(id)a2 room:(id)a3 extraData:(id)a4 giftIDForSendRequest:(id)a5 traceTool:(id)a6;
+ (id)messagesPropConsumeResultData:(id)a0 sendUser:(id)a1 toUser:(id)a2 room:(id)a3 extraData:(id)a4;
+ (id)splitSeriesGiftMessage:(id)a0;
+ (id)descriptor;

- (BOOL)hasEffectMixImages;
- (void)configSendGiftAbnormalTypeWithGiftData:(id)a0 giftIdForSendRequest:(id)a1;
