...
@property (copy, nonatomic) NSString *remoteIpAddress;
@property (nonatomic) long long remotePort;
@property (nonatomic) long long connectionType;
@property (nonatomic) long long connectionTag;
@property (copy, nonatomic) NSString *socketId;
@property (nonatomic) unsigned int leftReadBytes;
@property (copy, nonatomic) NSData *unhandledData;
...
- (id)bdleDescription;
- (id)connectionTypeDesc;
- (id)errorWithErrno:(int)a0 reason:(id)a1;
...
- (BOOL)connectToNetService:(id)a0 error:(id *)a1;
