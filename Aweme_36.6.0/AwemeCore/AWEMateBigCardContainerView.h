@class UIView, AWEMateBigCardViewModel, NSString, UIImageView, AWEBinding, CAGradientLayer, AWEMateBigCardView, MASConstraint, AWEUserRecommendBigCardFooterView;
