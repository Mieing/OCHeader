...
+ (void)setupDefaultSeparatorHeight:(double)a0 separatorInsets:(struct AWEListKitSeparatorInsets { double x0; double x1; })a1 separatorColor:(id)a2;
...
- (id)erasedToAny;
- (id)cellControllerAtIndex:(long long)a0;
- (BOOL)enableMovementAtIndex:(long long)a0 model:(id)a1;
- (id)getCellControllerWithCellViewModel:(id)a0;
