@interface AWEStoryImpl.StoryFeedDataController : AWEStoryKit.StoryKitBaseController <AWEBaseListUpdateDelegate, AWEStoryKit.StoryKitViewControllerLifeCycle> {
