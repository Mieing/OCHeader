...
@interface AWEShareReflowStrategyWebView : NSObject <AWEShareReflowStrategy>
...
- (void)fixedURLStringIfNeed;
- (void)getMetaInfosFromScheme:(id)a0 completion:(id /* block */)a1;
- (void)p_getMetaInfosFromUrl:(id)a0 completion:(id /* block */)a1;
- (void).cxx_destruct;
- (id)descriptionText;
- (id)tokenType;
