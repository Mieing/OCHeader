...
@interface IESLLLiveExpoundCardLynxModuleManager : NSObject <LLCubeViewDelegate>

@property (retain, nonatomic) IESLLLiveLynxView *loadingLynxModule;
@property (retain, nonatomic) IESLLLiveLynxView *readyLynxModule;
