...
- (void)_flex_swizzle_db15d1bf_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_47f64b07_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_15c7f70b_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_41187c72_connection:(id)a0 didReceiveData:(id)a1;
- (id)_flex_swizzle_450ea977_connection:(id)a0 willSendRequest:(id)a1 redirectResponse:(id)a2;
