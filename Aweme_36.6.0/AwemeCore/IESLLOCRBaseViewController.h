@class NSTimer, AVCaptureVideoPreviewLayer, IESLLCardOCRPageParams, NSString, AVCaptureSession, NSObject, AVCaptureDevice, IESLLCardOCRScanView, AVCaptureVideoDataOutput, IESLLCardOCRConfig;
@protocol OS_dispatch_queue;

@interface IESLLOCRBaseViewController : UIViewController <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property (retain, nonatomic) IESLLCardOCRScanView *ocrScanView;
...
@property (retain, nonatomic) IESLLCardOCRPageParams *params;
@property (retain, nonatomic) IESLLCardOCRConfig *cardOCRConfig;
