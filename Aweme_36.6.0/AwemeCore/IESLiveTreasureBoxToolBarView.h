@class UIImageView, IESLiveTreasureBoxToolBarCountDownView, UIView, NSTimer;
@protocol IESLiveWebPPlayer;

@interface IESLiveTreasureBoxToolBarView : UIView

@property (retain, nonatomic) UIView *containerView;
@property (retain, nonatomic) IESLiveTreasureBoxToolBarCountDownView *countDownView;
