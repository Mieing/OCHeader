...
@interface AWESearchGuideSearchSlidingTabBar : UICollectionView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>

@property (weak, nonatomic) id<AWESearchGuideSearchSlidingTabBarProtocol> guideSearchSlidingTabBarDelegate;
