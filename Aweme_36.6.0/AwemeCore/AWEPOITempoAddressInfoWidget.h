@class AWEPOITempoAddressInfoView, IESLLTempoAnimationContext, IESLLTempoContext, NSString, UIView, NSMutableArray;
@protocol IESLLTempoNodeProtocol, IESLLTempoWidgetProtocol;

@interface AWEPOITempoAddressInfoWidget : IESLLTempoBaseWidget <IESLLTempoWidgetProtocol>

@property (weak, nonatomic) AWEPOITempoAddressInfoView *nodeView;
