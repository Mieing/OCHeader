@interface AWELivePreStreamInteractAnchorGuidePointElement : AWELiveLeftBaseElement {
    void /* unknown type, empty encoding */ OneDayTime;
...
- (void)hideElementWithReason:(id)a0;
- (void)anchorGuidePointClicked;
- (void).cxx_destruct;
- (void)setData:(id)a0;
- (id)init;
