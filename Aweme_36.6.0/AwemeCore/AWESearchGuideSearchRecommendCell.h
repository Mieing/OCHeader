@class UIView, AWEGuideSearchWordModel, AWEEcommerceGuideSearchAttachedTextView, AWEEcommerceGuideSearchAttributeView, NSDictionary, AWEEcomSearchWebImageView, UILabel, AWEEcommerceSearchTagView;

@interface AWESearchGuideSearchRecommendCell : UICollectionViewCell
