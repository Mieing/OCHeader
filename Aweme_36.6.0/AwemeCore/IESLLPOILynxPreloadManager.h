@class NSString, NSMutableDictionary, LLDitoLynxManager;

@interface IESLLPOILynxPreloadManager : NSObject <LLCubeViewDelegate>
...
@property (weak, nonatomic) LLDitoLynxManager *ditoLynxManager;
