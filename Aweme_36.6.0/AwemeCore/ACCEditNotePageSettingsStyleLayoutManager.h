@class ACCEditNextButtonViewHolder, NSMapTable, ACCEditToolBarBubbleViewHolder, ACCEditNotePagePreviewViewHolder, AWEVideoPublishViewModel, NSString, ACCEditBottomToolBarViewHolder;
@protocol ACCSequenceEditServiceProtocol, IESServiceProvider, ACCEditViewContainer, ACCComponentManager;

@interface ACCEditNotePageSettingsStyleLayoutManager : NSObject <ACCEditUILayoutManagerProtocol>
...
@property (retain, nonatomic) ACCEditToolBarBubbleViewHolder *toolBarBubbleViewHolder;
