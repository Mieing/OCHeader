@class UIViewController, NSString, DUXLoadingParticleView, AWEPOIDetailVideosPreviewPauseIcon, AWEPOIVideoPlayerCore;
@protocol AWEPOIDetailUGCVideoPlayerDelegate;

@interface AWEPOIDetailUGCVideoPlayerView : UIView <IESVideoPlayerDelegate>
...
@property (weak, nonatomic) id<AWEPOIDetailUGCVideoPlayerDelegate> delegate;
