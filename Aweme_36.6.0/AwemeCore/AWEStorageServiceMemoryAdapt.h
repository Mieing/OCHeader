...
@interface AWEStorageServiceMemoryAdapt : AWEStorageServiceAdapt <AWEStorageServiceKVUniversal> {
...
- (id)initWithDomain:(id)a0 configuration:(id)a1;
- (void)setupMemoryCache:(id)a0 withConfiguration:(id)a1;
- (void).cxx_destruct;
