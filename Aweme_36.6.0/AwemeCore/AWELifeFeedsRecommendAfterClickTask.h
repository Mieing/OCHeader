@class AWELifeFeedsBaseComponentVM, AWELifeFeedsBaseComponentView, AWELifeFeedsPageContext, NSDictionary;
@protocol AWEHttpTask;

@interface AWELifeFeedsRecommendAfterClickTask : NSObject
