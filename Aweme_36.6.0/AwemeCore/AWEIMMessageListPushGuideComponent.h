@class NSSet, NSString, AWEIMPushGuideAlertConfig, UIViewController;
@protocol IESIMContentSheetVCProtocol;

@interface AWEIMMessageListPushGuideComponent : AWEIMComponentBase <AWEIMMessageListPushGuideComponentService, IESIMUGPushGuideByPitayaExecutorMessage, AWEIMPushGuideTextMsgTipsInteractor_Action, AWEIMMessageListDataAction, IESIMSheetVCDelegate>
...
@property (retain, nonatomic) AWEIMPushGuideAlertConfig *alertConfig;
