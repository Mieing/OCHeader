@class IESLLLiveShelfCellAddressView, UILabel, NSDictionary, IESLLLiveShelfListGoodsModel, IESLLLiveShelfCellViewModel, UIButton, UIView, IESLLLiveShelfCellIconView, LLPageContext, IESLLLiveShelfCellSeckillView, UIStackView, IESLLLiveShelfCellPriceView, UIImageView;

@interface IESLLLiveShelfListGoodsCell : UICollectionViewCell

@property (retain, nonatomic) UIView *backgroundContainerView;
@property (retain, nonatomic) IESLLLiveShelfCellIconView *iconView;
@property (retain, nonatomic) UILabel *poiTitleLabel;
@property (retain, nonatomic) IESLLLiveShelfCellAddressView *poiAddressView;
@property (retain, nonatomic) UILabel *deliveryLabel;
@property (retain, nonatomic) UIStackView *couponContainerView;
@property (retain, nonatomic) IESLLLiveShelfCellSeckillView *seckillView;
@property (retain, nonatomic) UILabel *salesLabel;
@property (retain, nonatomic) IESLLLiveShelfCellPriceView *priceView;
@property (retain, nonatomic) UIButton *actionBtn;
@property (retain, nonatomic) IESLLLiveShelfCellViewModel *viewModel;
