...
- (id)initWithTEReaderUnit:(void *)a0 asbd:(struct AudioStreamBasicDescription { double x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; })a1;
- (void)getOutputBufferList:(struct AudioBufferList **)a0;
- (void).cxx_destruct;
- (id).cxx_construct;
- (void)reset;
- (void)dealloc;
- (void)processAudioSamples:(struct AudioBufferList { unsigned int x0; struct AudioBuffer { unsigned int x0; unsigned int x1; void *x2; } x1[1]; } *)a0;
