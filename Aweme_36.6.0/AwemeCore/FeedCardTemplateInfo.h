@class NSString, FeedCardEventTrackInfo, FeedCardBackgroundInfo, FeedCardGaiYaInfo, FeedCardDislikeButtonInfo, FeedCardActionButtonInfo, FeedCardLynxConfig, FeedCardSubscribeConfig, FeedCardEventPushConfig, FeedCardNativeConfig;
...
@property (copy, nonatomic) NSString *frameCardUniqueId;
@property (nonatomic) BOOL hasFrameCardUniqueId;
@property (copy, nonatomic) NSString *frameExtra;
@property (nonatomic) BOOL hasFrameExtra;
@property (copy, nonatomic) NSString *containerType;
@property (nonatomic) BOOL hasContainerType;
@property (retain, nonatomic) FeedCardEventPushConfig *eventPushConfig;
@property (nonatomic) BOOL hasEventPushConfig;
@property (copy, nonatomic) NSString *feedCardUuid;
@property (nonatomic) BOOL hasFeedCardUuid;
