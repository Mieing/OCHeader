@class NSString, AWEPOIDetailUGCPhotosPreviewViewController, DUXLoadingParticleView, NSMutableArray, UIView;
@protocol BDXViewContainerProtocol;

@interface AWEPOIUGCCommentDataProvider : NSObject <AWEPOIUGCPreviewViewControllerLoadMoreDelegate, AWEPOIUGCPreviewViewControllerBounceDelegate>
...
@property (weak, nonatomic) AWEPOIDetailUGCPhotosPreviewViewController *photosPreviewViewController;
