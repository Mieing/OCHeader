@interface AWEGrouponResourceUtils : NSObject
...
+ (BOOL)shouldPopAvoidColdLaunch:(unsigned long long)a0;
+ (unsigned long long)getPopAvoidTypeWithModel:(id)a0;
+ (BOOL)shouldPopAvoidColdLaunch:(unsigned long long)a0 isColdLaunchShown:(BOOL)a1;
