...
+ (void)doShowBubbleWithEnterBubble:(id)a0 pageType:(long long)a1 task:(id)a2;
+ (void)p_doShowBubbleWithGeneralBubble:(id)a0 pageType:(long long)a1 task:(id)a2;
+ (void)updateBubbleFrequencyKeyWithBubbleModel:(id)a0;
+ (void)showTaskBubbleWithEnterBubble:(id)a0 pageType:(long long)a1 task:(id)a2;
