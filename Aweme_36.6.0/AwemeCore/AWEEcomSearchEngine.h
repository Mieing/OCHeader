...
@protocol AWEEcomSearchStrategyProtocol, AWEHttpTask, AWEEcomSearchDataStoreProtocol, OS_dispatch_queue, AWEEcomSearchEngineConfigurationProtocol;

@interface AWEEcomSearchEngine : NSObject <CSPChunkRequestDelegate, AWEEcomSearchChunkProcessorManagerDelegate, AWEEcomSearchEngineProtocol>

@property (retain, nonatomic) NSObject<OS_dispatch_queue> *searchQueue;
@property (retain, nonatomic) NSHashTable *listeners;
@property (retain, nonatomic) NSObject<AWEEcomSearchEngineConfigurationProtocol> *searchConfiguration;
