...
@interface AWEECOMIMRateEmotionOldView : UIView <UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, AWEECOMIMTextViewComponentDelegate>
...
- (void)updateTagListViewWithList:(id)a0 selectedTagList:(id)a1;
