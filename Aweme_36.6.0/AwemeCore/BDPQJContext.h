@class NSString, NSMutableDictionary, JSVirtualMachine, JSValue;
@protocol BDPValueProtocol;

@interface BDPQJContext : NSObject <BDPContextProtocol> {
    struct LEPUSContext { } *qjs_context;
    BOOL external;
}

@property (retain, nonatomic) NSMutableDictionary *errorInfo;
@property (readonly, nonatomic) id<BDPValueProtocol> exception;
@property (readonly, nonatomic) struct OpaqueJSContext { } *JSGlobalContextRef;
@property (readonly, nonatomic) id context;
@property (copy, nonatomic) NSString *name;
@property (copy, nonatomic) id /* block */ exceptionHandler;
@property (readonly, nonatomic) unsigned long long runtimeType;
@property (nonatomic) long long logExceptionFlag;
