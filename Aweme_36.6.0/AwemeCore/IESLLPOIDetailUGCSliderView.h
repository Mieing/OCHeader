@class IESLLPOIVideoProgressSlider, UIView;
@protocol IESLLPOIDetailUGCSliderDelegate;

@interface IESLLPOIDetailUGCSliderView : UIView

@property (nonatomic) long long currentIndex;
@property (nonatomic) long long totalCount;
@property (retain, nonatomic) UIView *indexSlider;
@property (retain, nonatomic) IESLLPOIVideoProgressSlider *progressSlider;
@property (nonatomic) BOOL isSliding;
@property (weak, nonatomic) id<IESLLPOIDetailUGCSliderDelegate> delegate;
