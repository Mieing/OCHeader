...
@interface SECURLFormatTask : NSObject <SECURLFormatProtocol>
...
- (void)prepareURL;
- (id)formatCDNURL:(id)a0;
- (id)formatSchemaURL:(id)a0;
- (id)formatFileURL:(id)a0;
- (id)formatURLByRemoveGurdKey;
