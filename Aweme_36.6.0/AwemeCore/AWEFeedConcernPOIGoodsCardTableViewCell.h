@class NSString, AWEFeedConcernPOIGoodsCellViewController, AWEAwemeModel, UIView, UIViewController;
@protocol UIScrollViewDelegate;

@interface AWEFeedConcernPOIGoodsCardTableViewCell : UITableViewCell <AWEFeedTableViewCellProtocol>

@property (retain, nonatomic) AWEFeedConcernPOIGoodsCellViewController *viewController;
