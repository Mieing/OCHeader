...
@interface TVLLSSStrategyController : NSObject {
    struct shared_ptr<livecore::liveplayer::LSSStrategyController> { struct LSSStrategyController *__ptr_; struct __shared_weak_count *__cntrl_; } _LSSStrategyController;
}
