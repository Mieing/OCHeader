...
@interface ILASkeleton : NSObject
...
@property (copy, nonatomic) NSArray *points_xy;
@property (copy, nonatomic) NSArray *points_detected;
@property (copy, nonatomic) NSArray *points_score;
