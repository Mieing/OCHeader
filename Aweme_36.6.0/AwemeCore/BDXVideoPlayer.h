@class NSDictionary, NSString, UIImageView, NSTimer, BDXVideoPlayerConfiguration, UIView, BDXVideoPlayerVideoModel;
@protocol BDXVideoPlayerDelegate, BDXVideoFullScreenPlayer, BDXVideoCorePlayerProtocol;
...
@property (retain, nonatomic) id<BDXVideoCorePlayerProtocol> corePlayer;
@property (weak, nonatomic) id<BDXVideoFullScreenPlayer> fullScreenPlayer;
...
@property (weak, nonatomic) id<BDXVideoPlayerDelegate> delegate;
