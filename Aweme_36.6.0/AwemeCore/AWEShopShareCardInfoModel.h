@class NSString, NSArray, AWEShopXZGInfoModel, AWEURLModel;

@interface AWEShopShareCardInfoModel : MTLModel <MTLJSONSerializing>

@property (nonatomic) long long shopId;
@property (copy, nonatomic) NSString *shopName;
@property (retain, nonatomic) AWEURLModel *shopLogo;
@property (copy, nonatomic) NSArray *tagList;
@property (copy, nonatomic) NSString *score;
@property (retain, nonatomic) AWEShopXZGInfoModel *shopXzgInfo;
