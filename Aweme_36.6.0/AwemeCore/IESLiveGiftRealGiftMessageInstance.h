...
@protocol HTSLiveViewHierarchyProvider, HTSLiveNativeAnimationEventAction, IESLiveMessageInteractionModule, IESLiveMessageInteractionXRoomModule, IESLiveGiftGlobalModule, IESLiveScreenModule, IESLiveFaceGiftRouter;
...
@property (weak, nonatomic) id<IESLiveMessageInteractionModule> messageInteractionModule;
@property (weak, nonatomic) id<IESLiveMessageInteractionXRoomModule> messageInteractionXModule;
