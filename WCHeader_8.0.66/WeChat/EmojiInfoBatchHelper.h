@interface EmojiInfoBatchHelper : NSObject {
    ...
    struct shared_ptr<emoticon::EmojiInfoBatchHelperCppCover> { struct EmojiInfoBatchHelperCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmojiInfoBatchHelperDispatcher> { struct EmojiInfoBatchHelperDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmojiInfoBatchHelperDispatcher> { struct EmojiInfoBatchHelperDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)init:(id)a0 createName:(const void *)a1 svrIdentity:(const void *)a2;
- (id)zidlObjToHolder;
- (void)getEmojiInfoAsync:(id)a0 completion:(id /* block */)a1;
- (void)getEmojiInfoAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
