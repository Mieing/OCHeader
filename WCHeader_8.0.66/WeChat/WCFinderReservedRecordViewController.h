@class MMFinderLiveReservedRecordViewModel, FinderLivePersonalCenterPrepareInfo, WCTimeLineFooterView, MMFinderLiveReserveNoticeLogic, UILabel, NSString, MMTableView;
