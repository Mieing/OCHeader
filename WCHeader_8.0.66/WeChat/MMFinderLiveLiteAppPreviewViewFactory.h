...
@interface MMFinderLiveLiteAppPreviewViewFactory : NSObject <FlutterPlatformViewFactory>

@property (weak, nonatomic) id<MMFinderLiveLiteAppPreviewViewFactoryDataSource> dataSource;
