@class WCFinderComment, NSString, WCFinderSizingRichTextView, UIView, WCFinderHotCommentStyleConfig, UIImageView, RichTextView, UILabel;
...
@property (retain, nonatomic) WCFinderHotCommentStyleConfig *styleConfig;
...
- (id)suffixLabelColor;
- (id)suffixIconColor;
- (void)configureTextViewWithWidth:(double)a0;
- (void)setupTextViewContent;
- (void)layoutSuffixViewWithLeftMargin:(double)a0 verticalPadding:(double)a1 rightMargin:(double)a2;
- (BOOL)isCardStyle;
- (void)updateWithStyleConfig:(id)a0;
- (void)updateSubviewsWithStyleConfig:(id)a0;
- (void)layoutWithStyleConfig:(id)a0;
