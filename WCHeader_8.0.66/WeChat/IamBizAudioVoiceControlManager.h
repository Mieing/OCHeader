@interface IamBizAudioVoiceControlManager : NSObject {
    ...
    struct shared_ptr<biz::IamBizAudioVoiceControlManagerCppCover> { struct IamBizAudioVoiceControlManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<biz::IamBizAudioVoiceControlManagerDispatcher> { struct IamBizAudioVoiceControlManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<biz::IamBizAudioVoiceControlManagerDispatcher> { struct IamBizAudioVoiceControlManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)startVoiceControlAsync:(id /* block */)a0;
- (void)startVoiceControlAsync:(id)a0 completion:(id /* block */)a1;
- (void)cancelVoiceControl;
- (void)subscribeExitPlayerEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeExitPlayerEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeExitPlayerEvent:(id)a0;
- (void)subscribeContinueVoiceControlEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeContinueVoiceControlEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeContinueVoiceControlEvent:(id)a0;
- (void)subscribeVoiceControlFinishEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeVoiceControlFinishEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeVoiceControlFinishEvent:(id)a0;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
