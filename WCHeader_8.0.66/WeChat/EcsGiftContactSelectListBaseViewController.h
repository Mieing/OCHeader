...
@protocol EcsGiftContactSelectListBaseViewControllerDelegate;

@interface EcsGiftContactSelectListBaseViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, WCSearchDelegate, MMTableViewIndexViewDelegate, contactInfoDelegate> {
...
@property (weak, nonatomic) id<EcsGiftContactSelectListBaseViewControllerDelegate> m_delegate;
