@class WCPayOverseaPayFunctionListRespObject, NSString, WCPayOverseaIBGGetWalletCgiCache, WCBizLoadingView, WCPayOverseaReadActivityList, MMWebViewController, WCPayOverseaMainWalletDataSource, WCPayComplianceHalfPage, WCPayOverseaIBGGetWalletCgi, UICollectionView, WCPayOverseaPayFunctionListCgi_v2;
...
@property (retain, nonatomic) WCPayOverseaPayFunctionListCgi_v2 *m_payFunctionCgi;
...
@property (retain, nonatomic) WCPayComplianceHalfPage *m_complianceHalfPage;
