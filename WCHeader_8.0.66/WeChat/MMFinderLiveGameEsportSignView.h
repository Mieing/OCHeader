@class NSString, FinderLiveBadgeInfo, MMWebImageView, MMUILabel;
...
+ (struct CGSize { double x0; double x1; })getGameEsportSizeWithBadgeName:(id)a0 uiStyle:(long long)a1;
