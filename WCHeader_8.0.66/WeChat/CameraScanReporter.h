...
+ (void)reportCameraBlack:(BOOL)a0 firstDataFrameCost:(unsigned int)a1 firstScanCost:(unsigned int)a2 authorizeType:(BOOL)a3 optimizeType:(unsigned int)a4 errorType:(unsigned int)a5 errorCode:(unsigned int)a6;
