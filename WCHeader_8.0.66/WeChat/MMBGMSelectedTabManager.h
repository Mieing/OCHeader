...
- (void)selectMusicAtIndex:(unsigned long long)a0 shouldInvokeSelectedFunc:(BOOL)a1;
...
- (void)reloadTableViewCellAtIndex:(unsigned long long)a0;
...
- (void)setupTabReportInfoWithEventID:(id)a0;
- (void)setupCellRemoveActionReportInfoWithEventID:(id)a0 musicData:(id)a1;
- (id)genReportDict;
- (void).cxx_destruct;
