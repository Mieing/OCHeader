@interface BrandServiceNativeNotifyBridge : NSObject {
    ...
    struct shared_ptr<brand_service::BrandServiceNativeNotifyBridgeCppCover> { struct BrandServiceNativeNotifyBridgeCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<brand_service::BrandServiceNativeNotifyBridgeDispatcher> { struct BrandServiceNativeNotifyBridgeDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<brand_service::BrandServiceNativeNotifyBridgeDispatcher> { struct BrandServiceNativeNotifyBridgeDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
...
- (void)callOnDataChange:(int)a0;
- (void)subscribeInitDoneEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeInitDoneEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeInitDoneEvent:(id)a0;
- (void)callOnInitDone:(BOOL)a0;
- (void)subscribeIDKeyEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeIDKeyEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeIDKeyEvent:(id)a0;
- (void)callOnIDKey:(int)a0 key:(int)a1 value:(int)a2;
- (void)subscribeKVEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeKVEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeKVEvent:(id)a0;
- (void)callOnKV:(int)a0 value:(id)a1;
- (void)subscribeFirstScreenResortStartEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeFirstScreenResortStartEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeFirstScreenResortStartEvent:(id)a0;
- (void)subscribeFirstScreenResortEndEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeFirstScreenResortEndEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeFirstScreenResortEndEvent:(id)a0;
- (void)callOnFirstScreenResortStart:(unsigned long long)a0;
- (void)callOnFirstScreenResortEnd:(unsigned long long)a0;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
