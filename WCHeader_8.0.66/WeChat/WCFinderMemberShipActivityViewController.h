@class UIView, UITableViewDiffableDataSource, WCFinderTabSwitchView, UILabel, WCFinderMemberShipActivityViewModel, NSString, WCFinderReuseQueue, UIViewController, WCFinderRefreshTableFooterView, WCFinderMSPostHeader, WCFinderEventDelegate;
@protocol WCFinderCommentBaseViewProtocol;

@interface WCFinderMemberShipActivityViewController : MMUIViewController <UITableViewDelegate, WCFinderTabSwitchViewDataSource, WCFinderTabSwitchViewDelegate, WCFinderMeberShipActivityEvent, WCFinderMemberShipActivityViewModelDelegate, WCFinderRefreshTableFooterViewDelegate, WCFinderStreamLoadingStateDelegate, WCPlayerConfigViewControllerDelegate, WCFinderMSPostHeaderDelegate, WCFinderCommentDetailViewControllerDelegate>
...
@property (retain, nonatomic) WCFinderMemberShipActivityViewModel *viewModel;
