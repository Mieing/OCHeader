@class NSString, UIImageView, WCProgressMaskView, UILabel, UIView, WCFinderVideoProducerTemplateCellViewModel;

@interface WCFinderVideoProducerTemplateCardView : UICollectionViewCell <WCMVVMViewComponent>
...
@property (retain, nonatomic) WCFinderVideoProducerTemplateCellViewModel *cellVM;
