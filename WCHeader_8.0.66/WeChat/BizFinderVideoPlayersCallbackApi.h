...
- (void)onVideoEndedPlayerId:(long long)a0 mediaId:(id)a1 completion:(id /* block */)a2;
- (void)onGetVideoSizePlayerId:(long long)a0 mediaId:(id)a1 width:(long long)a2 height:(long long)a3 completion:(id /* block */)a4;
- (void)onVideoPausePlayerId:(long long)a0 mediaId:(id)a1 completion:(id /* block */)a2;
- (void)onVideoPlayPlayerId:(long long)a0 mediaId:(id)a1 completion:(id /* block */)a2;
- (void)onVideoWaitingPlayerId:(long long)a0 mediaId:(id)a1 isSeeking:(BOOL)a2 completion:(id /* block */)a3;
- (void)onVideoWaitingEndPlayerId:(long long)a0 mediaId:(id)a1 completion:(id /* block */)a2;
