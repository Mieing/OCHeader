@class MMWebImageView, UIImageView, WCPayWebImageView, NSDictionary, UIButton, UIView, HongbaoReceiveHomeViewAbtestObject, NSString, WCRedEnvelopesControlData, WCRedEnvelopesReceiveHomePromotionView, MMEmoticonView, ContactUpdateHelper, WCPayWebPagView;
...
@property (retain, nonatomic) WCPayWebPagView *fullScreenAtmospherePagView;
...
- (BOOL)shouldShowFullScreentAtmospherePagView;
- (id)getFullScreenAtmospherePagUrl;
- (void)updateFullScreenAtmospherePagView;
- (void)setFullScreenAtmospherePagView:(id)a0;
- (id)fullScreenAtmospherePagView;
- (void)layoutSubviews;
