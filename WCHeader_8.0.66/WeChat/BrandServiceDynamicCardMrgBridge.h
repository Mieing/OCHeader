@interface BrandServiceDynamicCardMrgBridge : NSObject {
    ...
    struct shared_ptr<brand_service::BrandServiceDynamicCardMrgBridgeCppCover> { struct BrandServiceDynamicCardMrgBridgeCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<brand_service::BrandServiceDynamicCardMrgBridgeDispatcher> { struct BrandServiceDynamicCardMrgBridgeDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<brand_service::BrandServiceDynamicCardMrgBridgeDispatcher> { struct BrandServiceDynamicCardMrgBridgeDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)subscribeAdServerInfoEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeAdServerInfoEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeAdServerInfoEvent:(id)a0;
- (void)mockInsertCanvas:(int)a0 frameSetName:(id)a1 frameSetData:(id)a2;
- (void)callOnAdServerInfo:(id)a0;
- (void)subscribeRecFeedsAdServerInfoEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeRecFeedsAdServerInfoEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeRecFeedsAdServerInfoEvent:(id)a0;
- (void)callOnRecFeedsAdServerInfo:(id)a0;
- (void)subscribeDynamicCardInfoEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeDynamicCardInfoEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeDynamicCardInfoEvent:(id)a0;
- (void)callOnDynamicCardInfo:(int)a0 msgId:(unsigned long long)a1 frameSetName:(id)a2 frameSetData:(id)a3;
- (id)getAllDynamicCardInfo:(int)a0;
- (BOOL)setAdRequestInfo:(id)a0 adFetchInfo:(id)a1;
- (BOOL)setFeedsAdRequestInfo:(id)a0 adFetchInfo:(id)a1;
- (BOOL)setAdCardRequestInfo:(unsigned long long)a0 adInfo:(id)a1;
- (BOOL)deleteDynamicCard:(unsigned long long)a0 dynamicCardType:(int)a1;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
