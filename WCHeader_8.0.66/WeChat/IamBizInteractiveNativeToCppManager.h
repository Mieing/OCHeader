...
- (void)fetchMeTabRedPointAsync:(const void *)a0 regNoticeInfo:(const void *)a1 completion:(id /* block */)a2;
- (void)fetchMeTabRedPointAsync:(const void *)a0 regNoticeInfo:(const void *)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)disposeMeTabRedPointAsync:(const void *)a0 scene:(int)a1 regNoticeInfo:(const void *)a2 completion:(id /* block */)a3;
- (void)disposeMeTabRedPointAsync:(const void *)a0 scene:(int)a1 regNoticeInfo:(const void *)a2 on:(id)a3 completion:(id /* block */)a4;
- (void)getMeTabStrategyCacheAsync:(id /* block */)a0;
- (void)getMeTabStrategyCacheAsync:(id)a0 completion:(id /* block */)a1;
- (void)fetchMeTabStrategyWithCacheCheckAsync:(BOOL)a0 finderOpen:(BOOL)a1 completion:(id /* block */)a2;
- (void)fetchMeTabStrategyWithCacheCheckAsync:(BOOL)a0 finderOpen:(BOOL)a1 on:(id)a2 completion:(id /* block */)a3;
...
- (void)getInteractiveStrategyShowWordPosterAsync:(id /* block */)a0;
- (void)getInteractiveStrategyShowWordPosterAsync:(id)a0 completion:(id /* block */)a1;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
