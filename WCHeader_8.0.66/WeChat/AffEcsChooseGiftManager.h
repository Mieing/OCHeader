@interface AffEcsChooseGiftManager : NSObject {
    ...
    struct shared_ptr<ecs::AffEcsChooseGiftManagerCppCover> { struct AffEcsChooseGiftManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<ecs::AffEcsChooseGiftManagerDispatcher> { struct AffEcsChooseGiftManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<ecs::AffEcsChooseGiftManagerDispatcher> { struct AffEcsChooseGiftManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)requestTagAsync:(id)a0 scene:(int)a1 completion:(id /* block */)a2;
- (void)requestTagAsync:(id)a0 scene:(int)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)getTagPbStrAsync:(id)a0 scene:(int)a1 completion:(id /* block */)a2;
- (void)getTagPbStrAsync:(id)a0 scene:(int)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)preloadGiftProductAsync:(id)a0 scene:(int)a1 tagId:(int)a2 count:(int)a3 completion:(id /* block */)a4;
- (void)preloadGiftProductAsync:(id)a0 scene:(int)a1 tagId:(int)a2 count:(int)a3 on:(id)a4 completion:(id /* block */)a5;
- (void)requestGiftProductAsync:(id)a0 scene:(int)a1 tagId:(int)a2 count:(int)a3 completion:(id /* block */)a4;
- (void)requestGiftProductAsync:(id)a0 scene:(int)a1 tagId:(int)a2 count:(int)a3 on:(id)a4 completion:(id /* block */)a5;
- (id)getPreloadProductInfo:(id)a0;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
