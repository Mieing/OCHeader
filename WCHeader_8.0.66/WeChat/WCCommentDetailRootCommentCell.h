@class UIView, WCFinderComment, UITapGestureRecognizer, WCCommentLikeView, FinderUniCommentMediaView, UIImageView, UIButton, WCFinderFeedContentTextView, NSString, MMUIButton, UIColor;
...
@property (weak, nonatomic) id<WCCommentDetailRootCommentCellDelegate> delegate;
