@class NSString, EcsJumpInfo_EcsCgiPreloadInfo, EcsJumpInfo_EcsLiteAppInfo, EcsJumpInfo_EcsHtml5Info, EcsJumpInfo_EcsNativeInfo, EcsJumpInfo_EcsMiniAppInfo, NSMutableArray, mbAppInfo;

@interface EcsJumpInfo : WXPBGeneratedMessage

@property (retain, nonatomic) mbAppInfo *mbAppInfo;
