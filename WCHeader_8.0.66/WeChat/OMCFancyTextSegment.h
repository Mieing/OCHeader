...
@interface OMCFancyTextSegment : OMCElementSegment <OMCEditingStateAdjustable, OMCTextToSpeechAdjustable>

@property (readonly, nonatomic) struct SharedPtr<XMSFancyTextSegment> { struct XMSFancyTextSegment *x0; } backingFancyTextSegment;
...
- (BOOL)updateSubtitleFontName:(id)a0;
