...
@property (weak, nonatomic) id<WCHomePageDataProviderDelegate> delegate;
@property (weak, nonatomic) id<WCHomePageDataProviderStarDelegate> starDelegate;
...
- (void)updateStarListFromResponse:(id)a0 byRequest:(id)a1;
- (void)updateDragon2024InfoFromResponse:(id)a0 byRequest:(id)a1;
- (void).cxx_destruct;
