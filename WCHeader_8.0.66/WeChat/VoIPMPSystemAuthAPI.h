@interface VoIPMPSystemAuthAPI : NSObject {
    ...
    struct shared_ptr<voipmp::VoIPMPSystemAuthAPICppCover> { struct VoIPMPSystemAuthAPICppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<voipmp::VoIPMPSystemAuthAPIDispatcher> { struct VoIPMPSystemAuthAPIDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<voipmp::VoIPMPSystemAuthAPIDispatcher> { struct VoIPMPSystemAuthAPIDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
