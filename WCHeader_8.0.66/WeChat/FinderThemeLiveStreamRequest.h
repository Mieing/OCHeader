@class FinderPressureCtrl, FinderLiveTabInfo, FinderLiveReportBaseInfo, FinderLbsTabTipsInfo, FinderBaseRequest, NSMutableArray, NSString, FinderLiveBeforeJoinLiveRoomStatus, FinderSwitch, BaseRequest, FinderClientStatus, NSData, FinderLiveClientStatus;
...
@property (nonatomic) unsigned int aggregationCardType;
