@interface BrandEcsUtil : NSObject {
    ...
    struct shared_ptr<brand_service::BrandEcsUtilCppCover> { struct BrandEcsUtilCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<brand_service::BrandEcsUtilDispatcher> { struct BrandEcsUtilDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<brand_service::BrandEcsUtilDispatcher> { struct BrandEcsUtilDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (id)getImageView2Url:(id)a0;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
