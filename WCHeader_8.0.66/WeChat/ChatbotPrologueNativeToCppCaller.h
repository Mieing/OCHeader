@interface ChatbotPrologueNativeToCppCaller : NSObject {
    ...
    struct shared_ptr<chatbot::ChatbotPrologueNativeToCppCallerCppCover> { struct ChatbotPrologueNativeToCppCallerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<chatbot::ChatbotPrologueNativeToCppCallerDispatcher> { struct ChatbotPrologueNativeToCppCallerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<chatbot::ChatbotPrologueNativeToCppCallerDispatcher> { struct ChatbotPrologueNativeToCppCallerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)serviceInit;
- (void)serviceClearData;
- (void)markMsgAsExposedAsync:(id)a0 completion:(id /* block */)a1;
- (void)markMsgAsExposedAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
