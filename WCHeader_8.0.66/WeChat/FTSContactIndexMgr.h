@class NSMutableSet, FTSContactIndexLogic, FTSContactIndexInfo, FTSContactDB;
...
@property (retain, nonatomic) FTSContactIndexLogic *m_contactIndexLogic;
@property (nonatomic) BOOL hasCheckIndexCount;
@property (retain, nonatomic) FTSContactDB *ftsContactDB;

- (void)setM_contactIndexLogic:(id)a0;
- (id)m_contactIndexLogic;
