@interface IamBizAudioReportService : NSObject {
    ...
    struct shared_ptr<biz::IamBizAudioReportServiceCppCover> { struct IamBizAudioReportServiceCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<biz::IamBizAudioReportServiceDispatcher> { struct IamBizAudioReportServiceDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<biz::IamBizAudioReportServiceDispatcher> { struct IamBizAudioReportServiceDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)onActionWithContext:(id)a0;
- (void)onActionWithActionAndContext:(int)a0 bizReportContext:(id)a1;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
