...
@property (nonatomic, readonly) void /* unknown type, empty encoding */ originalUserInfo;
@property (nonatomic, readonly) NSString *description;

- (BOOL)validate;
- (id)initWithOfferID:(id)a0 openID:(id)a1 openKey:(id)a2 sessionID:(id)a3 sessionType:(id)a4 platform:(id)a5 platformKey:(id)a6 originalUserInfo:(id)a7;
- (id)init;
- (void).cxx_destruct;
