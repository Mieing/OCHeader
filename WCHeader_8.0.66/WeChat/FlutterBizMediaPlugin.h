...
- (void)selectPhotoLimit:(long long)a0 canSendOriginalImage:(BOOL)a1 supportLivePhoto:(BOOL)a2 supportTextCover:(BOOL)a3 scene:(long long)a4 completion:(id /* block */)a5;
