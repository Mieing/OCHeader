@class EcsPresentPicInfo, EcsCombineCouponInfo, EcsMerchantEvaluationLotteryPresentInfo, EcsMsgEncryInfo, EcsPresentOrderExpressFeeInfo, NSMutableArray, EcsOrderFinderSecInfo, EcsPriceInfo, EcsPresentPayInfo, NSString, EcsCorpPresentInfo, EcsProductSetInfo, EcsActionClientInfo;
