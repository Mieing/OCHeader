@class NSString, MMTagTextField, WCFinderAnimationLoadingView, MMTitleView, UITapGestureRecognizer, UIImageView, UITableView, WCFinderSearchContactViewModel, WCFinderRefreshTableFooterView, UILabel, WCFinderMoreLiveSearchHistoryView;

@interface WCFinderMoreLiveSearchContactViewController : MMCPUIViewController <UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, WCFinderSearchContactViewModelDelegate, WCFinderRefreshTableFooterViewDelegate, WCFinderMoreLiveSearchHistoryViewDelegate, WCFinderFeedBaseViewControllerProtocol, WCGeneralMonitorDelegate, WCFinderMoreLiveSearchContactCellDelegate>
