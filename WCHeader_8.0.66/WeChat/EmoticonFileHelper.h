@interface EmoticonFileHelper : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonFileHelperCppCover> { struct EmoticonFileHelperCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonFileHelperDispatcher> { struct EmoticonFileHelperDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonFileHelperDispatcher> { struct EmoticonFileHelperDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)getLocalEmoticonFileDataAsync:(id)a0 firstFrameOnly:(const void *)a1 shouldCheckWxamValid:(const void *)a2 completion:(id /* block */)a3;
- (void)getLocalEmoticonFileDataAsync:(id)a0 firstFrameOnly:(const void *)a1 shouldCheckWxamValid:(const void *)a2 on:(id)a3 completion:(id /* block */)a4;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
