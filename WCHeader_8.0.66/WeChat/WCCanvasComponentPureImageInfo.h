...
@property (retain, nonatomic) NSString *pureImageUrl;
@property (nonatomic) double pureImageWidth;
@property (nonatomic) double pureImageHeight;
@property (retain, nonatomic) NSString *bgColor;
@property (nonatomic) double bgColorAlpha;
@property (nonatomic) double cornerRadius;
@property (nonatomic) BOOL enableQRScan;
