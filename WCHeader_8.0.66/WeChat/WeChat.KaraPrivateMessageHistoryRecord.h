...
@interface WeChat.KaraPrivateMessageHistoryRecord : WeChat.KaraHistoryRecord <WCTTableCoding, KaraHistoryRecordIdentifiable> {
...
@property (nonatomic) void /* unknown type, empty encoding */ isWeComContact;
