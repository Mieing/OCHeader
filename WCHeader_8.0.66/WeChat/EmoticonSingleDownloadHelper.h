@interface EmoticonSingleDownloadHelper : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonSingleDownloadHelperCppCover> { struct EmoticonSingleDownloadHelperCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonSingleDownloadHelperDispatcher> { struct EmoticonSingleDownloadHelperDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonSingleDownloadHelperDispatcher> { struct EmoticonSingleDownloadHelperDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)downloadSingleEmoticonAsync:(id)a0 completion:(id /* block */)a1;
- (void)downloadSingleEmoticonAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
