@interface IamBizAudioRecommendManager : NSObject {
    ...
    struct shared_ptr<biz::IamBizAudioRecommendManagerCppCover> { struct IamBizAudioRecommendManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<biz::IamBizAudioRecommendManagerDispatcher> { struct IamBizAudioRecommendManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<biz::IamBizAudioRecommendManagerDispatcher> { struct IamBizAudioRecommendManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)setupListener;
- (void)playBizAudioNextAsync:(id /* block */)a0;
- (void)playBizAudioNextAsync:(id)a0 completion:(id /* block */)a1;
- (BOOL)enablePlayBizAudioNext;
- (void)playBizAudioPrevAsync:(id /* block */)a0;
- (void)playBizAudioPrevAsync:(id)a0 completion:(id /* block */)a1;
- (BOOL)enablePlayBizAudioPrev;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
