@interface RoamBackupPackageManager : NSObject {
    ...
    struct shared_ptr<affroam::RoamBackupPackageManagerCppCover> { struct RoamBackupPackageManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<affroam::RoamBackupPackageManagerDispatcher> { struct RoamBackupPackageManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<affroam::RoamBackupPackageManagerDispatcher> { struct RoamBackupPackageManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)createPackagesAsync:(id)a0 completion:(id /* block */)a1;
- (void)createPackagesAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)createPackagesCrossPlatformAsync:(id)a0 completion:(id /* block */)a1;
- (void)createPackagesCrossPlatformAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)getAllPackagesAsync:(BOOL)a0 completion:(id /* block */)a1;
- (void)getAllPackagesAsync:(BOOL)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)getAllPackagesCrossPlatformAsync:(BOOL)a0 completion:(id /* block */)a1;
- (void)getAllPackagesCrossPlatformAsync:(BOOL)a0 on:(id)a1 completion:(id /* block */)a2;
- (id)getPackageById:(unsigned long long)a0;
- (void)updatePackagesAsync:(id)a0 completion:(id /* block */)a1;
- (void)updatePackagesAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)updatePackagesCrossPlatformAsync:(id)a0 completion:(id /* block */)a1;
- (void)updatePackagesCrossPlatformAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)deletePackagesAsync:(id)a0 completion:(id /* block */)a1;
- (void)deletePackagesAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)deletePackagesCrossPlatformAsync:(id)a0 completion:(id /* block */)a1;
- (void)deletePackagesCrossPlatformAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (int)resetManager;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
