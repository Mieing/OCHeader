...
+ (BOOL)unzipFileAtPath:(id)a0 toDestination:(id)a1 preserveAttributes:(BOOL)a2 overwrite:(BOOL)a3 security:(BOOL)a4 password:(id)a5 error:(id *)a6 delegate:(id)a7;
+ (BOOL)unzipFileAtPath:(id)a0 toDestination:(id)a1 preserveAttributes:(BOOL)a2 overwrite:(BOOL)a3 security:(BOOL)a4 password:(id)a5 error:(id *)a6 delegate:(id)a7 progressHandler:(id /* block */)a8 completionHandler:(id /* block */)a9;
+ (BOOL)unzipFileAtPath:(id)a0 toDestination:(id)a1 preserveAttributes:(BOOL)a2 overwrite:(BOOL)a3 security:(BOOL)a4 nestedZipLevel:(long long)a5 password:(id)a6 error:(id *)a7 delegate:(id)a8 progressHandler:(id /* block */)a9 completionHandler:(id /* block */)a10;
