@class UIView, UILabel, UITapGestureRecognizer, WCC2CPlayerProgressBar, WCPlayerConfig, NSString, UIButton, CAGradientLayer, NSObject, MMUILabel, MMUIButton, SightIconView;
@protocol WCPlayerConfigDelegate;

@interface WCPlayerConfigControlView : WCPlayerControlView <SightIconViewDelegate, WCC2CPlayerProgressBarDelegate, UIGestureRecognizerDelegate>
...
@property (retain, nonatomic) WCPlayerConfig *playerConfig;
