@class OrderedDictionary, NSMutableArray, WCVideoProducerTemplatePlayingOperation;

@interface WCVideoProducerTemplateOperationContext : NSObject

@property (nonatomic) long long belonger;
@property (retain, nonatomic) WCVideoProducerTemplatePlayingOperation *currentTemplateOperation;
