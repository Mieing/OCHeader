@class FixTitleColorButton, NSString, MMFinderLiveVoteDurationPickerViewConfig, UILabel, UIView, UIPickerView;
...
@property (retain, nonatomic) MMFinderLiveVoteDurationPickerViewConfig *config;
@property (nonatomic) long long selectedRow;
@property (weak, nonatomic) id<MMFinderLiveVoteDurationPickerViewDelegate> delegate;
