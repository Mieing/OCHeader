@interface BrandEcsReportMgr : NSObject {
    ...
    struct shared_ptr<brand_service::BrandEcsReportMgrCppCover> { struct BrandEcsReportMgrCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<brand_service::BrandEcsReportMgrDispatcher> { struct BrandEcsReportMgrDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<brand_service::BrandEcsReportMgrDispatcher> { struct BrandEcsReportMgrDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)reportItem:(id)a0;
