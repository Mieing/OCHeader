@class WCFinderVideoProducerMusicSearchingOperation, OrderedDictionary, WCFinderVideoProducerEditSegmentOperation, MJVideoTemplate, NSMutableArray, WCFinderVideoProducerMusicPlayingOperation;

@interface WCFinderVideoProducerTemplatePlayingOperation : WCFinderVideoProducerBaseOperation
...
@property (retain, nonatomic) WCFinderVideoProducerMusicPlayingOperation *currentMusicPlayingOperation;
@property (retain, nonatomic) WCFinderVideoProducerMusicSearchingOperation *currentMusicSearchingOperation;
@property (retain, nonatomic) WCFinderVideoProducerEditSegmentOperation *currentEditSegmentOperation;
