@interface EmoticonRecoverEventCenter : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonRecoverEventCenterCppCover> { struct EmoticonRecoverEventCenterCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonRecoverEventCenterDispatcher> { struct EmoticonRecoverEventCenterDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonRecoverEventCenterDispatcher> { struct EmoticonRecoverEventCenterDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)onEmoticonRecoverLogicFinishedAsync:(int)a0 completion:(id /* block */)a1;
- (void)onEmoticonRecoverLogicFinishedAsync:(int)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)onEmoticonRecoverLogicFailedAsync:(int)a0 completion:(id /* block */)a1;
- (void)onEmoticonRecoverLogicFailedAsync:(int)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)onEmoticonRecoverLogicDownloadedSingleEmoticonAsync:(int)a0 completion:(id /* block */)a1;
- (void)onEmoticonRecoverLogicDownloadedSingleEmoticonAsync:(int)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)onEmoticonRecoverLogicFinishedPartSyncAsync:(int)a0 completion:(id /* block */)a1;
- (void)onEmoticonRecoverLogicFinishedPartSyncAsync:(int)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)onEmoticonRecoverLogicNotifyDownloadProgressAsync:(int)a0 completion:(id /* block */)a1;
- (void)onEmoticonRecoverLogicNotifyDownloadProgressAsync:(int)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
