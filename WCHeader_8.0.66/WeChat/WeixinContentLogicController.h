@class WCScheduleLogicController, NSString, MMBottomToolView, OpenIMSucceedContactLogic, WCTopicSearchViewController, MMInputToolView, ChatUnavailableTipsView, C2CReportController, XMailBindMailControlLogic;

@interface WeixinContentLogicController : BaseMsgContentLogicController <MMBottomToolViewDelegate, IQQMailExt, XMailBindMailControlLogicDelegate, OpenIMSucceedContactLogicLogicDelegate, WCTopicSearchViewControllerDelegate, ContactInfoViewControllerDelegate, IWCPayPluginTopMsgMgrExt, WCScheduleLogicControllerDelegate, addContactToChatRoomDelegate, TipsViewDelegate, ITranslateMsgMgrExt> {
    BOOL m_bTipsShow;
    BOOL m_isInMenuMode;
...
- (void)jumpFeatureScheduleMessage:(long long)a0;
- (void).cxx_destruct;
