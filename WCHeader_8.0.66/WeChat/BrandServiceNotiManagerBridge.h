@interface BrandServiceNotiManagerBridge : NSObject {
    ...
    struct shared_ptr<brand_service::BrandServiceNotiManagerBridgeCppCover> { struct BrandServiceNotiManagerBridgeCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<brand_service::BrandServiceNotiManagerBridgeDispatcher> { struct BrandServiceNotiManagerBridgeDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<brand_service::BrandServiceNotiManagerBridgeDispatcher> { struct BrandServiceNotiManagerBridgeDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
...
- (id)getData:(unsigned long long)a0 limit:(int)a1;
- (unsigned long long)getUnExpiredCountFromDb;
- (id)getLaterData:(unsigned long long)a0 limit:(int)a1;
- (id)getByLocalId:(unsigned long long)a0;
- (unsigned long long)getTotalCount;
- (unsigned long long)getTotalUnreadCount;
- (id)getFirstUnreadData;
- (void)onBatchReadAsync:(unsigned long long)a0 completion:(id /* block */)a1;
- (void)onBatchReadAsync:(unsigned long long)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)subscribeNotiListReadEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeNotiListReadEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeNotiListReadEvent:(id)a0;
- (void)callOnNotiListRead;
- (void)onBatchExposeAsync:(id)a0 completion:(id /* block */)a1;
- (void)onBatchExposeAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (BOOL)deleteByLocalId:(unsigned long long)a0;
- (BOOL)deleteByUserName:(id)a0;
- (void)subscribeInsertNotiEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeInsertNotiEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeInsertNotiEvent:(id)a0;
- (void)callOnInsertNoti:(id)a0;
- (void)subscribeEditNotiEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeEditNotiEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeEditNotiEvent:(id)a0;
- (void)callOnEditNoti:(id)a0;
- (void)subscribeDeleteNotiEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeDeleteNotiEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeDeleteNotiEvent:(id)a0;
- (void)callOnDeleteNoti:(unsigned long long)a0 username:(id)a1 svrId:(unsigned long long)a2;
- (void)subscribeUpdateNotiExpireTimeEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeUpdateNotiExpireTimeEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeUpdateNotiExpireTimeEvent:(id)a0;
- (void)callOnUpdateNotiExpireTime:(unsigned long long)a0;
- (BOOL)hasInit;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
