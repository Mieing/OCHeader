...
- (void)writeImageToSavedPhotosAlbum:(id)a0 exifExtraInfo:(id)a1 completionBlock:(id /* block */)a2;
- (void)writeImageToSavedPhotosAlbum:(id)a0 exifExtraInfo:(id)a1 exifUserComment:(id)a2 completionBlock:(id /* block */)a3;
...
- (void)internalSaveImages:(id)a0 toAlbumNamed:(id)a1 exifExtraInfo:(id)a2 exifUserComment:(id)a3 completionBlock:(id /* block */)a4;
