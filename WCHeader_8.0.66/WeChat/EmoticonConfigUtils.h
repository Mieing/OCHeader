@interface EmoticonConfigUtils : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonConfigUtilsCppCover> { struct EmoticonConfigUtilsCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonConfigUtilsDispatcher> { struct EmoticonConfigUtilsDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonConfigUtilsDispatcher> { struct EmoticonConfigUtilsDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
