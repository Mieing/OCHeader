@class NSString, EcsExtraData, NSArray;

@interface WCFinderLiveProductShareItem : NSObject <YYModel, NSCoding, NSCopying, PBCoding>

@property (retain, nonatomic) EcsExtraData *ecsExtraData;
...
- (id)ecsExtraDataString;
- (void)setEcsExtraDataString:(id)a0;
- (id)titleTags;
- (void)setEcsExtraData:(id)a0;
- (id)ecsExtraData;
