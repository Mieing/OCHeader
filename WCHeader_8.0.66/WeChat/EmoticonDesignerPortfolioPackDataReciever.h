@interface EmoticonDesignerPortfolioPackDataReciever : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonDesignerPortfolioPackDataRecieverCppCover> { struct EmoticonDesignerPortfolioPackDataRecieverCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonDesignerPortfolioPackDataRecieverDispatcher> { struct EmoticonDesignerPortfolioPackDataRecieverDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonDesignerPortfolioPackDataRecieverDispatcher> { struct EmoticonDesignerPortfolioPackDataRecieverDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
