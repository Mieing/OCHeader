@class UIView, WAMainFrameTaskBarSectionWeAppViewModel, NSString, WAMainFrameTaskBarDeleteActionWindow, UIImageView, WAStarCollectionViewLayout, UIButton, NSMutableSet, UICollectionView, UILabel, NSIndexPath;
...
@property (retain, nonatomic) NSMutableSet *reportedCommonUsedAppIds;
...
- (void)setReportedCommonUsedAppIds:(id)a0;
- (id)reportedCommonUsedAppIds;
- (id)title;
- (void)initView;
- (void)initEmptyView;
