@interface EmoticonMsgHelper : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonMsgHelperCppCover> { struct EmoticonMsgHelperCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonMsgHelperDispatcher> { struct EmoticonMsgHelperDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonMsgHelperDispatcher> { struct EmoticonMsgHelperDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)parseEmoticonXMLAsync:(id)a0 completion:(id /* block */)a1;
- (void)parseEmoticonXMLAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)parseEmoticonAppMsgXMLAsync:(id)a0 completion:(id /* block */)a1;
- (void)parseEmoticonAppMsgXMLAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)downloadEmoticonAsync:(id)a0 completion:(id /* block */)a1;
- (void)downloadEmoticonAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)isEmoticonCanAddAsync:(id)a0 completion:(id /* block */)a1;
- (void)isEmoticonCanAddAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)isEmoticonGameAsync:(id)a0 completion:(id /* block */)a1;
- (void)isEmoticonGameAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)getEmoticonDescAsync:(id)a0 completion:(id /* block */)a1;
- (void)getEmoticonDescAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
