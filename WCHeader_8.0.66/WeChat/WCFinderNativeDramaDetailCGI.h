@class WCFinderNativeDramaDetailCGIParams;

@interface WCFinderNativeDramaDetailCGI : WCFinderBaseCgi

@property (retain, nonatomic) WCFinderNativeDramaDetailCGIParams *params;
