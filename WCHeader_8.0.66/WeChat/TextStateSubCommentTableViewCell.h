@class UIView, WCFinderComment, UIColor, FinderUniCommentMediaView, NSString, UIImageView, UIButton, WCFinderFeedContentTextView, NSIndexPath;
...
@property (weak, nonatomic) id<TextStateSubCommentTableViewCellActionDelegate> delegate;
@property (retain, nonatomic) NSIndexPath *currentIndexPath;
@property (retain, nonatomic) UIColor *themeColor;
@property (nonatomic) BOOL isLastSectionCell;
