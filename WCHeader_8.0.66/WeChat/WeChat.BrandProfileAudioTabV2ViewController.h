@interface WeChat.BrandProfileAudioTabV2ViewController : UIViewController <UICollectionViewDelegate, BrandProfileTopicViewDelegate, BrandProfileTabVCProtocol, MMRefreshTableFooterDelegate> {
