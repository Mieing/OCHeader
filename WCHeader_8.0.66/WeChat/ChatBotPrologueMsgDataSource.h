@class NSString, NSArray, NSMutableDictionary, NSMutableSet, NSMutableArray, UITableView;
...
@property (retain, nonatomic) NSArray *allMsgList;
@property (retain, nonatomic) NSMutableDictionary *groupedSectionInfoDict;
...
- (void)reloadAllData;
- (unsigned long long)getDefaultUnfoldCountForSection:(unsigned long long)a0;
- (unsigned long long)getExpandCountForSection:(unsigned long long)a0;
