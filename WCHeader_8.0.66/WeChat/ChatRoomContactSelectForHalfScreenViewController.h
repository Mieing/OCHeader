@class NSMutableDictionary, ContactsItemView, MultiSelectContactsInChatRoomReport, MMUISearchBar, NewContactsSearchPanelView, _TtC6WeChat13DNDReportItem, NSMutableArray, UIView, NSString, OrderedDictionary, SearchHelpDataItem, MMTableView, WCSearchBar, CContact, ChatRoomContactSelectModel, MMUIButton;
@protocol RoomContactSelectDelegate;

@interface ChatRoomContactSelectForHalfScreenViewController : MMPageSheetBaseViewController <UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, MMTableViewIndexViewDelegate, MMPageSheetGestureRecognizerDelegate, NewContactsSearchPanelViewDelegate, ChatRoomContactSelectModelDelegate> {
...
@property (retain, nonatomic) ChatRoomContactSelectModel *viewModel;
@property (retain, nonatomic) NSMutableArray *arrRoomMembers;
@property (retain, nonatomic) UIView *chatRoomAllMemberViewFooter;
...
@property (nonatomic) BOOL supportAtRecord;
...
- (id)createSectionSeperateFooter;
- (void)initSearchBar;
- (void)initTableView;
- (void)initPageSheet;
