@interface DataReportCgiManager : NSObject {
    ...
    struct shared_ptr<data_report::DataReportCgiManagerCppCover> { struct DataReportCgiManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<data_report::DataReportCgiManagerDispatcher> { struct DataReportCgiManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<data_report::DataReportCgiManagerDispatcher> { struct DataReportCgiManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)onDataReportAsync:(id)a0 completion:(id /* block */)a1;
- (void)onDataReportAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)onBatchDataReportAsync:(id)a0 completion:(id /* block */)a1;
- (void)onBatchDataReportAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)refreshReportConfigAsync:(int)a0 configId:(int)a1 completion:(id /* block */)a2;
- (void)refreshReportConfigAsync:(int)a0 configId:(int)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)setNetworkStatusAsync:(BOOL)a0 completion:(id /* block */)a1;
- (void)setNetworkStatusAsync:(BOOL)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)updateServerTimeAsync:(unsigned long long)a0 completion:(id /* block */)a1;
- (void)updateServerTimeAsync:(unsigned long long)a0 on:(id)a1 completion:(id /* block */)a2;
- (BOOL)initWithConfigDir:(id)a0;
- (id)getAllReportItemJsonInfo:(int)a0 itemId:(id)a1 eventId:(id)a2;
- (id)getCgiConfig:(int)a0;
- (void)subscribeDataReportIdKeyEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeDataReportIdKeyEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeDataReportIdKeyEvent:(id)a0;
- (void)callReportIdKey:(int)a0 key:(int)a1 value:(int)a2;
- (void)subscribeDataReportKVEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeDataReportKVEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeDataReportKVEvent:(id)a0;
- (void)callDataReportKV:(int)a0 value:(id)a1;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
