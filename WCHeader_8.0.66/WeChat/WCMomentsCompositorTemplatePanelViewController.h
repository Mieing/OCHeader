@class UIView, NSString, WCMomentsCompositorTemplateTableViewController, NSMutableDictionary, WCVideoProducerDataSource, UICollectionView, MJVideoTemplate, MMUIButton, NSIndexPath;
@protocol WCMomentsCompositorTemplatePanelDelegate;

@interface WCMomentsCompositorTemplatePanelViewController : WCVideoProducerBaseViewControllerFragment <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, WCMomentsCompositorTemplateTableDelegate> {
...
@property (retain, nonatomic) WCVideoProducerDataSource *templateData;
@property (retain, nonatomic) WCVideoProducerDataSource *tabCellVMData;
...
@property (weak, nonatomic) id<WCMomentsCompositorTemplatePanelDelegate> delegate;
