@interface EmoticonBoardDataSourceAff : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonBoardDataSourceAffCppCover> { struct EmoticonBoardDataSourceAffCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonBoardDataSourceAffDispatcher> { struct EmoticonBoardDataSourceAffDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonBoardDataSourceAffDispatcher> { struct EmoticonBoardDataSourceAffDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)getEmoticonBoardDataAsync:(id)a0 completion:(id /* block */)a1;
- (void)getEmoticonBoardDataAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)isStorePackageDownloadedAsync:(id)a0 completion:(id /* block */)a1;
- (void)isStorePackageDownloadedAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)getEmoticonListWithPageWrapAsync:(id)a0 completion:(id /* block */)a1;
- (void)getEmoticonListWithPageWrapAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)isCustomEmoticonRecoverCompletedAsync:(id /* block */)a0;
- (void)isCustomEmoticonRecoverCompletedAsync:(id)a0 completion:(id /* block */)a1;
- (void)isCameraEmoticonRecoverCompletedAsync:(id /* block */)a0;
- (void)isCameraEmoticonRecoverCompletedAsync:(id)a0 completion:(id /* block */)a1;
- (BOOL)isCustomEmoticonRecoverActive;
- (BOOL)isCameraEmoticonRecoverActive;
- (void)trySyncCustomEmoticonAnotherPart;
- (void)trySyncCameraEmoticonAnotherPart;
- (void)downloadPackageHighPrivilege:(id)a0;
- (void)getEmoticonPackCoverLocalImgAsync:(id)a0 completion:(id /* block */)a1;
- (void)getEmoticonPackCoverLocalImgAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)getEmoticonThumbImgAsync:(id)a0 completion:(id /* block */)a1;
- (void)getEmoticonThumbImgAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)getEmoticonFilePathAsync:(id)a0 completion:(id /* block */)a1;
- (void)getEmoticonFilePathAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)getEmoticonDescAsync:(id)a0 md5:(id)a1 completion:(id /* block */)a2;
- (void)getEmoticonDescAsync:(id)a0 md5:(id)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
