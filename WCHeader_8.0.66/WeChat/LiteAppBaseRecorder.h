@class NSArray, NSString, NSURL, NSMutableData, NSObject, NSDictionary;
@protocol OS_dispatch_source, OS_dispatch_queue, LiteAppRecorderDelegate;

@interface LiteAppBaseRecorder : NSObject <LiteAppRecordEncodeDelegate>
...
@property (nonatomic) struct LiteAppRecorderData { id x0; id x1; struct AudioStreamBasicDescription { double x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; } x2; struct OpaqueAudioQueue *x3; struct AudioQueueBuffer *x4[3]; id x5; } *aqData;
...
@property (nonatomic) BOOL isCheckEnvironment;
...
@property (weak, nonatomic) id<LiteAppRecorderDelegate> delegate;
