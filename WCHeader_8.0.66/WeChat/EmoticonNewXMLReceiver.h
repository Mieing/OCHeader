@interface EmoticonNewXMLReceiver : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonNewXMLReceiverCppCover> { struct EmoticonNewXMLReceiverCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonNewXMLReceiverDispatcher> { struct EmoticonNewXMLReceiverDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonNewXMLReceiverDispatcher> { struct EmoticonNewXMLReceiverDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)onGotNewXML:(id)a0 content:(id)a1;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
