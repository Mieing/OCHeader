@interface WeChat.BrandProfileArticleTabViewController : UIViewController <UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, BrandProfileTopicViewDelegate, BrandProfileTabVCProtocol, MMRefreshTableFooterDelegate> {
