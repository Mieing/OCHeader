...
- (void)updateMicStatusAsync:(id)a0 isOpen:(BOOL)a1 roomScene:(int)a2 uiState:(int)a3 isFullDuplex:(BOOL)a4 switchToFullDuplex:(BOOL)a5 transferCtx:(id)a6 forbidSendMicStatus:(BOOL)a7 completion:(id /* block */)a8;
- (void)updateMicStatusAsync:(id)a0 isOpen:(BOOL)a1 roomScene:(int)a2 uiState:(int)a3 isFullDuplex:(BOOL)a4 switchToFullDuplex:(BOOL)a5 transferCtx:(id)a6 forbidSendMicStatus:(BOOL)a7 on:(id)a8 completion:(id /* block */)a9;
