@class WCFinderContact, NSArray, WCFinderRedDotTipsShowInfo, NSNumber, WCFinderRedDotCtrlInfo;

@interface WCFinderNotifyCenterTabPageVC : WCFinderTabPageViewController
...
@property (retain, nonatomic) NSNumber *selectTabType;
