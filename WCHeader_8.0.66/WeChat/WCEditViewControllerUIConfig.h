...
@property (nonatomic) BOOL keepCenterWhenSmallerThanScreen;
@property (nonatomic) BOOL scaleWhenCrop;
...
+ (id)configForEmotionEditWithContentDisplayFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 isCropTimeOnly:(BOOL)a1 keepCenter:(BOOL)a2;
...
+ (id)configForEmotionEditWithContentDisplayFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 keepCenter:(BOOL)a1;
