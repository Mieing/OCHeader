@interface RoamDeviceManager : NSObject {
    ...
    struct shared_ptr<affroam::RoamDeviceManagerCppCover> { struct RoamDeviceManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<affroam::RoamDeviceManagerDispatcher> { struct RoamDeviceManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<affroam::RoamDeviceManagerDispatcher> { struct RoamDeviceManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
...
- (int)initializeCustomDevice:(id)a0;
- (void)connectAsync:(id /* block */)a0;
- (void)connectAsync:(id)a0 completion:(id /* block */)a1;
- (void)disconnectAsync:(id /* block */)a0;
- (void)disconnectAsync:(id)a0 completion:(id /* block */)a1;
- (void)subscribeConnectivityChangedEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeConnectivityChangedEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeConnectivityChangedEvent:(id)a0;
- (void)getVersionConflictInfoAsync:(id /* block */)a0;
- (void)getVersionConflictInfoAsync:(id)a0 completion:(id /* block */)a1;
