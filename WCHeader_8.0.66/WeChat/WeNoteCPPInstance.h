@interface WeNoteCPPInstance : NSObject {
    ...
    struct shared_ptr<wenote::WeNoteCPPInstanceCppCover> { struct WeNoteCPPInstanceCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<wenote::WeNoteCPPInstanceDispatcher> { struct WeNoteCPPInstanceDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<wenote::WeNoteCPPInstanceDispatcher> { struct WeNoteCPPInstanceDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
...
- (void)saveNoteAsync:(id)a0 completion:(id /* block */)a1;
- (void)saveNoteAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (BOOL)hasEdited;
- (BOOL)isEmpty;
- (void)beginEditAttachment:(id)a0;
- (void)endEditAttachment:(id)a0;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
