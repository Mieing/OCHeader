...
@interface SettingQuickReplyViewController : NewSettingBaseViewController {
...
- (id)genCellWithTitle:(id)a0 index:(long long)a1 viewId:(id)a2;
- (long long)indexToSetting:(long long)a0;
