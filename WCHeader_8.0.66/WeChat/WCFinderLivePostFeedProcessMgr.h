...
@interface WCFinderLivePostFeedProcessMgr : NSObject <WCEditVideoViewControllerDelegate, WCFinderPostViewControllerDelegate, WCEditImageViewControllerDelegate, MJMovieComposingViewControllerDelegate>
...
@property (nonatomic) unsigned long long currentPostEnterScene;
@property (weak, nonatomic) id<WCFinderLivePostFeedProcessMgrDelegate> delegate;
