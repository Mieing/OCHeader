@class NSIndexPath, NSString, UICollectionView, UIView, WCFinderVideoProducerDataSource, MMUIButton;
@protocol WCFinderVideoProducerMusicBarDelegate;

@interface WCFinderVideoProducerMusicBarViewController : WCFinderVideoProducerBaseViewControllerFragment <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
...
@property (weak, nonatomic) id<WCFinderVideoProducerMusicBarDelegate> delegate;
