@class NSString, GameLifeContact;
...
@property (nonatomic) unsigned int digestFlag;
@property (retain, nonatomic) NSString *digestPrefix;
@property (retain, nonatomic) GameLifeContact *gameLifeContact;
...
- (id)initWithSessionId:(id)a0 talker:(id)a1 selfUsername:(id)a2 lastMsg:(id)a3 needUpdateUnreadCount:(BOOL)a4;
- (void)updateWithNewMsg:(id)a0 needUpdateUnreadCount:(BOOL)a1;
- (void)setLastMessage:(id)a0;
- (void)setPbLastMessage:(id)a0;
- (void)updateDigestFlag:(id)a0;
- (void)bindWithGameLifeContact:(id)a0;
