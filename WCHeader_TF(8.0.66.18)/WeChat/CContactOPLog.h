...
+ (void)handelStartModifyContactUserName:(id)a0 arrMultipleOplogCmdItem:(id)a1 isSuccess:(BOOL)a2 oplogRet:(id)a3 ret:(unsigned int)a4 callbackBlock:(id /* block */)a5;
