@class WCFinderMinimizeFloatingAudioSoundView, MMUILabel, UIFont;

@interface WCFinderMinimizeFloatingAudioOnlyView : UIView

@property (retain, nonatomic) MMUILabel *indicatorLabel;
@property (retain, nonatomic) WCFinderMinimizeFloatingAudioSoundView *leftView;
@property (retain, nonatomic) WCFinderMinimizeFloatingAudioSoundView *rightView;
