@interface AffStarDataManager : NSObject {
    ...
    struct shared_ptr<star::AffStarDataManagerCppCover> { struct AffStarDataManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<star::AffStarDataManagerDispatcher> { struct AffStarDataManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<star::AffStarDataManagerDispatcher> { struct AffStarDataManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (BOOL)initWithConfigDir:(id)a0;
- (void)insertByIdAsync:(id)a0 completion:(id /* block */)a1;
- (void)insertByIdAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)deleteByIdAsync:(unsigned long long)a0 completion:(id /* block */)a1;
- (void)deleteByIdAsync:(unsigned long long)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)deleteByIdAndTypeAsync:(id)a0 btype:(int)a1 completion:(id /* block */)a2;
- (void)deleteByIdAndTypeAsync:(id)a0 btype:(int)a1 on:(id)a2 completion:(id /* block */)a3;
- (id)getByIdAndType:(id)a0 btype:(int)a1;
- (void)getAllStarDataAsync:(unsigned long long)a0 completion:(id /* block */)a1;
- (void)getAllStarDataAsync:(unsigned long long)a0 on:(id)a1 completion:(id /* block */)a2;
- (BOOL)hasData;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
