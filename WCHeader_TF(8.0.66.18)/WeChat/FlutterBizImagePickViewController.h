@class UIView, NSString, UINavigationController, WCAlbumPickViewController, MMImagePickerManagerOptionObj, MMAssetPickerController, MMSightCameraViewController, UIViewController, MMUIButton;
