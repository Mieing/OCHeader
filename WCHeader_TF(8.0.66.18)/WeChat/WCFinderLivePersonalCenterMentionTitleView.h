@class MMUIButton, WCFinderLivePersonalCenterMentionTitleModel, UIImageView, WCFinderInteractionLabelGroupView, UILabel, WCFinderAggregatedTitleView, RichTextView;
@protocol WCFinderLivePersonalCenterMentionTitleViewDelegate;

@interface WCFinderLivePersonalCenterMentionTitleView : UIView
...
@property (retain, nonatomic) WCFinderLivePersonalCenterMentionTitleModel *model;
@property (nonatomic) double layoutWidth;
@property (nonatomic) double intrinsicHeight;
@property (weak, nonatomic) id<WCFinderLivePersonalCenterMentionTitleViewDelegate> delegate;
