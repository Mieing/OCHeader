@class TPMTLDisplayConfig, NSObject, UIView, TPMTLGeneralFrameRenderer, TPMTLDisplayView;
@protocol MTLDevice;

@interface TPMTLRendererManager : NSObject

@property (retain, nonatomic) id<MTLDevice> mtlDevice;
@property (retain, nonatomic) TPMTLGeneralFrameRenderer *renderer;
@property (retain, nonatomic) TPMTLDisplayView *mtkView;
@property (retain, nonatomic) TPMTLDisplayConfig *displayConfig;
