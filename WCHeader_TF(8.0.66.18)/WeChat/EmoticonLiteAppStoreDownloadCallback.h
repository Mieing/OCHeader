@interface EmoticonLiteAppStoreDownloadCallback : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonLiteAppStoreDownloadCallbackCppCover> { struct EmoticonLiteAppStoreDownloadCallbackCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonLiteAppStoreDownloadCallbackDispatcher> { struct EmoticonLiteAppStoreDownloadCallbackDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonLiteAppStoreDownloadCallbackDispatcher> { struct EmoticonLiteAppStoreDownloadCallbackDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
...
- (id)zidlObjToHolder;
- (void)onDownloadStatusChangedAsync:(id)a0 status:(int)a1 completion:(id /* block */)a2;
- (void)onDownloadStatusChangedAsync:(id)a0 status:(int)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)onDownloadProgressAsync:(id)a0 progress:(float)a1 completion:(id /* block */)a2;
- (void)onDownloadProgressAsync:(id)a0 progress:(float)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)onNeedPurchaseAsync:(id)a0 completion:(id /* block */)a1;
- (void)onNeedPurchaseAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
