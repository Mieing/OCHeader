...
@interface WCFinderLiveNewApplyBattleCGI : WCFinderLiveBaseCgi
...
- (id)initWithLiveTaskId:(id)a0 finderDataItem:(id)a1 liveMicId:(id)a2 liveCookies:(id)a3 battleMode:(unsigned long long)a4 battleScope:(unsigned long long)a5 battleDuration:(unsigned long long)a6 battleTeams:(id)a7 winningCondition:(unsigned long long)a8 winningConditionArguments:(id)a9 vroomId:(id)a10 battleLayout:(unsigned int)a11 successBlock:(id /* block */)a12 failBlock:(id /* block */)a13;
- (void)createRequest;
