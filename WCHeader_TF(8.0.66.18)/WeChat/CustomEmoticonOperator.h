@interface CustomEmoticonOperator : NSObject {
    ...
    struct shared_ptr<emoticon::CustomEmoticonOperatorCppCover> { struct CustomEmoticonOperatorCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::CustomEmoticonOperatorDispatcher> { struct CustomEmoticonOperatorDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::CustomEmoticonOperatorDispatcher> { struct CustomEmoticonOperatorDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)isEmoticonAddedAsync:(id)a0 completion:(id /* block */)a1;
- (void)isEmoticonAddedAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)stickEmoticonListToTopAsync:(id)a0 type:(int)a1 completion:(id /* block */)a2;
- (void)stickEmoticonListToTopAsync:(id)a0 type:(int)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)deleteEmoticonListAsync:(id)a0 type:(int)a1 completion:(id /* block */)a2;
- (void)deleteEmoticonListAsync:(id)a0 type:(int)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)addEmoticonAsync:(const void *)a0 msgWrap:(const void *)a1 completion:(id /* block */)a2;
- (void)addEmoticonAsync:(const void *)a0 msgWrap:(const void *)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
