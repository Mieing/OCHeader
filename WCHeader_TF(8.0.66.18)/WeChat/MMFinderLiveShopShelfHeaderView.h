@class UIView, NSString, MMFinderLiveShopShelfHeaderSubInfosView, MMFinderLiveShopShelfAudienceHeaderButtonGroupView, UIButton, MMFinderLiveShopShelfDisplayWindowButton, MMLiveShopShelfDragBar, MMUIButton, MMFinderLiveShopShelfHeaderViewModel;

@interface MMFinderLiveShopShelfHeaderView : UIView <MMFinderLiveShopShelfHeaderViewModelView, MMFinderLiveShopShelfHeaderSubInfosViewLoadDelegate, MMFinderLiveShopShelfDisplayWindowButtonLoadDelegate, MMFinderLiveShopShelfHeaderContentView>
