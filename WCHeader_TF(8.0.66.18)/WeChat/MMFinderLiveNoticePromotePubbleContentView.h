@class MMLiveIconButton, WCFinderLiveNoticePayActionView, FinderLiveNoticeInfo, MMWebImageView, NSString, MMPaddingView, WCLiveActionSheet, WCFinderBaseCgi, MMUILabel, MMUIButton, MMFinderLiveBuyTicketHandle;
