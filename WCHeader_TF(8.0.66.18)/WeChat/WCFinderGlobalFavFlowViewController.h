@class UIView, WCFinderFeedFlowView, WCFinderGlobalFavFlowPageViewModel, WCFinderExtStatsReporter, WCFinderGlobalFavFlowViewModel, NSString, WCSearchBar, WCFinderRichTextView, NSMutableSet, UILabel;
...
@property (retain, nonatomic) WCFinderGlobalFavFlowViewModel *viewModel;
@property (retain, nonatomic) WCFinderGlobalFavFlowPageViewModel *pageViewModel;
...
- (void)removeContentVM:(id)a0 indexPath:(id)a1;
- (void)favListViewModelDeleteDataItemTid:(id)a0;
