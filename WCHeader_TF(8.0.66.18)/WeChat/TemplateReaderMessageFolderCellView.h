@class MMUIButton, NSString, TemplateReaderMessageFolderViewModel, NSMutableArray;

@interface TemplateReaderMessageFolderCellView : BaseMessageCellView <ReaderMessageFolderCellViewDelegate>

@property (retain, nonatomic) TemplateReaderMessageFolderViewModel *viewModel;
