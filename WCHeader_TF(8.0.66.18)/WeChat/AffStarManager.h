@interface AffStarManager : NSObject {
    ...
    struct shared_ptr<star::AffStarManagerCppCover> { struct AffStarManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<star::AffStarManagerDispatcher> { struct AffStarManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<star::AffStarManagerDispatcher> { struct AffStarManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (BOOL)isOpenStarSwitch;
- (void)setOpenStarSwitch:(BOOL)a0;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
