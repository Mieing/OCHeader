...
@property (weak, nonatomic) id<WCPayOverseaTransferOrderCgiDelegate> m_delegate;
...
- (void)startRequestArgument:(id)a0;
- (void)callErrorDelegateWithErrorCode:(int)a0 ErrorMsg:(id)a1;
- (void)callDelegateHasUnreceiveWithResp:(id)a0;
- (void)callDelegateHasTheSameAmountUnreceiveWithResp:(id)a0;
- (void)callOkDelegateWithResp:(id)a0;
