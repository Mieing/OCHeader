@interface EmoticonCustomAddLogic : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonCustomAddLogicCppCover> { struct EmoticonCustomAddLogicCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonCustomAddLogicDispatcher> { struct EmoticonCustomAddLogicDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonCustomAddLogicDispatcher> { struct EmoticonCustomAddLogicDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)init:(id)a0 createName:(const void *)a1 svrIdentity:(const void *)a2;
- (id)zidlObjToHolder;
- (void)addEmoticonAsync:(id /* block */)a0;
- (void)addEmoticonAsync:(id)a0 completion:(id /* block */)a1;
- (void)exchangeForSendAsync:(id /* block */)a0;
- (void)exchangeForSendAsync:(id)a0 completion:(id /* block */)a1;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
