@class NSMutableDictionary, NSArray, NSMutableArray, MMTextStateMediaDownloadTaskInfo;
...
@property (retain, nonatomic) MMTextStateMediaDownloadTaskInfo *curTaskInfo;
