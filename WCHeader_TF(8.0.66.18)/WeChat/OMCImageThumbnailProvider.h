@class NSMutableDictionary, NSString, UIImage, OMJID;

@interface OMCImageThumbnailProvider : NSObject <OMCThumbnailProvider> {
...
- (id)initWithClipSegment:(id)a0 maxPixelSize:(struct CGSize { double x0; double x1; })a1;
- (void)dealloc;
