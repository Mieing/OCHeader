...
@interface MMLiveReplayFragmentViewController : MMUIViewController <MMLiveReplayFragmentPlayerControlDelegate, WCPlayerDownloaderExt, ForwardMessageLogicDelegate, WCFinderLivePostFeedProcessMgrDelegate>
