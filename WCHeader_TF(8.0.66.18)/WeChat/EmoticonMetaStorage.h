@interface EmoticonMetaStorage : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonMetaStorageCppCover> { struct EmoticonMetaStorageCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonMetaStorageDispatcher> { struct EmoticonMetaStorageDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonMetaStorageDispatcher> { struct EmoticonMetaStorageDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (id)loadStoreItemFromCache:(id)a0;
- (void)saveStoreItemToCache:(id)a0;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
