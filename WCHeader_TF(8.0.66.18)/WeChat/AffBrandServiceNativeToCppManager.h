@interface AffBrandServiceNativeToCppManager : NSObject {
    ...
    struct shared_ptr<brand_service::AffBrandServiceNativeToCppManagerCppCover> { struct AffBrandServiceNativeToCppManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<brand_service::AffBrandServiceNativeToCppManagerDispatcher> { struct AffBrandServiceNativeToCppManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<brand_service::AffBrandServiceNativeToCppManagerDispatcher> { struct AffBrandServiceNativeToCppManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)requestAdFetchingWithResortAsync:(id /* block */)a0;
- (void)requestAdFetchingWithResortAsync:(id)a0 completion:(id /* block */)a1;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
