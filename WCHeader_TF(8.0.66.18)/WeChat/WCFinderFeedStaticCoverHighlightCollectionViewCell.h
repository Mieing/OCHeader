@class FavAttributeCPLabel, WCFinderFeedStaticCoverView, UIImage, NSString, WCFinderFeedMediaWrap, WCFinderSearchHighLightItemModel, WCFinderFeedStaticCoverContactView, UIPageControl, UILabel;
...
@property (retain, nonatomic) WCFinderSearchHighLightItemModel *dataModel;
