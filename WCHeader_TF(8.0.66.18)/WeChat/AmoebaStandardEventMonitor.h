@class NSString, NSMutableDictionary, AmoebaStayInfo, NSMutableArray;

@interface AmoebaStandardEventMonitor : NSObject <AmoebaStandardEventDelegate> {
...
- (id)init;
- (void)onAppIn:(unsigned long long)a0 inType:(unsigned long long)a1;
- (void)onAppOut:(unsigned long long)a0 outType:(unsigned long long)a1;
