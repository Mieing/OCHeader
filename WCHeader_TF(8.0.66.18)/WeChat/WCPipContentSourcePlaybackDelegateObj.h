...
@interface WCPipContentSourcePlaybackDelegateObj : NSObject <AVPictureInPictureSampleBufferPlaybackDelegate>

@property (weak, nonatomic) NSObject<AVPictureInPictureSampleBufferPlaybackDelegate> *delegate;
