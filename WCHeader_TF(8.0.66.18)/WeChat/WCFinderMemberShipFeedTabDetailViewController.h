@class WCFinderShareCustomTransition, NSString, WCFinderMemberShipFeedTabDetailViewModel, WCFinderFeedContentVM, WCFinderFeedListView;
...
@property (retain, nonatomic) WCFinderMemberShipFeedTabDetailViewModel *viewModel;
...
- (id)initWithFeedTabViewModel:(id)a0 preVCData:(id)a1;
- (void)viewDidLoad;
