@interface EmoticonDesignerPortfolioPackDataSource : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonDesignerPortfolioPackDataSourceCppCover> { struct EmoticonDesignerPortfolioPackDataSourceCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonDesignerPortfolioPackDataSourceDispatcher> { struct EmoticonDesignerPortfolioPackDataSourceDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonDesignerPortfolioPackDataSourceDispatcher> { struct EmoticonDesignerPortfolioPackDataSourceDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)fetchPackList:(int)a0 cleanReq:(BOOL)a1 needStaticsInfo:(BOOL)a2 needExposeEmoji:(BOOL)a3;
- (id)getStorePackList:(int)a0;
- (BOOL)isPackListHasMore:(int)a0;
