@class TXCAsyncWritePacket, NSString, NSURL, NSData, TXCAsyncSocketPreBuffer, NSObject, NSMutableArray, TXCAsyncReadPacket;
@protocol TXCAsyncSocketDelegate, OS_dispatch_queue, OS_dispatch_source;
...
@property (weak) id<TXCAsyncSocketDelegate> delegate;
