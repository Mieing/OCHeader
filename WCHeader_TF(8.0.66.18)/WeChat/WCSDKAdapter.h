...
+ (BOOL)StartSnsVideoStreamingDownload:(id)a0 httpUrl:(id)a1 fileType:(int)a2 appType:(int)a3 filePath:(id)a4 preloadPercent:(int)a5 Timeout:(unsigned int)a6 referer:(id)a7 blockSize:(unsigned int)a8;
