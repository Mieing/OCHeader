...
@interface WeChat.KaraLiveHomePageHistoryRecord : WeChat.KaraHistoryRecord <WCTTableCoding, KaraHistoryRecordIdentifiable> {
...
@property (nonatomic) void /* unknown type, empty encoding */ unreadAtOtherCell;
@property (nonatomic) void /* unknown type, empty encoding */ badgeAtOtherCell;
