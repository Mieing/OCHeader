@interface FlutterCommonManager : NSObject {
    ...
    struct shared_ptr<flutter_common::FlutterCommonManagerCppCover> { struct FlutterCommonManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<flutter_common::FlutterCommonManagerDispatcher> { struct FlutterCommonManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<flutter_common::FlutterCommonManagerDispatcher> { struct FlutterCommonManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (unsigned long long)getCommonStructPointer;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
