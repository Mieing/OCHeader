@class UIView, MMBadgeView, NSString, UIImageView, UIButton, CAShapeLayer, CAGradientLayer, MMLiveBeautyItem, UILabel;

@interface MMLiveBeautyItemCollectionCell : UICollectionViewCell <MMLiveBeautyBadgeItemExt>
