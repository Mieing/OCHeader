...
- (void)_accumulateCharacters:(const char *)a0 length:(int)a1;
- (BOOL)parse;
- (void)abortParsing;
...
- (BOOL)_lookupCustomElement:(const char *)a0;
- (void).cxx_destruct;
