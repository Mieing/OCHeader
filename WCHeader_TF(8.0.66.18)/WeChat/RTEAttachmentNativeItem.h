@interface RTEAttachmentNativeItem : NSObject {
    ...
    struct shared_ptr<wcrte::RTEAttachmentNativeItemCppCover> { struct RTEAttachmentNativeItemCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<wcrte::RTEAttachmentNativeItemDispatcher> { struct RTEAttachmentNativeItemDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<wcrte::RTEAttachmentNativeItemDispatcher> { struct RTEAttachmentNativeItemDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
