@interface EmoticonStoreEventCenter : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonStoreEventCenterCppCover> { struct EmoticonStoreEventCenterCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonStoreEventCenterDispatcher> { struct EmoticonStoreEventCenterDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonStoreEventCenterDispatcher> { struct EmoticonStoreEventCenterDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)onEmoticonStoreItemInstallFinishedAsync:(id)a0 completion:(id /* block */)a1;
- (void)onEmoticonStoreItemInstallFinishedAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)onEmoticonStoreItemInstallFailedAsync:(id)a0 completion:(id /* block */)a1;
- (void)onEmoticonStoreItemInstallFailedAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)onEmoticonStoreItemChangedAsync:(id)a0 completion:(id /* block */)a1;
- (void)onEmoticonStoreItemChangedAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
