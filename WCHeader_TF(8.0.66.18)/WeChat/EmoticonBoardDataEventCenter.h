@interface EmoticonBoardDataEventCenter : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonBoardDataEventCenterCppCover> { struct EmoticonBoardDataEventCenterCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonBoardDataEventCenterDispatcher> { struct EmoticonBoardDataEventCenterDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonBoardDataEventCenterDispatcher> { struct EmoticonBoardDataEventCenterDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)onEmoticonThumbUpdatedAsync:(id)a0 thumbPath:(id)a1 completion:(id /* block */)a2;
- (void)onEmoticonThumbUpdatedAsync:(id)a0 thumbPath:(id)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
