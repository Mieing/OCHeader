@interface BizDynamicCardMrg : NSObject {
    ...
    struct shared_ptr<biz::BizDynamicCardMrgCppCover> { struct BizDynamicCardMrgCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<biz::BizDynamicCardMrgDispatcher> { struct BizDynamicCardMrgDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<biz::BizDynamicCardMrgDispatcher> { struct BizDynamicCardMrgDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
