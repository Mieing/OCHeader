@class UIWindow, NSString, NSMutableDictionary, NSHashTable, UIScrollView, NSMutableArray;
...
@property (weak, nonatomic) id<WCGeneralMonitorDelegate> monitorDelegate;
