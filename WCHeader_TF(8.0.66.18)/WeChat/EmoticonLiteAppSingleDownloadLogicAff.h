@interface EmoticonLiteAppSingleDownloadLogicAff : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonLiteAppSingleDownloadLogicAffCppCover> { struct EmoticonLiteAppSingleDownloadLogicAffCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonLiteAppSingleDownloadLogicAffDispatcher> { struct EmoticonLiteAppSingleDownloadLogicAffDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonLiteAppSingleDownloadLogicAffDispatcher> { struct EmoticonLiteAppSingleDownloadLogicAffDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
