@interface AffBrandServiceRedDotManager : NSObject {
    ...
    struct shared_ptr<brand_service::AffBrandServiceRedDotManagerCppCover> { struct AffBrandServiceRedDotManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<brand_service::AffBrandServiceRedDotManagerDispatcher> { struct AffBrandServiceRedDotManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<brand_service::AffBrandServiceRedDotManagerDispatcher> { struct AffBrandServiceRedDotManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
