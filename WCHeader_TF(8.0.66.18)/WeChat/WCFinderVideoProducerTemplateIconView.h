@class WCFinderVideoProducerTemplateCellViewModel, NSString, MMWebImageView, UIView, PAGView, PAGFile, WCProgressMaskView, UILabel;

@interface WCFinderVideoProducerTemplateIconView : UICollectionViewCell <MMWebImageViewDelegate, WCMVVMViewComponent> {
    PAGFile *_pagFile;
}
...
@property (retain, nonatomic) WCFinderVideoProducerTemplateCellViewModel *templateCellViewModel;
