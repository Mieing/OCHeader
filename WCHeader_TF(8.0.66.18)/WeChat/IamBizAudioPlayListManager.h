@interface IamBizAudioPlayListManager : NSObject {
    ...
    struct shared_ptr<biz::IamBizAudioPlayListManagerCppCover> { struct IamBizAudioPlayListManagerCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<biz::IamBizAudioPlayListManagerDispatcher> { struct IamBizAudioPlayListManagerDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<biz::IamBizAudioPlayListManagerDispatcher> { struct IamBizAudioPlayListManagerDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)getSpecialPlayListAsync:(int)a0 completion:(id /* block */)a1;
- (void)getSpecialPlayListAsync:(int)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)subscribeSpecialPlayListChangedEvent:(id)a0 on:(id)a1 eventBlock:(id /* block */)a2;
- (void)subscribeSpecialPlayListChangedEvent:(id)a0 eventBlock:(id /* block */)a1;
- (void)unsubscribeSpecialPlayListChangedEvent:(id)a0;
- (void)getPlayingPlayListAsync:(id /* block */)a0;
- (void)getPlayingPlayListAsync:(id)a0 completion:(id /* block */)a1;
- (void)playPlayListAsync:(id)a0 index:(int)a1 completion:(id /* block */)a2;
- (void)playPlayListAsync:(id)a0 index:(int)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)addToPlayLaterAsync:(id)a0 completion:(id /* block */)a1;
- (void)addToPlayLaterAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)updatePlayerState:(BOOL)a0;
- (void)markManualChangingIndex;
- (void)getAudioRecommendEnabledAsync:(id /* block */)a0;
- (void)getAudioRecommendEnabledAsync:(id)a0 completion:(id /* block */)a1;
- (void)setAudioRecommendEnabledAsync:(BOOL)a0 completion:(id /* block */)a1;
- (void)setAudioRecommendEnabledAsync:(BOOL)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
