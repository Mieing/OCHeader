@class MJShootComposingViewModel, MJGradientView, WCProgressMaskView, MMUIView, UIView, MMUIButton, MJShootRedPacketResponseInfo;
@protocol MJShootSimplePreviewViewControllerDelegate;

@interface MJShootSimplePreviewViewController : MMUIViewController
