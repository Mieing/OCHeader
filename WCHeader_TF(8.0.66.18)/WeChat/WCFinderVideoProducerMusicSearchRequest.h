@class WCFinderVideoProducerMusicPlayingOperation, NSString, NSMutableArray, OrderedDictionary;

@interface WCFinderVideoProducerMusicSearchRequest : NSObject <NSCopying>
...
@property (retain, nonatomic) WCFinderVideoProducerMusicPlayingOperation *currentSearchPlayingOperation;
