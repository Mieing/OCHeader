@class UIView, MMLiveFilterDataItem, MMBadgeView, NSString, UIImageView, UIButton, CAShapeLayer, CAGradientLayer, UILabel;

@interface MMLiveFilterItemCollectionCell : UICollectionViewCell <MMLiveBeautyBadgeItemExt>

@property (retain, nonatomic) MMLiveFilterDataItem *dataItem;
