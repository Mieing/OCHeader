@interface EmoticonSender : NSObject {
    ...
    struct shared_ptr<emoticon::EmoticonSenderCppCover> { struct EmoticonSenderCppCover *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_cover;
    struct weak_ptr<emoticon::EmoticonSenderDispatcher> { struct EmoticonSenderDispatcher *__ptr_; struct __shared_weak_count *__cntrl_; } cpp_dispatcher;
}

+ (id)shareInstance;
+ (id)buildZidlObjForHolder:(const void *)a0 svrIdentity:(const void *)a1 refCntManager:(void *)a2;

- (struct shared_ptr<emoticon::EmoticonSenderDispatcher> { struct EmoticonSenderDispatcher *x0; struct __shared_weak_count *x1; })getDispatcher;
- (void)setDispatcher:(const void *)a0;
- (id)initForZidlPrivate;
- (id)zidlObjToHolder;
- (void)getEmoticonMsgWrapAsync:(id)a0 completion:(id /* block */)a1;
- (void)getEmoticonMsgWrapAsync:(id)a0 on:(id)a1 completion:(id /* block */)a2;
- (void)uploadEmoticonAsync:(id)a0 xml:(id)a1 completion:(id /* block */)a2;
- (void)uploadEmoticonAsync:(id)a0 xml:(id)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)uploadNonStoreEmoticonAsync:(id)a0 path:(id)a1 completion:(id /* block */)a2;
- (void)uploadNonStoreEmoticonAsync:(id)a0 path:(id)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)checkEmoticonFileAndGetEmoticonWrapAsync:(id)a0 emoticonPath:(id)a1 completion:(id /* block */)a2;
- (void)checkEmoticonFileAndGetEmoticonWrapAsync:(id)a0 emoticonPath:(id)a1 on:(id)a2 completion:(id /* block */)a3;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
