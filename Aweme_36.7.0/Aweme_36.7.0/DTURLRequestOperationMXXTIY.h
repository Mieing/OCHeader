...
- (void)_flex_swizzle_f992c54f_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_2e4c99de_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_3f98a084_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_2cadcdc_connection:(id)a0 didReceiveData:(id)a1;
