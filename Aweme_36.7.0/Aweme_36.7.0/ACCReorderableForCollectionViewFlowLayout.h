@class UIView, UILongPressGestureRecognizer, CADisplayLink, NSString, AWEPassTouchView, UIPanGestureRecognizer, UITouch, UIImpactFeedbackGenerator, NSIndexPath;
@protocol ACCReorderableForCollectionViewDelegateFlowLayout, ACCReorderableForCollectionViewDataSource;
...
@property (retain, nonatomic) AWEPassTouchView *passTouchView;
@property (readonly, weak, nonatomic) id<ACCReorderableForCollectionViewDataSource> dataSource;
@property (readonly, weak, nonatomic) id<ACCReorderableForCollectionViewDelegateFlowLayout> delegate;
@property (retain, nonatomic) UIImpactFeedbackGenerator *feedbackGenerator;
@property (nonatomic) BOOL inCancelApply;
