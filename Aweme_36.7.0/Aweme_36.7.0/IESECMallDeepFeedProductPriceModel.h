@class IESECMallDeepFeedProductPriceDescModel, NSString, NSArray, NSNumber;

@interface IESECMallDeepFeedProductPriceModel : MTLModel <MTLJSONSerializing>
...
@property (retain, nonatomic) IESECMallDeepFeedProductPriceDescModel *minPriceDesc;
@property (retain, nonatomic) NSNumber *hotSalePrice;
@property (copy, nonatomic) NSString *hotSaleSKUID;
@property (retain, nonatomic) IESECMallDeepFeedProductPriceDescModel *hotSalePriceDesc;
