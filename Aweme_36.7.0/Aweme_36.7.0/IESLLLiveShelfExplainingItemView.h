@class IESLLGradientView, UIImageView, UILabel, UIView;

@interface IESLLLiveShelfExplainingItemView : UIView

@property (retain, nonatomic) UIView *viewContainerView;
@property (retain, nonatomic) IESLLGradientView *numberContainerView;
