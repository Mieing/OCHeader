@class NSArray, IESLLLiveShelfPagingDataController, NSString, IESLLLiveShelfListSectionController, IESLLLiveShelfListSectionViewModel;

@interface IESLLLiveShelfListViewModel : AWEBaseListViewModel <IESLLLiveShelfListSectionControllerDelegate>
