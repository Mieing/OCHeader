@class AWESearchPhotoSearchResultsPlaceholderViewController, NSString, AWESearchPhotoResultsContentTopAreaContainerView, AWEDoubleColumnSearchMerchandiseFilterManager, UIView, AWEMerchandiseComponentView, SearchCachalotView;

@interface AWESearchPhotoResultsContentView : UIView <AWESearchInlayScrollPanelContentViewProtocol, AWESearchPhotoContentResultProtocol>
