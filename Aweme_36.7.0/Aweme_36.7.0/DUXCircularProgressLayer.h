...
- (void)drawEmptyBar:(struct CGSize { double x0; double x1; })a0 context:(struct CGContext { } *)a1;
- (void)drawProgressBar:(struct CGSize { double x0; double x1; })a0 context:(struct CGContext { } *)a1;
- (void)drawText:(struct CGSize { double x0; double x1; })a0 context:(struct CGContext { } *)a1;
