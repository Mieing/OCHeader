...
@interface IESGCPCGLynxToastView : UIView <IESHYHybridViewLifecycleProtocol, IESGCPCGLayerItemViewProtocol, IESGCPCGStandardizedLynxView>
...
- (void)updateToastViewConstraintWithWidth:(long long)a0 Height:(long long)a1 duration:(long long)a2;
- (void).cxx_destruct;
