@class AWEPOITempoPOINameHeadTagsView;

@interface AWEPOITempoPOINameHeadTagsWidget : IESLLTempoBaseWidget

@property (weak, nonatomic) AWEPOITempoPOINameHeadTagsView *nodeView;
