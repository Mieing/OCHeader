@class NSString, NSDictionary, IESLLGoodsDetailPageContext, UIView, NSObject, IESLLPOIGoodsDetailCollectGuideInfo;
@protocol OS_dispatch_source, IESLLPopoverInterface;

@interface IESLLPOIGoodsDetailCollectGuideBubbleManager : NSObject
...
@property (retain, nonatomic) IESLLPOIGoodsDetailCollectGuideInfo *collectGuideInfo;
