@class UIStackView, UIView, IESECLiveSaleProgressView, IESECLiveGoodsProgressBarModel, IESECLiveGoodsMemoView, IESECLiveImageLabel, IESECLiveAccessibilityLabelGenerator, IESECLiveGoodsElasticTitleLineModel, YYLabel, NSMutableArray, NSString, NSNumber;
...
@property (retain, nonatomic) UIView *elasticTitleContainer;
