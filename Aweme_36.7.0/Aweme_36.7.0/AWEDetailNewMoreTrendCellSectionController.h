@interface AWEDetailNewMoreTrendCellSectionController : AWEBaseListSectionController

@property (copy, nonatomic) id /* block */ didEndDisplayCell;
...
- (void)configMoreTrendCell:(id)a0 model:(id)a1;
