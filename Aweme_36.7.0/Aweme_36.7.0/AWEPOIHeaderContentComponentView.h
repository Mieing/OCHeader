@class UIView, NSString, AWEPOIHeaderContentTabView, AWEPOIHeaderContentComponentViewModel, AWEPOIVideoMuteView, AWEPOIHeaderContentCrushRankView, UIImageView, UICollectionView;

@interface AWEPOIHeaderContentComponentView : AWEPOIDetailHeaderImageComponentBaseView <UICollectionViewDataSource, UICollectionViewDelegate, AWEPOIVideoPlayerDelegate, UIGestureRecognizerDelegate>

@property (weak, nonatomic) AWEPOIHeaderContentComponentViewModel *viewModel;
@property (retain, nonatomic) UIView *contentView;
@property (retain, nonatomic) UICollectionView *mediaListView;
@property (retain, nonatomic) UIImageView *loadMoreImageView;
@property (retain, nonatomic) AWEPOIHeaderContentTabView *tabListView;
