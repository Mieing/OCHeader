@class AWELiveShelfCardElementLotteryModel, UIImageView, UILabel, UIView;

@interface AWELiveShelfNativeLotteryView : UIView

@property (retain, nonatomic) UIView *containerView;
@property (retain, nonatomic) UIImageView *arrowIcon;
@property (retain, nonatomic) UILabel *timeLabel;
@property (retain, nonatomic) AWELiveShelfCardElementLotteryModel *lotteryModel;
