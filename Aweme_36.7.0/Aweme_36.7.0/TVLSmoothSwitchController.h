...
@interface TVLSmoothSwitchController : NSObject {
    struct shared_ptr<livecoreplayer::liveplayer::SmoothSwitchController> { struct SmoothSwitchController *__ptr_; struct __shared_weak_count *__cntrl_; } _smoothSwitchController;
}
