@class NSString, AWELiveShelfNativeLotteryView, UILabel, NSMutableArray, UIView;

@interface AWELiveShelfNativeSellingView : UIView <AWELiveShelfGlobalTimerDelegate>
...
@property (retain, nonatomic) AWELiveShelfNativeLotteryView *lotteryView;
