...
@interface AWEPaySwiftImpl.CCMOperationCardConfig : MTLModel <MTLJSONSerializing> {
    ...
    void /* function */ operationCardStyle;
}
...
@property (nonatomic, copy) NSString *mainButtonIcon;
...
@property (nonatomic, copy) NSString *operationCardStyle;
