@class AWEBGPlayLandscapeSettingsCellModel, NSString, DUXSwitch, UICollectionView, UILabel, UIView, DUXRadioBox;

@interface AWEBGPlaySettingsCell : UITableViewCell <UICollectionViewDelegate, UICollectionViewDataSource>
