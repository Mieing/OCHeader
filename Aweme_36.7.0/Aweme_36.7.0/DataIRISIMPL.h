...
@interface DataIRISIMPL : NSObject <TrackerAPI, TrackerAPI_Deprecated>
...
+ (void)addABSDKVersionBlock:(id /* block */)a0 forKey:(id)a1;
+ (void)removeABSDKVersionBlockForKey:(id)a0;
+ (void)addHTTPHeaderBlock:(id /* block */)a0 forKey:(id)a1;
+ (void)removeHTTPHeaderBlockForKey:(id)a0;
