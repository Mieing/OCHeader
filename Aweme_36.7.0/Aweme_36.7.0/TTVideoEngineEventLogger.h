...
- (void)setTargetLoudnessLogger:(double)a0;
- (void)setSmallSplTargetLoudnessLogger:(double)a0;
- (void)setMediumSplTargetLoudnessLogger:(double)a0;
- (void)setLargeSplTargetLoudnessLogger:(double)a0;
