@class NSMutableDictionary, CADisplayLink, AWEGoodsDetailMainInfoModel, NSString, AWEGoodsDetailMainInfoComponentView;

@interface AWEGoodsDetailMainInfoComponentViewModel : DitoComponentViewModel <AWEGDImageHeightChangeDelegate, AWEGDImageItemClickProtocol, AWEGDImagePointClickProtocol>
...
@property (retain, nonatomic) AWEGoodsDetailMainInfoModel *componentModel;
@property (weak, nonatomic) AWEGoodsDetailMainInfoComponentView *cell;
