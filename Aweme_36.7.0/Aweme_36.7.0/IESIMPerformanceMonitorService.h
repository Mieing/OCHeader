...
- (void)setSessionSceneName:(id)a0 forTargetVC:(id)a1;
...
- (void)beginCustomLoadWithKind:(id)a0 forTargetVC:(id)a1;
- (void)endCustomLoadWithKind:(id)a0 success:(BOOL)a1 forTargetVC:(id)a2;
