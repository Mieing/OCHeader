@class NSArray, NSDictionary, NSString, AWELifeFeedsPageInfo;

@interface AWELifeFeedsPageViewModel : NSObject
...
@property (retain, nonatomic) AWELifeFeedsPageInfo *pageInfo;
