@class UIView, NSString, AWENearbyHalfStyleConfigModel, NSArray, AWEGrouponHalfShowAction, AWEGrouponHalfClosedAction, NSDictionary, AWEGrouponHalfScreenGesturesInfo;

@interface AWEGrouponHalfScreenContainerModel : MTLModel <MTLJSONSerializing>
...
@property (retain, nonatomic) AWEGrouponHalfShowAction *halfShowAction;
...
@property (retain, nonatomic) AWEGrouponHalfScreenGesturesInfo *gesturesInfo;
...
@property (nonatomic) BOOL disableScrollToTop;
