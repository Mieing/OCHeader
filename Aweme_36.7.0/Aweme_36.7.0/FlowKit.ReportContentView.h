@interface FlowKit.ReportContentView : UIView <UICollectionViewDelegateFlowLayout, UICollectionViewDataSource> {
    ...
    void /* unknown type, empty encoding */ didSelectReasonBlock;
