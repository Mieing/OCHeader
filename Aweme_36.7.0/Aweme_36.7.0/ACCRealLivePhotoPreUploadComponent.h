...
@interface ACCRealLivePhotoPreUploadComponent : ACCFeatureComponent <ACCEditSessionLifeCircleEvent, ACCVideoEditFlowControlSubscriber, AWEVideoPublishAsImageAlbumResourceMessageProtocol, ACCPublishServiceMessage, ACCQuickSaveSubscriber, ACCEditHDPhotoServiceSubscription, ACCSequenceEditServicePlayerSubscriber>
...
@property (nonatomic) unsigned long long originLivePhotoMode;
...
- (BOOL)enableLivePhotoPreUpload;
- (BOOL)enablePreUploadForStaticMode;
- (BOOL)enablePreUploadForLiveAndLoopMode;
- (void).cxx_destruct;
