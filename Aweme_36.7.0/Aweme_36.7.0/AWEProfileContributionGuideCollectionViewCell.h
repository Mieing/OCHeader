...
@property (retain, nonatomic) UIImageView *actionButtonIconView;
@property (retain, nonatomic) UIImageView *aroundCoverBackgroundImageView;
...
- (void)configActionButtonIcon;
- (void)configAroundCoverStyle;
...
- (double)calculateActionButtonWidth;
