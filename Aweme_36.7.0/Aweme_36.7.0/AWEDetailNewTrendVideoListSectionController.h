@class AWEDetailNewTrendVideoItemViewController;

@interface AWEDetailNewTrendVideoListSectionController : AWEBaseListSectionController

@property (weak, nonatomic) AWEDetailNewTrendVideoItemViewController *videoItemViewController;
