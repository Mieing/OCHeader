@class BattleConfigSetting, NSString, ActivityUser, IESLiveLinkMicBizExtra, BattleLinkerInviteMessageExtra_RankSeasonInfo, BattleLinkerInviteMessageExtra_AcceptTip, BattleLinkerInviteMessageExtra_GameInfo, VoteSetting, NSMutableArray, BattleLinkerInviteMessageExtra_InviterRivalExtra, HTSLiveRoom;
...
@property (retain, nonatomic) BattleLinkerInviteMessageExtra_AcceptTip *acceptTip;
@property (nonatomic) BOOL hasAcceptTip;
