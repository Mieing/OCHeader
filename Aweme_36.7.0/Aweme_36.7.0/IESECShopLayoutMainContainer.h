@class NSString, IESECShopLayoutBaseContainer, IESECPagerView, IESECServiceProxy;
@protocol IESECShopThemeService, IESECShopForwardCoService, IESECShopStateService;

@interface IESECShopLayoutMainContainer : IESECShopLayoutBaseContainer <IESECShopLayoutBaseContainerDelegate>

@property (retain, nonatomic) NSString *frameworkType;
...
@property (retain, nonatomic) IESECShopLayoutBaseContainer *mediaContainer;
...
- (void)floatContainerDidBindView:(id)a0 viewType:(id)a1 layoutItem:(id)a2;
- (id)initWithFrameworkType:(id)a0;
- (void).cxx_destruct;
- (id)init;
- (void)viewDidLoad;
