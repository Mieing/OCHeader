@class NSArray, LLDitoComponentViewModel, IESLLGDElevatorViewManager, UIView, NSMutableArray, NSString;

@interface IESLLGDElevatorView : UIView <IESLLGDElevatorViewManagerDelegate>
...
@property (retain, nonatomic) IESLLGDElevatorViewManager *manager;
