...
- (void)ensureLoaderForContext:(id)a0;
- (void)loadJson:(id)a0 withContext:(id)a1 completion:(id /* block */)a2;
- (void)loadUri:(id)a0 withContext:(id)a1 completion:(id /* block */)a2;
