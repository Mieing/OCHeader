...
@interface AWEDanmakuFeedController : AWEPlayInteractionNewBaseController <AWEDanmakuBaseControllerDelegate, AWEPadUIAdaptionViewTransitionObserver, AWEPlayInteractionPlayerLifeCycleProtocol, AWEPlayInteractionNormalLynxOrH5PanelLifeCycleDelegateProtocol>
