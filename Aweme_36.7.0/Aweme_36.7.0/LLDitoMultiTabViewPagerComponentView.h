@class NSString, LLDitoMultiTabViewPagerComponentViewModel, LLDitoMultiTabViewPagerScrollView, NSMutableArray, LLDitoMultiTabDataModel;

@interface LLDitoMultiTabViewPagerComponentView : LLDitoComponentView <UIScrollViewDelegate, LLDitoMultiTabContainerProtocol>

@property (weak, nonatomic) LLDitoMultiTabViewPagerComponentViewModel *viewModel;
...
@property (retain, nonatomic) LLDitoMultiTabViewPagerScrollView *scrollView;
@property (retain, nonatomic) LLDitoMultiTabDataModel *cacheScrollingStartModel;
