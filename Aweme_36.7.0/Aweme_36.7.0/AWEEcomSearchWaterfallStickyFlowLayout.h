@class NSMutableDictionary, NSDictionary, NSArray, NSString, NSMutableArray;
@protocol AWENewCollectionDelegateWaterfallLayout;

@interface AWEEcomSearchWaterfallStickyFlowLayout : UICollectionViewLayout <AWEEcomSearchCollectionViewWaterfallLayoutProtocol>

@property (weak, nonatomic) id<AWENewCollectionDelegateWaterfallLayout> delegate;
...
- (void)prepareForDeleteItemsAtIndexSets:(id)a0 ofSection:(id)a1;
- (void)prepareForInsertItemsAtIndexSets:(id)a0 intoSections:(id)a1;
- (void)prepareForReloadItemAtIndexPaths:(id)a0;
- (void)prepareForReloadSections:(id)a0;
- (void).cxx_destruct;
