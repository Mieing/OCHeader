...
@interface AWEHPNormalChannelPageViewController : AWEHPChannelPageViewController <AWEFeedTabItemViewControllerProtocol>

@property (copy, nonatomic) id /* block */ getChannelObjectBlock;
