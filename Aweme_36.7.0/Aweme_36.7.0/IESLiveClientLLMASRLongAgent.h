@class IESLiveClientLLMASRLongAgentMonitor, NSString, NSDictionary, NSMutableArray, NSObject;
@protocol OS_dispatch_queue, IESLiveClientAIService;

@interface IESLiveClientLLMASRLongAgent : NSObject <IESLiveClientLLMASRLongAgentService>
...
@property (retain, nonatomic) IESLiveClientLLMASRLongAgentMonitor *monitor;
...
- (void)startASRLongAgent;
- (void)stopASRLongAgent;
- (void)summaryAnchorSpeechLongWithClientLLM:(id)a0;
