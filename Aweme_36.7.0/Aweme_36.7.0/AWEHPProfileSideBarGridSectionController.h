...
@interface AWEHPProfileSideBarGridSectionController : IGListSectionController <AWEHPListKitCollectionViewCellDelegate, IGListSupplementaryViewSource, AWEHPListKitModuleControllerProtocol, AWEHPSideBarSectionControllerProtocol>
