@class NSHashTable, NSString, AWEIMRecorderVolumeIncreaseViewConfig, CAShapeLayer, CALayer, CAGradientLayer, UILabel, UIScrollView;
...
@property (retain, nonatomic) CALayer *scrollViewMaskLayer;
...
- (void)updateLayoutWithMachineState:(unsigned long long)a0 scaleFactor:(double)a1;
