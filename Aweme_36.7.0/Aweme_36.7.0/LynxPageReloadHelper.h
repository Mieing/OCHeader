...
- (void)reloadLynxView:(BOOL)a0 withTemplate:(id)a1 fromFragments:(BOOL)a2 withSize:(int)a3 withReloadUrl:(id)a4;
- (void)reloadLynxView:(BOOL)a0 withReloadUrl:(id)a1;
