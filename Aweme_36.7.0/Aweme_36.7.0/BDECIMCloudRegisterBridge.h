...
@interface BDECIMCloudRegisterBridge : NSObject <TIMXAppMessageInsertPluginProtocol, TIMXStatisticProtocol>

@property (weak) id<BDECIMCloudCoreBridgeManagerV2Interface> bridgeManager;
