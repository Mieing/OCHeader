@class LLBizDitoCustomDataParserImpl;

@interface LLBizDitoCommonToolBarActionViewManager : NSObject

@property (retain, nonatomic) LLBizDitoCustomDataParserImpl *colorParser;
