@class AWEGrouponTaskStateManager, AWEGrouponTaskCommonContext, AWEGrouponTaskCenter, NSMutableDictionary, NSString;

@interface AWEGrouponTaskServiceImpl : NSObject <AWEGrouponTaskService>

@property (retain, nonatomic) AWEGrouponTaskCenter *taskCenter;
@property (retain, nonatomic) AWEGrouponTaskCommonContext *commonContext;
@property (retain, nonatomic) AWEGrouponTaskStateManager *stateManager;
