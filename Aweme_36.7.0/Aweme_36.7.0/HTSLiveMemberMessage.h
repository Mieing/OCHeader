@class NSString, HTSLiveImage, HTSLiveMemberMessage_EffectConfig, HTSLivePublicAreaCommon, NSMutableDictionary, HTSLiveCommon, HTSLiveMemberMessage_PicoEffectConfig, HTSLiveUser, HTSLiveText;
...
@property (retain, nonatomic) HTSLiveMemberMessage_PicoEffectConfig *picoEnterEffectConfig;
@property (nonatomic) BOOL hasPicoEnterEffectConfig;
@property (nonatomic) int unsetAdminType;
@property (nonatomic) long long enterRedirectFrom;
