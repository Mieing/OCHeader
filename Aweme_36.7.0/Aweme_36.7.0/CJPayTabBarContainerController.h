@class CJPayTabBar, NSString, UIScrollView, NSMutableArray;
@protocol CJPayTabBarContainerDelegate, CJPayTabBarProtocol;

@interface CJPayTabBarContainerController : UIViewController <UIScrollViewDelegate>
...
@property (retain, nonatomic) CJPayTabBar<CJPayTabBarProtocol> *tabbarView;
...
@property (weak, nonatomic) id<CJPayTabBarContainerDelegate> delegate;
...
- (void)scrollViewScrollToIndex:(long long)a0;
