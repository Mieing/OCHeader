...
@interface IESLiveFansClubStore : NSObject <HTSLiveMessageSubscriber, IESHYControllerDelegate, IESLiveFansGroupRouter>
...
@property (copy, nonatomic) NSString *ecomFansClubUrl;
...
@property (copy, nonatomic) NSString *lastOpenTimeStr;
...
- (void)requestFansClubEntryInfoWithRequestSource:(unsigned long long)a0;
- (void)requestEcomFansClubEntryInfoWithRequestSource;
- (void)track_fansClubStatusWithTrackContext:(id)a0 user:(id)a1;
- (void)p_bindSignals;
- (void)storageCache:(id)a0;
...
- (void)track_fansClubApiCallWithTrackContext:(id)a0 isEcomFansClub:(BOOL)a1 source:(unsigned long long)a2;
...
- (BOOL)p_isOpenEcomFansClubWithRequestPage:(unsigned long long)a0;
- (void)openFansGroupViewFinalFunctionWithMessage:(id)a0 trackType:(unsigned long long)a1 sourceType:(unsigned long long)a2 isSubscribeTab:(BOOL)a3 timeStampStr:(id)a4;
- (void)requestUserFansClubInfo;
- (BOOL)p_checkPaywallStatus;
- (BOOL)openGroupLiveMemberSelectPanel;
- (id)getRequestPageWithSourceType:(unsigned long long)a0;
