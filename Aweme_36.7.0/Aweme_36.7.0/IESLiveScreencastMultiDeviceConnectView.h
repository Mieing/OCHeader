...
@interface IESLiveScreencastMultiDeviceConnectView : UIView
...
@property (retain, nonatomic) UILabel *subTextLabel3;
...
@property (retain, nonatomic) NSDictionary *multiDeviceConfig;
@property (weak, nonatomic) id<IESLiveScreencastMultiDeviceConnectViewDelegate> delegate;
