@class DUXActionSheetPresentViewController, NSArray, NSString, UIImage, UIColor, DUXActionSheetItemModel, DUXActionSheetViewController;
@protocol IESIMActionSheetDelegate, IESIMActionSheetActionProtocol, DUXActionSheetDelegate;

@interface DUXActionSheet : NSObject <IESIMStandardActionSheetProtocol, DUXActionSheetDelegate>

@property (weak, nonatomic) id<IESIMActionSheetDelegate> iesimDelegate;
@property (retain, nonatomic) UIImage *titleIconImage;
@property (readonly, copy, nonatomic) NSArray *actions;
@property (retain, nonatomic) id<IESIMActionSheetActionProtocol> cancelAction;
...
- (void)messageReach_actionSheet:(id)a0 didClickButtonAtIndex:(long long)a1;
- (void)messageReach_actionSheetDidClickCancelButton:(id)a0;
- (void)messageReach_actionSheetDidClickMaskArea:(id)a0;
