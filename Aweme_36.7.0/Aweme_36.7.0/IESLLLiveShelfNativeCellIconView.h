@class IESLLLiveShelfNativeCellShapeLayerView, IESLLGradientView, UIImageView, LOTAnimationView, UILabel;

@interface IESLLLiveShelfNativeCellIconView : UIView

@property (retain, nonatomic) UIImageView *iconImageView;
@property (retain, nonatomic) IESLLLiveShelfNativeCellShapeLayerView *numberLabelBackView;
