...
- (void)_flex_swizzle_8ca6fb5d_URLSession:(id)a0 task:(id)a1 didCompleteWithError:(id)a2;
- (void)_flex_swizzle_83bebef0_URLSession:(id)a0 dataTask:(id)a1 didReceiveResponse:(id)a2 completionHandler:(id /* block */)a3;
- (void)_flex_swizzle_b15023dd_URLSession:(id)a0 dataTask:(id)a1 didReceiveData:(id)a2;
