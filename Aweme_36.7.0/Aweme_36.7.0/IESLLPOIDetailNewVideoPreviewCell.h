@class IESLLPOIDetailPhotoBaseInfo, NSString, IESLLPOIDetailPhotosPreviewBaseViewController, IESLLPOIVideoPlayerView, UILabel, UIButton;

@interface IESLLPOIDetailNewVideoPreviewCell : UICollectionViewCell <IESLLPOIVideoPlayerDelegate, IESLLPOIDetailVideosPreviewBaseCellProtocol>

@property (retain, nonatomic) UIButton *closeButton;
@property (retain, nonatomic) UILabel *indexLabel;
@property (retain, nonatomic) IESLLPOIVideoPlayerView *playerView;
@property (retain, nonatomic) IESLLPOIDetailPhotoBaseInfo *data;
