...
@interface IESLiveGuideMediaFisheyeContentPanelView : UIView <UITableViewDelegate, UITableViewDataSource>

@property (retain, nonatomic) IESLiveGuideModel *guideModel;
@property (retain, nonatomic) UITableView *tableView;
@property (retain, nonatomic) NSArray *limitAppConfigArray;
@property (retain, nonatomic) NSMutableArray *selectedAppidMultiArray;
