@class NSMutableArray, LLDitoNodeFlowLayoutItem;

@interface LLDitoNodeFlowLayout : LLDitoNodeLayout

@property (retain, nonatomic) NSMutableArray *columnItemList;
@property (retain, nonatomic) LLDitoNodeFlowLayoutItem *nextLayoutItem;
