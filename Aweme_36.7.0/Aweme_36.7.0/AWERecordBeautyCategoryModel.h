@class NSString, AWERecordBeautyCategoryExtraModel, NSMutableArray, IESCategoryModel;
@protocol AWERecordBeautyNodeProtocol;

@interface AWERecordBeautyCategoryModel : NSObject <AWERecordBeautyNodeProtocol>

@property (retain, nonatomic) IESCategoryModel *iesCategoryModel;
@property (retain, nonatomic) AWERecordBeautyCategoryExtraModel *extra;
