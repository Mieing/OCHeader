...
@protocol OS_dispatch_queue, SSWCTTrackProtocol;

@interface SSWCTTrackManager : NSObject

@property (weak, nonatomic) id<SSWCTTrackProtocol> trackService;
...
- (BOOL)crudCanTrack;
- (void)errorCanTrackWithDBTag:(long long)a0 path:(id)a1 errorCode:(long long)a2 block:(id /* block */)a3;
