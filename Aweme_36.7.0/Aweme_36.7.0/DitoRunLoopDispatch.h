@class DitoRunLoopDispatchConfig, NSMutableArray, NSObject;
@protocol OS_dispatch_semaphore;

@interface DitoRunLoopDispatch : NSObject
...
@property (retain, nonatomic) DitoRunLoopDispatchConfig *config;
