@class NSString, IESLLPOIDetailResponse, IESLLPOIDetailStore, IESLLPOIDetailConstData, NSDictionary;

@interface LLDitoGeneralContainerPageContext : LLDitoPageContext
