@class AWEFeedOfflineGuideCardCellViewController, NSString, AWEAwemeModel, UIView, UIViewController;
@protocol UIScrollViewDelegate;

@interface AWEFeedOfflineGuideCardTableViewCell : DUXBaseTableViewCell <AWEFeedTableViewCellProtocol>

@property (retain, nonatomic) AWEFeedOfflineGuideCardCellViewController *viewController;
