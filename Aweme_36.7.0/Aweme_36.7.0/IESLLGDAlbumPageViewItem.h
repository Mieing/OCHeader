@class IESLLGDAlbumRefreshFooter, NSString, UIImageView, NSDictionary, UITableView, IESLLGoodsDetailPageContext, UICollectionView, IESLLGDAlbumCategoryInfoModel, IESLLGDAlbumDataProcessor;

@interface IESLLGDAlbumPageViewItem : UIView <UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate, IESLLPOIDetailPhotosDynamicPreviewViewControllerLoadMoreDelegate, IESLLZoomTransitionOuterContextProvider, IESLLPOIDetailPhotosPreviewViewControllerDelegate>
...
@property (retain, nonatomic) IESLLGDAlbumRefreshFooter *footer;
@property (retain, nonatomic) IESLLGDAlbumDataProcessor *dataProcessor;
@property (retain, nonatomic) NSDictionary *logParams;
@property (retain, nonatomic) IESLLGDAlbumCategoryInfoModel *model;
