...
@property (readonly, nonatomic) NSString *annie_update_version_str;

- (id)initWithVersionInfo:(struct shared_ptr<uni::service::base_bundle::BaseBundleVersionInfo> { struct BaseBundleVersionInfo *x0; struct __shared_weak_count *x1; })a0;
- (void).cxx_destruct;
- (id).cxx_construct;
