@class UITapGestureRecognizer, AWEIMMessage, NSString, UIView, YYLabel;
@protocol AWEIMTextQuoteMessageProtocol;

@interface AWEIMQuoteReplyStyleTableViewCell : AWEIMUserMessageTableViewCell <AWEIMGradientBubbleProtocol>
