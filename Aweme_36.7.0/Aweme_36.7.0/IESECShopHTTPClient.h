@interface IESECShopHTTPClient : NSObject
...
+ (id)requestWithURLString:(id)a0 verifiedParams:(id)a1 modelClass:(Class)a2 completion:(id /* block */)a3 metricsBlock:(id /* block */)a4;
+ (id)requestWithURLString:(id)a0 params:(id)a1 modelClass:(Class)a2 completion:(id /* block */)a3;
...
+ (id)requestWithURLString:(id)a0 params:(id)a1 modelClass:(Class)a2 completion:(id /* block */)a3 metricsBlock:(id /* block */)a4;
