...
@interface IESLLGDLRUCacheShared : NSObject
...
+ (void)requestWithParams:(id)a0 bizCode:(id)a1 activityID:(id)a2 cacheFrom:(id)a3 cacheFromSubScene:(id)a4 completion:(id /* block */)a5;
+ (id)shared;
