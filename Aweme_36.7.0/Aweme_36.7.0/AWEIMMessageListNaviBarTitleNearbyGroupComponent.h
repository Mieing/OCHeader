...
@interface AWEIMMessageListNaviBarTitleNearbyGroupComponent : AWEIMComponentBase <AWEIMMessageListNaviBarTitleProvider>

@property (nonatomic) BOOL shouldShowNearbyGroupLabel;
@property (retain, nonatomic) UILabel *nearbyGroupLabel;
