...
- (void)trackOpenGameResultWithContext:(id)a0 result:(id)a1;
- (void)openGameAppWithScheme:(id)a0 gameID:(id)a1 completionHandler:(id /* block */)a2;
- (BOOL)handleHttpPrefixFormatWithURL:(id)a0 gameID:(id)a1;
