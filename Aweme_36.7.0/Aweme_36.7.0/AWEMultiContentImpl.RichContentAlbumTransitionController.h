...
@interface AWEMultiContentImpl.RichContentAlbumTransitionController : AWEBaseController <AFDAlbumDetailTransitionOuterContextProvider, AWEFeedAlbumPanelTransitionOuterContextProvider, AWERichContentAlbumTransitionControllerProtocol> {
