@class AWELifeFeedsPageContext, AWELifeFeedsBaseComponentView, NSMutableDictionary, AWENearbyLynxContainerView, AWELifeFeedsFeedFeedbackModel, NSString;
@protocol AWELifeFeedsShowFeedbackTaskDelegate;

@interface AWELifeFeedsShowFeedbackTask : NSObject <AWENearbyLynxContainerViewDelegate>
...
@property (retain, nonatomic) AWELifeFeedsFeedFeedbackModel *feedbackModel;
@property (weak, nonatomic) AWELifeFeedsPageContext *pageContext;
@property (weak, nonatomic) id<AWELifeFeedsShowFeedbackTaskDelegate> delegate;
