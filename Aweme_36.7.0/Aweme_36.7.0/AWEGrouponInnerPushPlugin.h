@class AWEGrouponAsyncUpdateModuleModel, AWEGrouponInnerPushConfigDataModel, NSTimer, NSString;

@interface AWEGrouponInnerPushPlugin : AWEGrouponFeedBasePlugin <AWENearbyContainerEventMessage, AWEGrouponFeedEventMessage, AWEGrouponTaskInnerPushMessage>

@property (retain, nonatomic) AWEGrouponAsyncUpdateModuleModel *asyncUpdateModuleModel;
@property (retain, nonatomic) AWEGrouponInnerPushConfigDataModel *innerPushConfigData;
...
- (void)handleInnerPushWithTask:(id)a0;
- (void)discardedInnerPushTask:(id)a0;
