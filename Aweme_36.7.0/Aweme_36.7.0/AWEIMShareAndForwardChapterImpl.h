@class AWEIMChapterMessageModel, AWEIMMessage, NSString;
@protocol IESIMShareContextProtocol;

@interface AWEIMShareAndForwardChapterImpl : NSObject <AWEIMShareAndForwardToChatProtocol>

@property (retain, nonatomic) AWEIMChapterMessageModel *chapterShareModel;
