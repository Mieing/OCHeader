...
@interface AWEUserRecommendCardSectionController : AWEBaseListSectionController <AWEUserRecommendSectionViewModelDelegate, IGListScrollDelegate>
...
- (BOOL)sectionViewModelShouldUseReloadAnimation:(id)a0;
