@class NSString, NSDictionary, IESECRelationActivityDynamicComponentModel, UIView;
@protocol IESHYContainerProtocol, IESECWinFloatLynxContainerDelegate;

@interface IESECWinFloatLynxContainerView : UIView <IESHYHybridViewLifecycleProtocol, LynxViewLifecycle>
...
@property (weak, nonatomic) id<IESECWinFloatLynxContainerDelegate> delegate;
