...
@property (retain, nonatomic) UIViewController<AWEPhotosPreviewFadeOutTransitionContextProvider> *fromCP;
@property (retain, nonatomic) UIViewController<AWEPhotosPreviewFadeInTransitionContextProvider> *toCP;
