@class AWECoverPicTemplatePanelLoadingView, NSString, UICollectionView, ACCPicTemplatePanelDataManager, UICollectionViewFlowLayout, ACCPicTemplateCategoryModel;
@protocol AWECoverPicTemplatePanelContentCellDelegate;

@interface AWECoverPicTemplatePanelContentCell : UICollectionViewCell <UICollectionViewDelegate, UICollectionViewDataSource, AWECoverPicTemplatePanelContentCellProtocol>
...
@property (retain, nonatomic) ACCPicTemplateCategoryModel *categoryModel;
...
- (void)modernPreloadPicTemplateWithSelectIndexPath:(id)a0;
- (BOOL)isItemVertical;
