@class IESLiveGiftAssemblySectionViewModel, NSString, UIView;
@protocol IESHYContainerProtocol, IESLiveRefactGiftPanelSectionVMProtocol;

@interface IESLiveGiftAssemblyCardLynxView : IESLiveGiftCheckWindowView <IESHYHybridViewLifecycleProtocol, IESLiveRefactGiftPanelSectionViewProtocol>
