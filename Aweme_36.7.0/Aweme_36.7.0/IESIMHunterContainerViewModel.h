@class HunterDynamicPatchModel, NSString, IESIMHunterStartLynxRuntimePlugin, NSDictionary, HunterBasePlugin, IESIMHunterDataInjectionPlugin, UIView;
...
@interface IESIMHunterContainerViewModel : NSObject <IESIMBulletContainerViewModelProtocol, HunterContainerLifeCycleProtocol>

@property (retain, nonatomic) HunterDynamicPatchModel *hunterDynamicPatchModel;
@property (retain, nonatomic) IESIMHunterDataInjectionPlugin *dataInjectionPlugin;
@property (retain, nonatomic) IESIMHunterStartLynxRuntimePlugin *startLynxRuntimePlugin;
...
@property (readonly, nonatomic) HunterBasePlugin *imDataPlugin;
...
- (void)p_injectPerfDataIntoContext:(id)a0;
- (void)p_updatePerfData;
- (void)p_injectDictIntoClientData:(id)a0 forKey:(id)a1 forContext:(id)a2;
- (id)hunterDynamicPatchModelUpdatedInfoWithContext:(id)a0;
- (void).cxx_destruct;
