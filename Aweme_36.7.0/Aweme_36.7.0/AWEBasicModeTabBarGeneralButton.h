...
@protocol AWEBasicModeTabBarInnerView, AWEBasicModeTabBarButtonDelegate;

@interface AWEBasicModeTabBarGeneralButton : AWEBasicModeTabBarButton <AWEBasicModeTabBarGeneralButtonProtocol>
...
@property (retain, nonatomic) UIView<AWEBasicModeTabBarInnerView> *innerView;
@property (retain, nonatomic) UIImage *loadingImage;
@property (retain, nonatomic) UIImageView *loadingImageView;
@property (weak, nonatomic) id<AWEBasicModeTabBarButtonDelegate> delegate;
