@class UIView, NSString, ACCImageAlbumEditTagsUploadImageHelper, AWEVideoPublishViewModel, UIImage, UIImageView, NSDictionary, UIButton, UIViewController, AWEStickerContainerFakeProfileView;
