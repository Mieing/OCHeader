@class AWENearbyLRUCache, NSMutableDictionary, AWEGrouponTransformerAutoRefreshModel;
@protocol AWEGrouponTransformerAutoRefreshSceneControllerProtocol;

@interface AWEGrouponTransformerAutoRefreshHandle : NSObject

@property (weak, nonatomic) id<AWEGrouponTransformerAutoRefreshSceneControllerProtocol> sceneController;
@property (retain, nonatomic) NSMutableDictionary *cardAutoRefreshModelsMap;
@property (retain, nonatomic) AWEGrouponTransformerAutoRefreshModel *globalAutoRefreshModel;
