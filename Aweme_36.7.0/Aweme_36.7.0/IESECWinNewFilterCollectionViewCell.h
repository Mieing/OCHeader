@class IESECWinProductsSelectButtonContainer, NSString, NSTimer, IESECWinFilterDiffableModel, UIView, IESECSlidingTabbarView, IESECButton;
@protocol IESECWinFilterCollectionViewCellDelegate;

@interface IESECWinNewFilterCollectionViewCell : UICollectionViewCell <IESECSlidingTabbarLayoutDelegate, IESECSlidingTabbarDelegate, IESECWinProductsSelectButtonContainerDelegate, IGListBindable> {
    IESECWinProductsSelectButtonContainer *_selectButtonContainer;
}

@property (retain, nonatomic) IESECWinFilterDiffableModel *model;
...
@property (weak, nonatomic) id<IESECWinFilterCollectionViewCellDelegate> delegate;
