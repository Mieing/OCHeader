@class NSString, AWEIMRichRecorderViewModel;

@interface AWEIMRichRecorderCommonView : UIView <AWEIMRichRecorderCommonViewProtocol>

@property (weak, nonatomic) AWEIMRichRecorderViewModel *viewModel;
