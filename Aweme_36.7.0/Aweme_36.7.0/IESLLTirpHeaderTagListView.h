@class NSMutableArray, NSString, UIImageView, LLDitoPageContext, UIScrollView, UIView, UILabel;

@interface IESLLTirpHeaderTagListView : UIView <UIScrollViewDelegate>
