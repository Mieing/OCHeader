...
@interface AWEStudioAIGCAIMateEditAsyncBusinessHandler : NSObject <AWEStudioAIGCAsyncTaskBusinessHandlerProtocol>
...
+ (BOOL)currentSceneCanUpdateAIGCTaskInfoStatus;
