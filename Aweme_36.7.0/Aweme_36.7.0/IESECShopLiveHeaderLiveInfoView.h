@class UIView, IESECButton, NSString, IESECGradientView, CALayer, CAGradientLayer, IESECShopExtensionAreaDragDownView, UILabel;

@interface IESECShopLiveHeaderLiveInfoView : UIView <IESECLiveCardContainerDelegate> {
