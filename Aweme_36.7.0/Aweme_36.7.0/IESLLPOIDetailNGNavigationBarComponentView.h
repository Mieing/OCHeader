@class IESLLPOIDetailNGNavigationBarViewModel, IESLLPOINavButton, NSDictionary, BDXBridgeEventSubscriber, IESLLPOILynxContainerView;

@interface IESLLPOIDetailNGNavigationBarComponentView : LLDitoComponentView

@property (weak, nonatomic) IESLLPOIDetailNGNavigationBarViewModel *viewModel;
