...
- (void)update:(unsigned long long)a0 point:(struct CGPoint { double x0; double x1; })a1 touches:(id)a2 event:(id)a3 touchEvent:(id)a4 extraBundle:(id)a5;
...
- (void)handleUIEvent:(id)a0 touches:(id)a1 event:(id)a2 touchEvent:(id)a3 flingPoint:(struct CGPoint { double x0; double x1; })a4 handleBySimultaneous:(BOOL)a5 extraBundle:(id)a6;
