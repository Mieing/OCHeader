...
@property (nonatomic) long long groupApplyAllCount;
@property (nonatomic) long long groupApplyingCount;
...
- (void)updateGroupApplyAllCount:(long long)a0;
- (void)updateGroupApplyingCount:(long long)a0;
- (void)updateDiggAndOtherCount:(long long)a0;
...
- (void)readGroupApplyingWithTaskManager;
- (void)readGroupApplyAllWithTaskManager;
- (void)readDiggAndOtherWithTaskManager;
