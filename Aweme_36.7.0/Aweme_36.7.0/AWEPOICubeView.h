...
@protocol AnnieXContainerBaseProtocol, AWEPOICubeViewDelegate, AnnieXCardModelProtocol, BDXLynxViewProtocol, BDXMonitorProtocol;

@interface AWEPOICubeView : UIView <BDXKitViewLifecycleProtocol, AWEPOICubeMonitorDataSource, BDXContainerLifecycleProtocol, AnnieXDataProviderProtocol, AWEPOICubeViewDataSource>
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 cubeModel:(id)a1 extraParams:(id)a2 delegate:(id)a3;
...
- (id)initWithCubeModel:(id)a0 extraParams:(id)a1 delegate:(id)a2;
