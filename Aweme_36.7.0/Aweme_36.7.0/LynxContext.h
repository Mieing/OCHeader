@class NSString, NSMutableDictionary, LynxUIOwner, LynxUIIntersectionObserverManager, LynxKeyboardEventDispatcher;
...
@property (nonatomic) long long lynxEmbeddedMode;
...
@property (weak, nonatomic) LynxKeyboardEventDispatcher *keyboardEventDispatcher;
