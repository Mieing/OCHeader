...
- (struct AudioClassDescription { unsigned int x0; unsigned int x1; unsigned int x2; } *)getAudioClassDescriptionWithType:(unsigned int)a0 fromManufacturer:(unsigned int)a1;
- (id)initWithInFormat:(struct AudioStreamBasicDescription { double x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; })a0 outFormat:(struct AudioStreamBasicDescription { double x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; })a1;
- (int)encodeAudioFrame:(struct AVFrame { char *x0[8]; int x1[8]; char **x2; int x3; int x4; int x5; int x6; int x7; int x8; struct AVRational { int x0; int x1; } x9; long long x10; long long x11; long long x12; int x13; int x14; int x15; void *x16; unsigned long long x17[8]; int x18; int x19; int x20; int x21; long long x22; int x23; unsigned long long x24; struct AVBufferRef *x25[8]; struct AVBufferRef **x26; int x27; struct AVFrameSideData **x28; int x29; int x30; int x31; int x32; int x33; int x34; int x35; long long x36; long long x37; long long x38; struct AVDictionary *x39; int x40; int x41; int x42; char *x43; int x44; int x45; struct AVBufferRef *x46; struct AVBufferRef *x47; struct AVBufferRef *x48; unsigned long long x49; unsigned long long x50; unsigned long long x51; unsigned long long x52; struct AVBufferRef *x53; } *)a0 toAudioBuf:(struct AudioBufferList **)a1;
- (unsigned long long)copyPCMSamplesIntoBuffer:(struct AudioBufferList { unsigned int x0; struct AudioBuffer { unsigned int x0; unsigned int x1; void *x2; } x1[1]; } *)a0;
- (void)dealloc;
