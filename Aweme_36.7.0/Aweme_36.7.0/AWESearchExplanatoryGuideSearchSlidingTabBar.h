...
@interface AWESearchExplanatoryGuideSearchSlidingTabBar : DUXBaseCollectionView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>

@property (weak, nonatomic) id<AWESearchExplanatoryGuideSearchSlidingTabBarProtocol> guideSearchSlidingTabBarDelegate;
