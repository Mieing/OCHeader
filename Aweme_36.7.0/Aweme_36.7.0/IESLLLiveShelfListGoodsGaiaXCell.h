@class GXTemplateItem, IESLLLiveShelfListGoodsGaiaXModel, IESLLLiveShelfPagingDataController, UIView, NSString;
@protocol GXRootViewProtocal;

@interface IESLLLiveShelfListGoodsGaiaXCell : UICollectionViewCell <GXEventProtocal, GXTrackProtocal>

@property (retain, nonatomic) IESLLLiveShelfListGoodsGaiaXModel *model;
