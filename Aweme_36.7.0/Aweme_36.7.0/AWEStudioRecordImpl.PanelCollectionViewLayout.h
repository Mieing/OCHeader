@interface AWEStudioRecordImpl.PanelCollectionViewLayout : UICollectionViewFlowLayout {
    void /* unknown type, empty encoding */ selectedIndexPath;
    void /* unknown type, empty encoding */ enableSelectedScale;
    void /* unknown type, empty encoding */ contentSize;
    void /* unknown type, empty encoding */ selectedScale;
}
