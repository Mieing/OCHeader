@class HTSLiveItemDotInfo, NSString, ConfigItemPre_Bubble, HTSLiveImage, GPBInt32Array, NSMutableArray, HTSLiveItemBubbleInfo;

@interface ConfigItemPre : IESLivePBBaseMessage
...
@property (retain, nonatomic) ConfigItemPre_Bubble *bubble;
