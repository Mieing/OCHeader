@class IESLiveGuideModel, IESLiveSkipCertificateApi, IESLiveGuideStartLiveForbidden;
...
@property (retain, nonatomic) IESLiveGuideStartLiveForbidden *startLiveForbidden;
...
- (void)handleRoomForbiddenWithToast:(id)a0;
