@class NSArray, IESLiveLinkmicLayoutConfigCanvasDefaultJSONModel, IESLiveLinkmicLayoutConfigContentDefaultJSONModel, IESLiveLinkmicLayoutConfigUIContainerDefaultJSONModel, HTSInteractStreamContent, NSString;
@protocol IESLiveLinkmicLayoutConfigCanvas, IESLiveLinkmicLayoutConfigUIContainer, IESLiveLinkmicLayoutConfigContent;

@interface IESLiveRevenueInteractLayoutConfigModel : MTLModel <MTLJSONSerializing, IESLiveLinkmicLayoutConfig>
...
+ (id)streamRegionsJSONTransformer;
