@interface FlowKit.FlowMarkdownMixedMediaContainerView : FlowKit.FlowMarkdownBaseContainerView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
    void /* unknown type, empty encoding */ $__lazy_storage_$_collectionView;
    void /* unknown type, empty encoding */ $__lazy_storage_$_titleLabel;
    void /* unknown type, empty encoding */ mediaModel;
    void /* unknown type, empty encoding */ dataSetted;
    void /* unknown type, empty encoding */ isRecommend;
