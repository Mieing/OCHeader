...
@interface AWEProfileHeaderLongVideoSignatureSectionViewModel : AWEBaseListSectionViewModel <AWEProfileHeaderSectionViewModelProtocol>
...
- (double)sectionHeightWithContext:(id)a0;
- (void).cxx_destruct;
