@class IESLiveMultiLiveCoreInfo, HTSLiveText, GPBEnumArray, IESLiveLinkmicJoinChannelData, IESLiveMsgBoardItemInfo, IESLiveMultiChannelInfo, NSMutableArray, NSString, BreakthroughInfo, IESLiveLinkerBaseInfo, IESLiveChorusCDNInfo, HTSLiveUser, HTSLiveJoinTeamfightInfo, IESLiveLinkGameInfo, HTSLiveImage, IESLiveMCUContent, BattleBarConfig, IESLiveAudienceActionSource, IESLiveMultiRtcInfo, IESLiveBanUser, IESLiveClientUIInfo, HTSLiveAnchorLinkmicInfo, HTSLiveCommon, IESLiveRivalExtraInfo, GPBInt64ObjectDictionary, IESLiveLinkmicMediaInfo, IESLiveGameInviteInfo, HTSLiveLinkMicMethod_InvitorInfo;
...
@property (retain, nonatomic) HTSLiveImage *inviteImage;
@property (nonatomic) BOOL hasInviteImage;
@property (copy, nonatomic) NSString *invitePrompt;
@property (retain, nonatomic) IESLiveLinkmicJoinChannelData *joinChannelData;
@property (nonatomic) BOOL hasJoinChannelData;
@property (nonatomic) BOOL switchToSilence;
@property (nonatomic) BOOL isAutoJoin;
@property (nonatomic) long long gameBarrageLinkerId;
@property (copy, nonatomic) NSString *gameBarrageLinkerFinishReason;
...
@property (nonatomic) int pushRtcType;
