@class IESLLPOIDetailNGPageContext, NSArray, NSString, IESLLPOICOIItemModel, IESLLPOIDetailNGCOIListComponentView, NSURL;

@interface IESLLPOIDetailNGCOIListComponentViewModel : LLDitoComponentViewModel <IESLLPOIDetailNGListCellProtocol>

@property (weak, nonatomic) IESLLPOIDetailNGPageContext *context;
@property (retain, nonatomic) IESLLPOICOIItemModel *itemModel;
@property (nonatomic) BOOL hasRecordCOIPosition;
@property (weak, nonatomic) IESLLPOIDetailNGCOIListComponentView *cell;
