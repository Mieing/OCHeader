...
@interface AWEIMEntertainmentCommentShareMessageViewModel : NSObject <AWEIMCommentShareTableViewCellViewModelProtocol>
...
- (void)p_updateEntCommentShareModelWithMessage:(id)a0;
- (id)unAvailiableText;
- (void).cxx_destruct;
