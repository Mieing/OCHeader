@class UIScrollView, NSString, NSDictionary, AWEGrouponLifeFeedsViewController, AWEGrouponLifeFeedsLynxNestedItem, AWEGrouponLifeMallFeedsComponentView, UIView;

@interface AWEGrouponLifeMallFeedsComponentViewModel : DitoComponentViewModel <AWEGrouponLifeFeedsViewControllerDelegate, AWEGrouponLifeFeedsLynxNestedItemDelegate>
...
@property (weak, nonatomic) AWEGrouponLifeMallFeedsComponentView *cell;
