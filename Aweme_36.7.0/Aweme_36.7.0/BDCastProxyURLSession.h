...
- (void)_flex_swizzle_2a58cf9f_URLSession:(id)a0 task:(id)a1 didCompleteWithError:(id)a2;
- (void)_flex_swizzle_756d74b_URLSession:(id)a0 dataTask:(id)a1 didReceiveResponse:(id)a2 completionHandler:(id /* block */)a3;
- (void)_flex_swizzle_44f5fae9_URLSession:(id)a0 dataTask:(id)a1 didReceiveData:(id)a2;
