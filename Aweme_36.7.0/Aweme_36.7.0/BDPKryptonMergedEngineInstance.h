...
@interface BDPKryptonMergedEngineInstance : NSObject <BDPScreenSnapshotProtocol, BDPPageDiagnoseProtocol, BDPBootLifeCycleMessage, BDPEngineProtocol, BDPMonitorableObjectProtocol, BDPFrameInfoProtocol>
