@class HTSEventContext, NSString, NSError, IESLiveGuideModel, IESLiveAuthorizationApi, IESLiveGuideCameraMicroChecker, CreateInfoResponse_CreateInfo, IESLiveOpenAnchorRoomAdapter, IESLiveGuideStartLiveForbidden;
