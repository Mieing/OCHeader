@interface FlowKit.MessagingSnapshotHeaderView : UIView {
    void /* unknown type, empty encoding */ $__lazy_storage_$_avatarView;
    void /* unknown type, empty encoding */ $__lazy_storage_$_titleLable;
    void /* unknown type, empty encoding */ $__lazy_storage_$_subTitleLable;
    ...
    void /* unknown type, empty encoding */ containerViewHeight;
