...
@interface IESLivePKAnchorRootViewController : IESLiveRevenueInteractPopupViewController <IESLivePKCustomPanelViewDelegate, UIScrollViewDelegate>
...
- (void)setupData:(id)a0 loadType:(long long)a1;
- (id)pkExpandNavBar:(id)a0;
...
- (void)refreshPanelWithCacheData:(id)a0;
