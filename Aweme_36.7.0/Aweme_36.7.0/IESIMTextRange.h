@class IESIMTextPosition;

@interface IESIMTextRange : UITextRange <NSCopying>

@property (retain, nonatomic) IESIMTextPosition *start;
@property (retain, nonatomic) IESIMTextPosition *end;
