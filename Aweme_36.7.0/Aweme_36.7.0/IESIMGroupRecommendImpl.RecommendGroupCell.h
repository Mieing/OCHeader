@interface IESIMGroupRecommendImpl.RecommendGroupCell : UICollectionViewCell {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_textStackView;
    void /* unknown type, empty encoding */ $__lazy_storage_$_joinButton;
}

- (void)handleThemeChange:(id)a0;
- (void).cxx_destruct;
