@class CAGradientLayer, NSString, UIImageView, AWEPOIDetailAwemePlayerViewController, UILabel, IESLLPOICityLiveComponentViewModel, UIView;
@protocol AWELiveStreamPlayer;

@interface IESLLPOICityLiveComponentView : LLDitoComponentView <IESLivePlayerControllerDelegate, AWEPOIDetailAwemePlayerCellProtocol>

@property (weak, nonatomic) IESLLPOICityLiveComponentViewModel *viewModel;
