@class NSString, UIImageView, IESLLGDImagePointModel, UILabel, UIView;

@interface IESLLGDSuperDiscountView : UIView <IESLLGDImagePointProtocol>
...
@property (retain, nonatomic) IESLLGDImagePointModel *model;
