@class NSArray, UICollectionView, NSDictionary, UICollectionViewFlowLayout, NSMutableArray, NSString;
@protocol AWESearchWordProtocol, AWESearchGuideSearchViewProtocol;

@interface AWESearchGuideSearchView : UIView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>

@property (retain, nonatomic) UICollectionView *guideSearchCollectionView;
...
@property (weak, nonatomic) id<AWESearchGuideSearchViewProtocol> guideSearchViewDelegate;
