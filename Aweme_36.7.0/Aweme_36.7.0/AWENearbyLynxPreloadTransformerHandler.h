@class NSMutableDictionary, NSString, NSMutableArray, AWENearbyEmptyCardPreloadConfig;

@interface AWENearbyLynxPreloadTransformerHandler : NSObject <AWESharkLynxContainerViewDelegate, AWENearbyLynxPreloadHandlerProtocol>
