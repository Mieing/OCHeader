@class NSString, UIViewController, AWEGrouponHalfScreenContainerArrowView;
@protocol AWEGrouponHalfScreenContainerProtocol;

@interface AWEGrouponHalfScreenTopAngleViewInjector : NSObject <AWEGrouponHalfScreenInjectedViewProtocol>

@property (weak, nonatomic) UIViewController<AWEGrouponHalfScreenContainerProtocol> *targetVC;
@property (weak, nonatomic) AWEGrouponHalfScreenContainerArrowView *injectedView;
