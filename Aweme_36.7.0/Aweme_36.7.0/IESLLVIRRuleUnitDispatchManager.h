@class NSLock, IESLLVIRUnitDefaultManager, NSMutableArray, NSObject;
@protocol OS_dispatch_queue;

@interface IESLLVIRRuleUnitDispatchManager : NSObject

@property (retain, nonatomic) NSMutableArray *unitManagerList;
@property (retain, nonatomic) IESLLVIRUnitDefaultManager *defaultManager;
