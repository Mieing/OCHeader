@class AWEVideoImageGenerator, UIView, NSArray, UIImage, AWEVideoPublishViewModel, UIImageView, NSDictionary, UIButton, AWEStudioComposerPublishBasicFeature, UIViewController, NSString, AWEStickerContainerFakeProfileView;
