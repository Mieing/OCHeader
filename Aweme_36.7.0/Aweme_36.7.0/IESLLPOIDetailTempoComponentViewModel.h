@class NSString, NSDictionary, LLPOISkeletonView, NSNumber, IESLLPOIDetailTempoComponentView;

@interface IESLLPOIDetailTempoComponentViewModel : LLDitoComponentViewModel
...
@property (weak, nonatomic) IESLLPOIDetailTempoComponentView *cell;
