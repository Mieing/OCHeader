@class AWEAwemeModel, UIView, AWENearbyC2FeedAnchorView, NSString, UIImageView, AWEGradientView, BDImageView, AWENearbyC2FeedDualAnchorContainerView, AWENearbyFeedLiveExperimentView, AWENearbyC2FeedLiveLargeCardProductView, UILabel;
...
@property (retain, nonatomic) AWENearbyFeedLiveExperimentView *experimentView;
...
+ (double)cardPadding;
+ (double)coverImageResizeRatio:(id)a0;
