...
- (void)convertNewFile:(id)a0 fromTime:(double)a1;
- (void)adjustTimeOffset:(double)a0;
- (void)resetConverter;
- (void)switchMusicType:(unsigned long long)a0;
- (void)convertNewFile:(id)a0 fromTime:(double)a1 musicType:(unsigned long long)a2;
- (int)renderIOData:(short *)a0 dataSize:(unsigned long long)a1 outputPacketSize:(unsigned int *)a2;
