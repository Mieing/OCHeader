@class NSString, NSDictionary, IESLLPOIDetailResponse, IESLLPOIDetailConstData, UIViewController;

@interface IESLLPOIEnterDetailTracker : NSObject
...
@property (retain, nonatomic) IESLLPOIDetailResponse *response;
@property (nonatomic) BOOL didTrack;
@property (retain, nonatomic) NSDictionary *lifeInitialInfo;
@property (weak, nonatomic) IESLLPOIDetailConstData *constData;
