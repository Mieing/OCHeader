@class NSString, NSArray, NSMutableSet, AWEIMShareContactListViewRecentChatSegmentedLoadingManager;
@protocol IESIMContactPickerContentSectionBuilder, IESIMContactPickerContentDataProviderDelegate;

@interface AWEIMMyGroupDataProvider : NSObject <IESIMContactPickerContentDataProvider, IESIMContactDataProviderLoadMoreAble>
...
@property (nonatomic) BOOL createdGroupOnly;
