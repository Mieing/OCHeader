@class UIView, AWEAwemeModel, UIImage, NSString, AWEScreenCastInnerFeedProgressIndicator, AWEFeedProgressSlider, NSMutableArray, AWELoadingAndVolumeView, UILabel;
@protocol AWEScreenCastInnerFeedProgressViewDelegate;

@interface AWEScreenCastInnerFeedProgressView : UIView <UIGestureRecognizerDelegate, AWEScreenCastInnerFeedProgressViewProtocol>

@property (retain, nonatomic) AWEFeedProgressSlider *progressSlider;
...
@property (retain, nonatomic) AWEScreenCastInnerFeedProgressIndicator *indicator;
...
@property (weak, nonatomic) id<AWEScreenCastInnerFeedProgressViewDelegate> delegate;
