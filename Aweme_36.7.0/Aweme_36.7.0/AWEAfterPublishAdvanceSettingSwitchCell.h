@class AFDRoundedView, NSIndexPath, UIImageView, NSString, UILabel, UIView, UIButton;
@protocol AWEAfterPublishAdvanceSettingCellDelegate, AWESettingSwitchProtocol, AWEAfterPublishAdvanceSettingItemProtocol;

@interface AWEAfterPublishAdvanceSettingSwitchCell : UITableViewCell <AWEAfterPublishAdvanceSettingCellProtocol>

@property (retain, nonatomic) id<AWEAfterPublishAdvanceSettingItemProtocol> item;
