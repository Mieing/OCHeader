@class LLDitoPageContext, NSMutableDictionary, NSString, LLDitoNestedScrollItem, NSMutableArray, NSLock;
@protocol LLDitoExtensionContainerProtocol;

@interface LLDitoNestedScrollExtensionV2 : NSObject <LLDitoExtensionProtocol, LLDitoScrollViewDelegateProtocol_Private, LLDitoHalfContainerDelegateProtocol>

@property (retain, nonatomic) LLDitoNestedScrollItem *sideBarItem;
...
- (void)isLynxListAdjustingContentOffset;
