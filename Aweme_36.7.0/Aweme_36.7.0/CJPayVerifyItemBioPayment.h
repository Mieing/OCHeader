...
- (void)p_switchToPasswordPassiveWithResponse:(id)a0 passiveType:(id)a1 reason:(id)a2;
...
- (id)buildEventSwitchToPasswordWithReason:(id)a0 isActive:(BOOL)a1;
...
- (void)verifyTypeSwitchToPassCode:(id)a0 event:(id)a1;
- (void)p_alertTipsWithResponse:(id)a0;
- (id)p_payName;
- (void).cxx_destruct;
