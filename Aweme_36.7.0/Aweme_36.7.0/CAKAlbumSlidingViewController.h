@class CAKAlbumSlidingTabBarView, NSString, CAKAlbumSlidingScrollView, NSMutableArray;
@protocol CAKAlbumSlidingViewControllerDelegate, CAKCommonConfigProtocol;
...
@property (retain, nonatomic) CAKAlbumSlidingTabBarView *tabbarView;
@property (nonatomic) long long selectedIndex;
@property (nonatomic) BOOL slideEnabled;
@property (nonatomic) BOOL needAnimationWithTapTab;
@property (weak, nonatomic) id<CAKAlbumSlidingViewControllerDelegate> delegate;
@property (nonatomic) BOOL shouldAdjustScrollInsets;
@property (retain, nonatomic) CAKAlbumSlidingScrollView *contentScrollView;
