@class NSString, NSDictionary, IESLLPOITouchThroughView, IESLLPOILynxContainerView;

@interface IESLLPOIPreviewContainerManager : NSObject <LLCubeViewDelegate>

@property (retain, nonatomic) IESLLPOILynxContainerView *lynxView;
@property (retain, nonatomic) IESLLPOITouchThroughView *containerView;
