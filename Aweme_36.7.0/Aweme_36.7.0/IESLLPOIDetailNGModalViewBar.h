@class IESLLPOIDetailNGModalViewBarViewModel, IESLLPOIRepeatBackgroundView, UIView, LLDitoPageContext;

@interface IESLLPOIDetailNGModalViewBar : LLDitoComponentView {
...
@property (weak, nonatomic) IESLLPOIDetailNGModalViewBarViewModel *barVM;
@property (retain, nonatomic) IESLLPOIRepeatBackgroundView *backgroundView;
