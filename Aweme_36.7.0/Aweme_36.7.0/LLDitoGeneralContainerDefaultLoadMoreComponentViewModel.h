@class NSString, LLDitoGeneralContainerDefaultLoadMoreComponentView;

@interface LLDitoGeneralContainerDefaultLoadMoreComponentViewModel : LLDitoComponentViewModel
...
@property (weak, nonatomic) LLDitoGeneralContainerDefaultLoadMoreComponentView *cell;
