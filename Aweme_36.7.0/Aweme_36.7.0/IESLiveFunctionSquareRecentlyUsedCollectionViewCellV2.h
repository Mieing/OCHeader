@class RACCompoundDisposable, IESLiveFunctionSquareRowNode, UIImageView, UIView, UILabel, HTSPaddingLabel;

@interface IESLiveFunctionSquareRecentlyUsedCollectionViewCellV2 : IESLiveFunctionSquareCollectionCell

@property (retain, nonatomic) UIImageView *imageView;
@property (retain, nonatomic) HTSPaddingLabel *iconTagLabel;
@property (retain, nonatomic) HTSPaddingLabel *runningLabel;
@property (retain, nonatomic) HTSPaddingLabel *bindLabel;
