...
- (void)multiLinkerUserService:(id)a0 user:(id)a1 linkerRoleChanged:(int)a2;
- (id)chorusInfo;
...
- (void)setupButtonType:(id)a0;
- (BOOL)isNormalTeamPKing;
- (void)clickTeamBattleButton;
- (void)inviteOnceMoreBattle:(int)a0 modeType:(int)a1 battleMode:(unsigned long long)a2 inviteTrackParams:(id)a3;
...
- (void)invitePersonalBattleWithModType:(int)a0 isOnceMore:(BOOL)a1;
- (BOOL)isNewCustomBattleItemPKing:(id)a0;
- (BOOL)isQuadraInteract;
- (void)trackConncetionInvite:(id)a0;
- (BOOL)isNormalPKing;
