@class ACCCountDownModel, RACSubject, RACSignal, NSString, AWERecordCountdownPlusComponent;

@interface ACCRecordCountDownPlusViewModel : ACCRecorderViewModel <ACCCountDownProvideProtocol>

@property (retain, nonatomic) RACSubject *dismissCountDownPanelSubject;
@property (weak, nonatomic) AWERecordCountdownPlusComponent *delegate;
