@class HTSLiveGiftStruct, HTSLiveText, HTSLiveSendTogether, NextSendParams, ComboHint, GPBInt64Array, HTSLiveGameGiftData, NSMutableArray, NSString, HTSLiveAnchorGiftData, ProfitCheckConfig, HTSLiveDSAlertInfo, HTSLiveExtraEffect, HTSLiveDSLimitCalmPeriod, HTSLiveFreeCellData, HTSLivePetEffectInfo;
...
@property (copy, nonatomic) NSString *multiSendToUserId;
@property (retain, nonatomic) HTSLiveAnchorGiftData *anchorGift;
@property (nonatomic) BOOL hasAnchorGift;
@property (retain, nonatomic) NSMutableArray *toUserIdsArray;
...
@property (retain, nonatomic) HTSLivePetEffectInfo *petEffectInfo;
@property (nonatomic) BOOL hasPetEffectInfo;
