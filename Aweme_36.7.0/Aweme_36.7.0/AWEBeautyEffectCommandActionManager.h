@class NSString, AWEBeautyEffectCommandActionContext;

@interface AWEBeautyEffectCommandActionManager : NSObject <AWEBeautyEffectCommandActionService>

@property (retain, nonatomic) AWEBeautyEffectCommandActionContext *context;
