@class AWEIMPhotoBrowserNavView, AWEIMPhotoPreviewEditorCollectionView, AWEIMPhotoPickerToolbarViewV2, AWEIMExchangeAndSendImageActionBarView, UIImage, NSString, NSDictionary, UICollectionView, PHFetchResult, AWEIMPhotoPickerModel, AWEIMMediaEditorProxy;
