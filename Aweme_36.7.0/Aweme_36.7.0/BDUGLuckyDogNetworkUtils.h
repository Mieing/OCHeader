...
+ (id)commonGetParams;
+ (id)commonPostParams;
+ (id)addCommonPostParamsWithParams:(id)a0;
+ (id)addCommonGetParamsWithParams:(id)a0;
+ (void)registerRequestSerializerBlock;
+ (id)commonRequestHeaderFields;
+ (BOOL)shouldAllowJSONArrayBodyWithURL:(id)a0;
+ (id)__settingsVersionDicWithPrefix;
+ (id)__settingsVersionDicWithoutPrefix;
+ (void)initializeNetworkModule;
+ (id)addCommonRequestHeaderFieldsWithFields:(id)a0;
+ (id)sharedInstance;
+ (id)serviceProtocol;
