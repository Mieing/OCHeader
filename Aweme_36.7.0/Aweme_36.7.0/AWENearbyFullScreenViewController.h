@class UIViewController, AWENearbySkyLightCatchView, UILabel, AWENearbySkylightGestureGuideView, AWENearbySkyLightViewController, NSString, AWENearbyPageContext, AWEPageContext, UITableViewCell, AWENearbySkyLightCapsuleView, AWENearbySkyLightAnchorContainerView, UIView, UIPanGestureRecognizer, AWENearbyWidgetViewController, AWENearbyTransformerAnimationView, AWENearbyActionEventHandler, AWENearbySwitchContext, AWEGradientView, AWEBinding, UIImageView, AWENearbyFullScreenViewModel, AWENearbySkylightPanGestureGuideView;
