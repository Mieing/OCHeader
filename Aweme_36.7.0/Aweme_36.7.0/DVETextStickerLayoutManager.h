@class DVETextStickerStrokeConfig;

@interface DVETextStickerLayoutManager : NSLayoutManager

@property (copy, nonatomic) id /* block */ beforeShowGlyhpBlock;
@property (copy, nonatomic) id /* block */ afterShowGlyphBlock;
@property (retain, nonatomic) DVETextStickerStrokeConfig *strokeConfig;
