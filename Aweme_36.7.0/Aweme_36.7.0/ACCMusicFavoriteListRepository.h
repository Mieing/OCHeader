...
@property (nonatomic) long long collectSourceBitStatus;
...
- (void)fetchFavoriteListV2WithParams:(id)a0 completion:(id /* block */)a1;
- (void)fetchFavoriteListV1WithParams:(id)a0 completion:(id /* block */)a1;
- (void).cxx_destruct;
- (id)init;
- (void)reset;
