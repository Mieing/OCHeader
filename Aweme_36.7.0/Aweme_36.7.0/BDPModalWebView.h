...
@interface BDPModalWebView : BDPBridgeWebView <BDPWebViewImplInterface, WKNavigationDelegate, BDPNavigationControllerGestureRecognizeBreaker>
...
- (BOOL)isASubviewOfBDPModalWebView:(id)a0;
