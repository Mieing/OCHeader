@class AWEIMMessage, AWEIMEntertainmentCommentShareModel, NSString;
@protocol IESIMShareContextProtocol;

@interface AWEIMShareAndForwardEntertainmentCommentShareImpl : NSObject <AWEIMShareAndForwardToChatProtocol>

@property (retain, nonatomic) AWEIMEntertainmentCommentShareModel *commentShareModel;
