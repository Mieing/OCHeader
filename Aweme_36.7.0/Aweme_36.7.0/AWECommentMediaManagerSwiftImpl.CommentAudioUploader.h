@interface AWECommentMediaManagerSwiftImpl.CommentAudioUploader : NSObject <AWECommentMediaUploaderProtocol> {
    ...
    void /* unknown type, empty encoding */ audioUploadClient;
}
