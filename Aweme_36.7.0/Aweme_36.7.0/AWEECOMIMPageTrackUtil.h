@class NSMutableDictionary, NSMutableSet, AWEECOMIMPageTrackConfig;

@interface AWEECOMIMPageTrackUtil : NSObject

@property (retain, nonatomic) AWEECOMIMPageTrackConfig *config;
...
- (double)p_currentMsTime;
- (BOOL)checkIfTimeOutBlockWithClickUUID:(id)a0;
