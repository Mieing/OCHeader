@class AWEBeautyVCContext, NSString;

@interface AWEBeautyNavigationController : UINavigationController <UINavigationControllerDelegate>

@property (weak, nonatomic) AWEBeautyVCContext *context;
