...
@property (nonatomic) BOOL checkIsUseMVTrack;
@property (copy, nonatomic) NSString *useMVTrackScene;
...
- (void)p_newGenerateNleWithRepository:(id)a0 userResourses:(id)a1 transitionEffectModel:(id)a2 transitionDuration:(double)a3 beatsArray:(id)a4 completion:(id /* block */)a5;
- (id)p_transitionWithEffect:(id)a0 duration:(double)a1;
...
- (void)trackUseMVTrack;
- (id)initWithDraftFolder:(id)a0;
- (void)newGenerateNleWithRepository:(id)a0 userResourses:(id)a1 beatsArray:(id)a2 useTransition:(BOOL)a3 transitionDuration:(double)a4 completion:(id /* block */)a5;
