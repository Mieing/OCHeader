@class NSString, AWEStorageFilePermanent;

@interface AWEStorageServiceStorageFileAdapt : AWEStorageServiceAdapt <AWEStorageServiceKVUniversal> {
    AWEStorageFilePermanent *storageFile;
}
...
- (id)syncReadObjectForKey:(id)a0 withClassType:(Class)a1;
- (void).cxx_destruct;
