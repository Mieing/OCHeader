...
@interface IESLiveRoomProfileInfoViewModel : NSObject <HTSLiveMessageSubscriber, HTSLiveDiggAction, IESLiveDirectorRoomMessageAction>
...
@property (nonatomic) long long originEarnCount;
@property (nonatomic) long long originLikeCount;
@property (nonatomic) BOOL isCollaborating;
@property (nonatomic) BOOL enableCollaborate;
...
- (id)currentTopEarnStringWithCount:(id)a0;
- (id)currentLiveEarningsStringWithCount:(id)a0;
- (id)currentTopDiggStringWithCount:(id)a0;
- (id)currentLiveDiggStringWithCount:(id)a0;
- (id)authenticationTabLabel;
- (void)trackVipAnchorTab;
- (void)updateEarnCountWithGiftMessage:(id)a0;
- (void)updateDiggCountWithLikeMessage:(id)a0;
- (void)updateEarnCountWithUpdateMessage:(id)a0;
