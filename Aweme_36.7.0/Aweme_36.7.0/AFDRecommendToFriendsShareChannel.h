...
@interface AFDRecommendToFriendsShareChannel : AWEShareBaseChannel <AWEShareFunction, AWEShareItemDelegate>
...
- (void)recommendAwemeWithCompletion:(id /* block */)a0;
- (void)cancelRecommendAwemeWithCompletion:(id /* block */)a0;
- (id)title;
- (id)shareTitle;
