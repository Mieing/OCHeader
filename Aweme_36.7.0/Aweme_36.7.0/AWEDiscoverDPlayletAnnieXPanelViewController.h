@class NSObject, NSMutableDictionary, NSString, BDXBridgeEventSubscriber, UIView, UIPanGestureRecognizer, UITapGestureRecognizer;
@protocol AnnieXContainerBaseProtocol, AnnieXCardModelProtocol, AWEDiscoverDPlayletAnnieXPanelViewControllerDelegate, OS_dispatch_queue;
...
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *queueForPerformanceOptimization;
...
- (void)dataSourceHasUpdatedWithFlag:(unsigned long long)a0 enableAsync:(BOOL)a1 completion:(id /* block */)a2;
...
- (id)getCurrentEntertainmentSuggestInfo;
