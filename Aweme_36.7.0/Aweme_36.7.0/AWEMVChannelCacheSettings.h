...
@property (class, readonly, nonatomic) BOOL allowUseChunkTidyData;
@property (class, readonly, nonatomic) BOOL enableAwemeJsonDataFormat;
@property (class, readonly, nonatomic) BOOL enableAwemeJsonDataLazyParse;
@property (class, readonly, nonatomic) BOOL enableAwemeJsonDataConcurrentParse;
