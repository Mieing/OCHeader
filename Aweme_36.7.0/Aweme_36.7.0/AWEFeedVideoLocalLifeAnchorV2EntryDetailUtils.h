...
@interface AWEFeedVideoLocalLifeAnchorV2EntryDetailUtils : NSObject <AWEFeedVideoLocalLifeAnchorV2EntryDetailUtilsProtocol>
...
+ (void)feedVideoAnchorClickWithContext:(id)a0;
...
+ (void)appendDictionaryFrom:(id)a0 to:(id)a1;
...
+ (void)handleAnchorDetailPageEnterEventWithContext:(id)a0 detailPageVC:(id)a1;
+ (void)handleEnterPOIListWithAwemeModel:(id)a0 referString:(id)a1 enterMethod:(id)a2 logExtraDict:(id)a3 shouldUseModalView:(BOOL)a4 playInteractionDelegate:(id)a5 btmResponser:(id)a6 btm:(id)a7 btmStandData:(id)a8;
+ (id)p_feedPOIAnchorPrefetchLocalLifeSchemaWithContext:(id)a0;
+ (id)p_feedPOIAnchorClickParamsWithContext:(id)a0;
+ (void)handleEnterPOIListWithAwemeModel:(id)a0 referString:(id)a1 enterMethod:(id)a2 logExtraDict:(id)a3 shouldUseModalView:(BOOL)a4 playInteractionDelegate:(id)a5 btmResponser:(id)a6 btm:(id)a7;
