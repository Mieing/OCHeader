...
@interface AWEDeliveryDynamicCardCommonFunctionImp : NSObject <BDPCDDynamicCardCommonFunctionInterface>
...
- (id)bdpcd_douyinNumberABCFontOfSize:(double)a0 weight:(double)a1;
...
- (void)imagePreviewWithImageURlsList:(id)a0 targetIndex:(unsigned long long)a1 pigeonBizType:(id)a2;
