@class UIViewController, NSString, NSMutableDictionary, AWEGrouponResourceResponse, AWEGrouponLifeTabNoticeResopnse, NSMutableArray, AWEGrouponPageContext;
@protocol AWEGrouponContainerChildProtocol;

@interface AWEGrouponForwardTabDYHandler : NSObject <AWEGrouponFeedEventMessage, AWEGrouponForwardTabHandlerProtocol>
...
@property (retain, nonatomic) AWEGrouponResourceResponse *lastResource;
@property (retain, nonatomic) AWEGrouponLifeTabNoticeResopnse *lastNoticeRsp;
...
- (id)contextWithTabNoticeRsp:(id)a0;
...
- (id)lynxInsertFeedCardModelWithData:(id)a0;
