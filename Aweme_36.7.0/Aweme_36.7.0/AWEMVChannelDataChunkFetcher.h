@class AWEMVChannelDataChunkHelper, AWEAwemeResponseModel, NSDictionary, NSObject, AWEMVChannelDataControllerConfig, AWEMVDataRequestContext, NSString, CSPChunkRequestManager, NSArray, AWEMVCSPChunkRequestDelegateConverter, NSNumber, NSError, AWEMVChannelDataShardParser;
...
@property (copy, nonatomic) NSDictionary *chunk0Json;
@property (copy, nonatomic) NSDictionary *chunk1Json;
@property (retain, nonatomic) AWEAwemeResponseModel *chunk1Response;
@property (retain, nonatomic) AWEAwemeResponseModel *loadmoreResponse;
...
@property (nonatomic) long long chunk0ParseTotalCount;
@property (copy, nonatomic) NSArray *chunk1LazyParseAwemeIDs;
...
- (id)reduceChunk0DataIfNeeded:(id)a0;
- (void)resetTTNetRequestControl;
- (id /* block */)getChunk1CustomParseModelBlock;
