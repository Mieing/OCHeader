@class AWETeenSearchResultVideoDataController, UICollectionView, NSString, AWEUILoadingView, UIView, NSDictionary;
@protocol AWETeenSearchResultDelegate;

@interface AWETeenSearchResultVideoViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, AWEZoomTransitionOuterContextProvider, AWETeenSearchResultProtocol>

@property (retain, nonatomic) AWETeenSearchResultVideoDataController *dataController;
@property (retain, nonatomic) AWETeenSearchResultVideoDataController *dataControllerBackup;
