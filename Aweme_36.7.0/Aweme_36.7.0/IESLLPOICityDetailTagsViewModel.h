@class LLDitoSwitchNodeActionOperation, NSArray, NSString, IESLLPOICityDetailTagsView, IESLLPOICityDetailTagItem, UIView;

@interface IESLLPOICityDetailTagsViewModel : LLDitoComponentViewModel <LLDitoComponentStickyProtocol>
...
@property (weak, nonatomic) IESLLPOICityDetailTagItem *selectedItem;
@property (retain, nonatomic) UIView *p_stickView;
@property (weak, nonatomic) IESLLPOICityDetailTagsView *tagsView;
