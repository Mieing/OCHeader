@class NSString, NSDictionary, IESECECTagGroupAttributes, IESECSliceXBaseElementView;

@interface SLIECTagGroupInlineCustomContent : NSObject <IESECSliceXInlineCustomContent>

@property (copy, nonatomic) NSDictionary *tagGroupData;
