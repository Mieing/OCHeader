@class NSString, IESLLPOIGoodsDetailMarketingShareInfoModel, IESLLPOIGoodsDetailShareCouponTagModel, NSDictionary, IESLLPOIGoodsDetailShareCouponBubbleModel, IESLLPOIGoodsDetailCollectObject, NSNumber, IESLLPOIGoodsDetailNavigationBarUIModel;

@interface IESLLPOIGoodsDetailNavigationBarNewViewModel : LLDitoComponentViewModel

@property (retain, nonatomic) IESLLPOIGoodsDetailCollectObject *collectObj;
...
@property (retain, nonatomic) IESLLPOIGoodsDetailMarketingShareInfoModel *marketingShareInfo;
@property (retain, nonatomic) IESLLPOIGoodsDetailShareCouponBubbleModel *shareBubbleInfo;
@property (retain, nonatomic) IESLLPOIGoodsDetailShareCouponTagModel *shareTagInfo;
