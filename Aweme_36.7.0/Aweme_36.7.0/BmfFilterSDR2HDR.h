@class NSString, NSDictionary, PixelTextureFormat, NSMutableDictionary, NSObject;
...
@interface BmfFilterSDR2HDR : FilterBase {
    ...
    BOOL isSupportMultiModels;
    int lastModexIndex;
    NSMutableDictionary *modelCachesDic;
...
@property (copy, nonatomic) NSDictionary *modelConfigsDic;
