@class UIVisualEffectView, ACCFakeProgressViewConfig, UIView;

@interface ACCEditSingleVideoFakeProgressView : UIView

@property (nonatomic) BOOL isAdaptForSecondaryPage;
@property (retain, nonatomic) ACCFakeProgressViewConfig *normalConfig;
@property (retain, nonatomic) ACCFakeProgressViewConfig *highlightConfig;
