@class NSString, LLDitoPageContext, NSMutableArray;
@protocol LLDitoLynxContainerDelegate;

@interface LLDitoGeneralLynxContainerBuilder : NSObject <LLDitoLynxContainerBuilder, LLCubeViewDelegate>

@property (weak, nonatomic) LLDitoPageContext *inner_pageContext;
@property (retain, nonatomic) NSMutableArray *businessExtenderList;
@property (copy, nonatomic) NSString *sharedGroupName;
@property (weak, nonatomic) id<LLDitoLynxContainerDelegate> containerDelegate;
