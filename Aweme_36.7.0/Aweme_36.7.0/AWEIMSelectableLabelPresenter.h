@class AWEIMTextSelectable, NSString;
@protocol AWEIMSelectableLabelAction;

@interface AWEIMSelectableLabelPresenter : AWEIMYYLabelPresenter <AWEIMTextSelectableDelegate, AWEIMSelectableLabelPresenterProtocol>

@property (retain, nonatomic) AWEIMTextSelectable *selectable;
