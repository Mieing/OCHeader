@class NSMutableDictionary, NSString, LLDitoPageContext, NSMutableArray;
@protocol LLDitoExtensionContainerProtocol;

@interface LLDitoExtensionManager : NSObject <LLDitoViewControllerLifeCycleProtocol_Private, LLDitoComponentDelegateProtocol_Private, LLDitoScrollViewDelegateProtocol_Private, LLDitoExtensionManagerProtocol, LLDitoPrivateExtensionProtocol>
