@class NSString, TIMXPBNResponseBody, NSMutableDictionary;

@interface TIMXPBNResponse : GPBMessage
...
@property (retain, nonatomic) TIMXPBNResponseBody *body;
...
@property (copy, nonatomic) NSString *pdesKey;
@property (nonatomic) BOOL hasPdesKey;
...
- (int)inboxType;
- (id)body;
- (long long)serverExecutionEndTime;
- (long long)requestArrivedTime;
- (id)logId;
- (int)statusCode;
- (int)cmd;
- (long long)reqUserId;
- (id)timx_errorWithBusinessResponseBodyName:(id)a0;
