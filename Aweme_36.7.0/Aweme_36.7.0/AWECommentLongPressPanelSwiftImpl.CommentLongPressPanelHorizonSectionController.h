@interface AWECommentLongPressPanelSwiftImpl.CommentLongPressPanelHorizonSectionController : AWEBaseListSectionController {
    void /* unknown type, empty encoding */ didReload;
}
