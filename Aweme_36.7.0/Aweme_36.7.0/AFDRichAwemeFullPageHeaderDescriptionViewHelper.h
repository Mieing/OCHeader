...
+ (id)configAttributedContentTextWithModel:(id)a0 offset:(long long)a1 referString:(id)a2 isTitle:(BOOL)a3 entitySearchWords:(id)a4 needPureString:(BOOL)a5;
+ (id)contentTextStringWithModel:(id)a0;
+ (id)getBodyAttributedTextWithModel:(id)a0 referString:(id)a1 entitySearchWords:(id)a2 needPureString:(BOOL)a3;
