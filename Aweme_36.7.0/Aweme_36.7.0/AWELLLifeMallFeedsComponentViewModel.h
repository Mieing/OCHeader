@class UIView, NSString, NSDictionary, UIScrollView, AWELifeFeedsViewController, AWELifeFeedsLynxNestedItem, AWELLLifeMallFeedsComponentView;

@interface AWELLLifeMallFeedsComponentViewModel : LLDitoComponentViewModel <AWEGrouponLifeFeedsViewControllerDelegate, AWELifeFeedsLynxNestedItemDelegate>
...
@property (weak, nonatomic) AWELLLifeMallFeedsComponentView *cell;
