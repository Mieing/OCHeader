@interface AWEKnowledgeRichContentImpl.FullPageFeedCreationInfoItemController : AWEKnowledgeSwiftBasic.FullPageBaseItemController <AWEFullPageFeedPageModeSensitiveComponentProtocol>
