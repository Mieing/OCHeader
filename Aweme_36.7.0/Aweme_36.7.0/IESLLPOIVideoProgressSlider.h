@class IESLLProgressSliderConfig;

@interface IESLLPOIVideoProgressSlider : UISlider
...
@property (retain, nonatomic) IESLLProgressSliderConfig *normalConfig;
@property (retain, nonatomic) IESLLProgressSliderConfig *bigModeConfig;
