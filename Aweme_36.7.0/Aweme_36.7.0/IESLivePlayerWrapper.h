@class IESLivePlayerMiddlewarePropertyContainer, NSString, IESLivePlayerAttachment, UIView, NSURL, NSError, NSDictionary, NSArray, IESLivePlayerPlayDurationTracker, IESLiveNewPlayerTVLTracker, IESLivePlayerSEIMetaInfo;
...
@property (readonly, nonatomic) double pullStreamTimeCost;
