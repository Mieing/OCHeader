...
@interface IESIMContactPickerNaviRightButtonSelectAllComponent : AWEIMComponentBase <IESIMContactPickerSelectAction, IESIMContactPickerNavigationBarAction, IESIMContactPickerRightButtonComponentService>

@property (retain, nonatomic) UIButton *selectAllButton;
@property (nonatomic) BOOL selectAllButtonStatus;
...
- (void)__tryUpdateSelectAllButtonStatus;
