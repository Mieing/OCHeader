@class NSString, IESLiveGiftMarketAreaSectionViewModel, UIView, IESLiveNewGiftPanelContext;

@interface IESLiveNewGiftPanelGiftMarketAreaItem : NSObject <IESLiveNewGiftPanelItemProtocol>
