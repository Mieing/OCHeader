@class AWEURLModel, AWEShareSchemaLongVideoModel, AWEShareSchemaSpecialConfigModel, NSDictionary, AWEShareSchemaVideoModel, AWEShareSchemaChallengeModel, AWEShareSchemaPOIModel, AWEShareSchemaLiveFormatModel, AWEFavoriteFolderBaseInfoModel, NSString, AWEShareSchemaPlayRemoteModel, AWEShareSchemaGoodsModel, AWEShareSchemaPOIGoodsModel, AWEShareSchemaLiveModel, AWECouponModel, AWECodeGenCommandTransLongArticleModel;
