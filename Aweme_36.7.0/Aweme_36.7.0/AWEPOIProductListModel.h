@class AWEPOIProductSecondPageModel, NSArray, NSString, NSDictionary, NSNumber;

@interface AWEPOIProductListModel : NSObject
...
@property (retain, nonatomic) AWEPOIProductSecondPageModel *secondPageModel;
