@class AWELifeFeedsBaseComponentView, NSArray;

@interface AWELifeFeedsAutoPlayPlugin : AWELifeFeedsBasePlugin

@property (weak, nonatomic) AWELifeFeedsBaseComponentView *playingView;
@property (weak, nonatomic) AWELifeFeedsBaseComponentView *resumePlayingView;
