...
@interface CJPayUnifyPayMethodCollectionView : UIView <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (id)p_subAssetTrackParamsWithModel:(id)a0 indexPath:(id)a1;
- (void)checkVisibleCellsStatus;
- (BOOL)isAssetFirstAppearWithModel:(id)a0;
- (void)p_setupUI;
- (void).cxx_destruct;
