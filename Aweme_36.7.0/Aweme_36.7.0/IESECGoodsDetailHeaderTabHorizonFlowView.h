...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })calculateSlideViewFrame;
- (void)tryRefreshTabFont;
- (void)configGradientLayerLeft:(BOOL)a0 Right:(BOOL)a1;
- (struct CGPoint { double x0; double x1; })calculateNewContentOffset;
