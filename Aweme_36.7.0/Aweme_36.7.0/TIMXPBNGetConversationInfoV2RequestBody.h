@class NSString, GPBInt64Array, TIMXPBNMemberParam;
...
@property (nonatomic) BOOL needMessage;
@property (nonatomic) BOOL hasNeedMessage;
@property (nonatomic) long long messageLimit;
@property (nonatomic) BOOL hasMessageLimit;
