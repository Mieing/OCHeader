@class AWELiveShelfPagingDataController, NSString;
@protocol AWELiveShelfListSectionControllerDelegate;

@interface AWELiveShelfListSectionController : AWEBaseListSectionController <AWEListSectionControllerDelegate>
...
@property (weak, nonatomic) id<AWELiveShelfListSectionControllerDelegate> delegate;
