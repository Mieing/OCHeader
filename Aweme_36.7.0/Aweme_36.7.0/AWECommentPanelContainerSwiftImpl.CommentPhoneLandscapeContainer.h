@interface AWECommentPanelContainerSwiftImpl.CommentPhoneLandscapeContainer : AWECommentPanelContainerSwiftImpl.CommentBaseContainer <UIGestureRecognizerDelegate> {
