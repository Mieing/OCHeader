@interface AWEPaySwiftImpl.CCMLeftSideBarPresenter : AWELeftSideBarBasePresenter <AWELeftSideBarDowngradeDisplayProtocol> {
    ...
    void /* unknown type, empty encoding */ handledDynamicData;
    void /* unknown type, empty encoding */ dynamicDataModel;
    void /* unknown type, empty encoding */ consultDataModel;
    void /* unknown type, empty encoding */ reddotStatus;
}
