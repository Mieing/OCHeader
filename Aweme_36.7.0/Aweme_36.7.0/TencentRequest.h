...
- (void)_flex_swizzle_4ff79627_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_dc55adf9_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_8c594890_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_eb9ff637_connection:(id)a0 didReceiveData:(id)a1;
