@class BDPVideoStrategyModel, NSString, NSDictionary, BDPVideoPlayerSizeModel, NSArray, NSNumber, BDPVideoDefinitionModel;
...
@property (copy, nonatomic) BDPVideoStrategyModel *videoStrategy;
