...
@property (nonatomic) BOOL hasMutualFriendDiggCount;
@property (nonatomic) long long mutualFriendCommentCount;
@property (nonatomic) BOOL hasMutualFriendCommentCount;
@property (nonatomic) long long recommendCount;
@property (nonatomic) BOOL hasRecommendCount;
@property (nonatomic) long long pickCount;
@property (nonatomic) BOOL hasPickCount;
