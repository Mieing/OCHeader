@class UIImageView, IESLLPOIDetailResponse, UILabel, IESLLModernPOIDetailCollectButton, YYLabel;

@interface IESLLPOISimilarPOIRecommendCell : UICollectionViewCell

@property (nonatomic) BOOL hasDoneInitialization;
@property (weak, nonatomic) IESLLPOIDetailResponse *poiDetail;
