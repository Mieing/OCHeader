...
@property (copy, nonatomic) NSString *iconGif;
@property (nonatomic) BOOL hasIconGif;
@property (nonatomic) int iconWidth;
@property (nonatomic) BOOL hasIconWidth;
@property (nonatomic) int iconHeight;
@property (nonatomic) BOOL hasIconHeight;
