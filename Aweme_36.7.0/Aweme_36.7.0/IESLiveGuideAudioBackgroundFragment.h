@class IESLiveLinkmicSettingApi, NSString, HTSLiveInitInfoSetting, NSDictionary, IESLiveGuideAudioThemeViewModel, CreateInfoResponse_CreateInfo, IESLiveInteractThemeManager, NSMutableArray, IESLiveGuideToolBarItem, NSNumber;
