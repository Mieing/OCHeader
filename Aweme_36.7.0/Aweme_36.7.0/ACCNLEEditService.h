@class ACCCameraSubscription, NLEInterface_OC, NSMutableDictionary, NSValue, UIView, NSMutableArray, NSString;
...
@property BOOL hasFirstRender;
@property (nonatomic) BOOL hasHandledRemoveCover;
@property (nonatomic) BOOL needHandleSensorialPlayFrameRender;
...
@property (retain, nonatomic) NSMutableArray *sensorialBlocks;
@property (retain, nonatomic) NSMutableDictionary *sensorialBlockCosts;
@property (copy, nonatomic) id /* block */ visibleFirstFrameTrackBlock;
...
- (void)removeFirstFrameRenderedIfShouldAtScene:(id)a0;
- (void)configResolver:(id)a0;
- (void)updateVideoDataFinished:(id)a0 updateType:(long long)a1 multiTrack:(BOOL)a2;
- (void)handleFirstFrameCompleteTask;
- (void)handleFirstRenderBlk;
- (void)handleSensorialPlayFrameRenderBlk;
- (void)handleFirstFrameRenderBlk;
- (void)handleFirstFrameRemoveCover;
- (void)executeSensorialBlocks;
