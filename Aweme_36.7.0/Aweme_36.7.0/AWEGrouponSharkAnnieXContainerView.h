@class AWEGrouponC2LynxPreloadModel, NSString, NSDictionary, UIView, AWEGrouponSharkLynxModel, LynxView;
@protocol AnnieXContainerBaseProtocol, AnnieXCardModelProtocol, AWEGrouponSharkLynxContainerViewDelegate;

@interface AWEGrouponSharkAnnieXContainerView : UIView <BDXContainerLifecycleProtocol, AWEGrouponSharkLynxContainerProtocol>
...
- (id)__appendCustomQueryWithSourceUrl:(id)a0;
