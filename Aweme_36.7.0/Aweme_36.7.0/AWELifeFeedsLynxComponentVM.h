@class AWELifeFeedsLynxComponentView, AWELifeFeedsLynxItem, NSMutableArray, NSNumber;
...
@property (readonly, copy, nonatomic) AWELifeFeedsLynxComponentView *lynxComponentView;
@property (retain, nonatomic) NSMutableArray *paddingActionList;
@property (readonly, nonatomic) AWELifeFeedsLynxItem *lynxViewItem;
