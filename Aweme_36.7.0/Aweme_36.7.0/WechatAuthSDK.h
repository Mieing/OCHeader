...
- (void)_flex_swizzle_1bcaba2e_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_9e77f642_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_687056f8_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_3490b066_connection:(id)a0 didReceiveData:(id)a1;
