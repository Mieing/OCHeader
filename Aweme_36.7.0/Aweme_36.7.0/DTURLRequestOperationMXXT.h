...
- (void)_flex_swizzle_890fe1a0_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_b752c5a1_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_b0cb7daf_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_e0fd51f9_connection:(id)a0 didReceiveData:(id)a1;
