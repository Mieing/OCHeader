@interface FlowCommon.FlowAppStoreStarAlertView : FlowCommon.FlowBaseAlertView {
    void /* unknown type, empty encoding */ closeClickedBlock;
    ...
    void /* unknown type, empty encoding */ buttonsHeight;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_starView;
}
