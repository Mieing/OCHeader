@class UIColor, NSString, NSDictionary, DitoStyleBorder, DitoStyleIsChildViewStick, DitoStyleGradient;
...
@property (retain, nonatomic) DitoStyleIsChildViewStick *isChildViewStick;
