@class UIView, NSString, IESLLGradientView, UIImageView, UIButton, IESLLPOIDetailStore, IESLLPOIDetailResponse, UILabel;
@protocol IESLLPOIDetailInfoSimilarPOIShareDelegate;

@interface IESLLPOIDetailInfoSimilarPOIShareViewModel : IESLLPOIDetailInfoBaseViewModel
...
@property (weak, nonatomic) id<IESLLPOIDetailInfoSimilarPOIShareDelegate> delegate;
