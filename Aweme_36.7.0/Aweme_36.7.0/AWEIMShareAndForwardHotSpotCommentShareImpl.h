@class AWEIMHotSpotCommentModel, AWEIMMessage, NSString;
@protocol IESIMShareContextProtocol;

@interface AWEIMShareAndForwardHotSpotCommentShareImpl : NSObject <AWEIMShareAndForwardToChatProtocol>

@property (retain, nonatomic) AWEIMHotSpotCommentModel *commentShareModel;
