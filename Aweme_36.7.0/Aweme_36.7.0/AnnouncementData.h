@class HintInfo, NSString, GPBInt32Array, GPBInt64Array, NSMutableArray, SubscribeInfo;
...
@property (nonatomic) BOOL highestPriority;
@property (nonatomic) long long nextLiveStartTime;
@property (copy, nonatomic) NSString *nextLiveStartTimeStr;
@property (nonatomic) BOOL isSingle;
@property (retain, nonatomic) HintInfo *hint;
