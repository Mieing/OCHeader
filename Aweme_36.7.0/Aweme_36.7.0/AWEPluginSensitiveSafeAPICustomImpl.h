...
- (id)p_jumpSceneFromJumpType:(unsigned long long)a0;
- (unsigned long long)p_aweJumpTypeFromBdpJumpType:(unsigned long long)a0;
- (unsigned long long)typeWithApiName:(id)a0;
...
- (BOOL)setPasteboardString:(id)a0 error:(id *)a1 appId:(id)a2 apiName:(id)a3;
