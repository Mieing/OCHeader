...
@interface BDSimSuperRFilter : NSObject <BDSimPreloadSuperResImpl, BDSimSuperResImpl>
...
@property (copy, nonatomic) NSArray *srTypeSwitchInfos;
...
@property (retain, nonatomic) id<BDSimPlayerBizVideoSRConfiguring> bizConfig;
...
- (BOOL)thermalMitigationSRisValid:(id)a0;
- (BOOL)awe_checkCommonPercentWithModel;
- (BOOL)__check720PercentWithModel;
- (id)__BDSimPlayer_ModelURLArrayWithModel:(id)a0 bsModel:(id)a1;
- (void).cxx_destruct;
- (id)init;
- (void)setupData;
