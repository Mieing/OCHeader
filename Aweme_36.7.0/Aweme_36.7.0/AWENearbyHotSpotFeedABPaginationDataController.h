@class NSArray, NSString, AWENearbyHotSpotTableViewController, NSMutableSet, NSMutableArray, AWENearbyHotSpotTableViewModel;
@protocol AWENearbyHotSpotFeedDataControllerDelegate, AWEHttpTask;

@interface AWENearbyHotSpotFeedABPaginationDataController : AWEListDataController <AWENearbyHotSpotFeedDataControllerProtocol>
...
@property (nonatomic) long long initialBatch;
...
@property (copy, nonatomic) NSString *feedExtraParams;
...
@property (retain, nonatomic) NSMutableSet *requestedBatches;
...
@property (nonatomic) BOOL hasLastMore;
...
- (void)requestAdditionalHotSpotDataWithBatchNumber:(long long)a0;
