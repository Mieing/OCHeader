@interface AWECommentPanelListSwiftImpl.CommentBaseFooterView : UIView {
    void /* unknown type, empty encoding */ bindingHostManager;
    ...
    void /* unknown type, empty encoding */ footerExpandTouchBeganAction;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_touchGesture;
