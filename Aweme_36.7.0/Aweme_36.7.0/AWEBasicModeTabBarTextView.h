...
@interface AWEBasicModeTabBarTextView : UIView <AWEBasicModeTabBarInnerView>

@property (nonatomic) BOOL isInTitleChangedAnimation;
@property (retain, nonatomic) UILabel *label;
@property (retain, nonatomic) id<AWEBasicModeTabBarInnerViewUIConfigProtocol> config;
