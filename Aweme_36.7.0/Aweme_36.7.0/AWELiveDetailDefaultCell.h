...
@protocol AWEFeedTableViewCellViewControllerProtocol, IESLivePlayerProtocol;

@interface AWELiveDetailDefaultCell : AWELiveEmptyTableViewCell <AWEAwemeLiveTableViewCellProtocol, AWEAwemeContainerTableViewCellPreloadProtocol> {
