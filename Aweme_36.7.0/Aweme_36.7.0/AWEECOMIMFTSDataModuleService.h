...
@protocol OS_dispatch_queue, AWEECOMIMFTSStoreServiceProtocol;

@interface AWEECOMIMFTSDataModuleService : NSObject <AWEECOMIMFTSDataServiceProtocol>

@property (retain, nonatomic) id<AWEECOMIMFTSStoreServiceProtocol> store;
