@class AWEAwemeModel, AWEGrouponWidgetViewModel, AWEGrouponWidgetView;

@interface AWEGrouponWidgetViewController : UIViewController

@property (retain, nonatomic) AWEGrouponWidgetView *widgetView;
...
@property (retain, nonatomic) AWEGrouponWidgetViewModel *viewModel;
...
- (id)__appendResourceTrackParamsWithUrlString:(id)a0;
- (id)__getAppendLifeExtraInfo;
