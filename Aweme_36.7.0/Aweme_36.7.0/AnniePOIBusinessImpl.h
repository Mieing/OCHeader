@class BDXPOILifeCycleImpl, NSString;

@interface AnniePOIBusinessImpl : NSObject <BDXBusinessProtocol, BDXServiceProtocol>

@property (retain, nonatomic) BDXPOILifeCycleImpl *containerLifeCycle;
