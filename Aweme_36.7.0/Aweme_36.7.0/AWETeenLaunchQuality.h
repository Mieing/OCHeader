...
+ (void)didColdStart;
+ (void)endLaunchSceneWithSubName:(id)a0;
+ (void)failLaunchSceneWithSubName:(id)a0 isNetworkError:(BOOL)a1 message:(id)a2 errorCode:(long long)a3;
+ (void)cancleLaunchSceneWithSubName:(id)a0 data:(id)a1;
+ (id)dataCacheManager;
+ (void)changeLastSubScene:(id)a0;
+ (void)startLaunchSceneWithSubName:(id)a0;
+ (void)cancleLaunchSceneWithSubName:(id)a0;
+ (void)changeStartDuration:(double)a0;
+ (void)startFeedApi;
+ (void)endFeedApi;
+ (void)endPlayVideo;
