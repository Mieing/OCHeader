...
- (id)requestType:(id)a0;
- (void)trackWithResponse:(id)a0 error:(id)a1 isChunk:(BOOL)a2 requestType:(id)a3;
- (void)trackChunkErrorWithResponse:(id)a0 error:(id)a1 isChunk:(BOOL)a2 requestType:(id)a3;
- (void).cxx_destruct;
- (id)init;
- (void)resetData;
- (id)requestUrl;
