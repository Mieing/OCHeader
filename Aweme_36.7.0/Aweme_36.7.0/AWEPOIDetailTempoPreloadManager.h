@class AWEPOIDetailNGPageContext, NSMutableDictionary, NSString;

@interface AWEPOIDetailTempoPreloadManager : NSObject <IESLLTempoContainerViewLifecycleDelegate>
