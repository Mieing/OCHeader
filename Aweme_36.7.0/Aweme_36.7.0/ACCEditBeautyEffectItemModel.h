@class ACCEditBeautyEffectItemExtraModel, NSString, IESEffectModel, NSMutableArray;
@protocol ACCEditBeautyEffectNodeProtocol;

@interface ACCEditBeautyEffectItemModel : NSObject <ACCEditBeautyEffectNodeProtocol>

@property (retain, nonatomic) IESEffectModel *iesEffectModel;
@property (retain, nonatomic) ACCEditBeautyEffectItemExtraModel *extra;
