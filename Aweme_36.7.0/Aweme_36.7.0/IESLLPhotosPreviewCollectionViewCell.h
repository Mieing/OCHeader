@class NSString, UIImageView, UIImage, UILabel, UIScrollView, IESLLPOILoadingView;
@protocol IESLLPhotosPreviewCollectionViewCellDelegate;

@interface IESLLPhotosPreviewCollectionViewCell : UICollectionViewCell <UIScrollViewDelegate>
...
@property (weak, nonatomic) id<IESLLPhotosPreviewCollectionViewCellDelegate> delegate;
