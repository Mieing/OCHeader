...
+ (void)scanAndSearchAlbumsWithBridgeContext:(id)a0 beginTime:(double)a1 endTime:(double)a2 count:(long long)a3 fileType:(unsigned long long)a4 needResInfo:(BOOL)a5 needTagInfo:(BOOL)a6 onlyPicWithLocation:(BOOL)a7 completionHandler:(id /* block */)a8;
+ (void)onlyScanAlbumsWithBridgeContext:(id)a0 beginTime:(double)a1 endTime:(double)a2 count:(long long)a3 fileType:(unsigned long long)a4 needResInfo:(BOOL)a5 onlyPicWithLocation:(BOOL)a6 completionHandler:(id /* block */)a7;
+ (id)getILAAssetWithBridgeContext:(id)a0 beginTime:(double)a1 endTime:(double)a2 count:(long long)a3 fileType:(unsigned long long)a4 hasLocation:(BOOL)a5;
+ (void)publishScanProgress:(id)a0 cur:(long long)a1 total:(long long)a2 bridgeContext:(id)a3;
...
+ (void)scanAlbumsWithBridgeContext:(id)a0 beginTime:(double)a1 endTime:(double)a2 count:(long long)a3 fileType:(unsigned long long)a4 needResInfo:(BOOL)a5 needTagInfo:(BOOL)a6 onlyPicWithLocation:(BOOL)a7 completionHandler:(id /* block */)a8;
+ (void)searchTagsClusterFromLocalIds:(id)a0 tagsAssetCount:(long long)a1 bridgeContext:(id)a2 completionHandler:(id /* block */)a3;
+ (id)scanAlbumsExifInfoFromLocalIds:(id)a0 beginTime:(double)a1 endTime:(double)a2 page:(long long)a3 count:(long long)a4 noTrans:(unsigned char)a5 bridgeContext:(id)a6;
