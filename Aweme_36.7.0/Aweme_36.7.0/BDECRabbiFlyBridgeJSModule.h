@class JSWorkerBridge, NSString, NSDictionary, JSWorkerBridgeEngine, BDECRabbiFlyDynamicSupervisor;

@interface BDECRabbiFlyBridgeJSModule : NSObject <BDECRabbiFlyIJSModule>
