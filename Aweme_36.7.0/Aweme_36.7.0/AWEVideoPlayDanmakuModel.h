@class UIFont, NSString, UIImage, NSArray, AWECodeGenActivityGuideModel, AWEDanmakuPendantMaterial, NSDictionary, AWEDanmakuExtraModel, NSMutableAttributedString, NSRegularExpression, AWEDanmakuEggMaterial, AWEDanmakuModel;
...
@property (nonatomic) BOOL isPickCountDanmaku;
...
@property (copy, nonatomic) NSArray *prefixImageURLList;
