@class AWEInnerPushCommonViewModel, AWEGrouponInnerPushModel, UIImageView, NSString, AWEInnerPushCommonView, UIView, AWEInnerNotificationRequest;
@protocol AWEInnerNotificationContentOperator;

@interface AWEGrouponInnerPushContent : NSObject <AWENearbyContainerEventMessage, AWEInnerNotificationContent>
...
@property (retain, nonatomic) AWEGrouponInnerPushModel *innerPushModel;
