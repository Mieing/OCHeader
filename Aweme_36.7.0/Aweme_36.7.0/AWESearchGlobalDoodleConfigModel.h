@class AWESearchFeelGoodEntranceIconModel, NSString, AWESearchGoodsFeedbackModel, AWESearchNoResultModel, NSArray, AWESearchFeelGoodModel, NSDictionary, AWESearchGSInfoModel, AWESearchGlobalCartModel, AWEEcomSearchInsertCouponConfigModel;
