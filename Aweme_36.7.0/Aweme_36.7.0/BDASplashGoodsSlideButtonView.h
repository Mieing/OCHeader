@class CALayer, BDASplashGoodsSlideButtonViewModel, BDASplashComplianceButtonView, BDImageView, UIView, BDASplashComplianceSlideUpTipsView, UILabel;
...
@property (retain, nonatomic) CALayer *goodsBorderLayer;
...
@property (retain, nonatomic) BDImageView *atmosphereAnimationView;
