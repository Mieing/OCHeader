@class NSString, AWEFeedNearbyCardCellViewController, AWEAwemeModel, UIView, UIViewController;
@protocol UIScrollViewDelegate;

@interface AWEFeedNearbyCardTableViewCell : UITableViewCell <AWEFeedTableViewCellProtocol>

@property (retain, nonatomic) AWEFeedNearbyCardCellViewController *viewController;
