@class AWENearbyPageContext, AWENearbyC2FeedDataController, NSString, AWENearbyGrouponResponse, NSNumber;

@interface AWENearbyGrouponTabListViewModel : NSObject <AWENearbyGrouponTabFeedDelegate>
...
@property (retain, nonatomic) AWENearbyGrouponResponse *response;
