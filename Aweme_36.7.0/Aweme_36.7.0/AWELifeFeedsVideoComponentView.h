@class NSString, AWELifeFeedsVideoComponentVM, AWENearbyPaddingLabel, UIImageView, AWEGradientView, AWEBinding, NSObject, AWELifeFeedsUserInfoView, AWENearbyC2FeedDualAnchorView, UILabel, UIViewController;
...
@interface AWELifeFeedsVideoComponentView : AWELifeFeedsBaseComponentView <AWEPlayVideoDelegate, AWEAwemeDetailTableViewControllerDelegate>
...
@property (retain, nonatomic) AWELifeFeedsVideoComponentVM *videoViewModel;
...
- (id)fittedLineTextForLabel:(id)a0 withOriginalText:(id)a1 labelWidth:(float)a2;
- (void).cxx_destruct;
- (void)pause;
- (BOOL)canPlay;
