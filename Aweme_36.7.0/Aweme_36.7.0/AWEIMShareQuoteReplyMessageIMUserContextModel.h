@class AWEIMUser, AWECommentModel, NSDictionary, AWEAwemeModel, AWEIMNoticeQuickReplyModel, AWEUserModel, NSString;
@protocol AWEIMShareModelProtocol;

@interface AWEIMShareQuoteReplyMessageIMUserContextModel : AWEIMShareQuoteReplyMessageContextModel <AWEIMShareQuoteReplyMessageIMUserContextModelProtocol>
