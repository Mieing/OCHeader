@class AWEFeedNearbyShopCardCellViewController, NSString, AWEAwemeModel, UIView, UIViewController;
@protocol UIScrollViewDelegate;

@interface AWEFeedNearbyShopCardTableViewCell : UITableViewCell <AWEFeedTableViewCellProtocol>

@property (retain, nonatomic) AWEFeedNearbyShopCardCellViewController *viewController;
