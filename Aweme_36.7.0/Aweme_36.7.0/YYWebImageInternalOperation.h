...
- (void)_flex_swizzle_b74e573e_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_d336fa63_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_fe2f3fdc_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_e8324b2f_connection:(id)a0 didReceiveData:(id)a1;
