@class IESECImageXReplaceTemplatesAllConfig, NSArray, NSDictionary, NSMutableDictionary, IESECImageXReplaceFormatsConfigs, NSString;

@interface IESECImageXServiceManager : NSObject <IESECImageXServiceInterface>

@property (nonatomic) BOOL enableFirstConvergeHost;
@property (copy, nonatomic) NSArray *firstConvergePathPatterns;
@property (nonatomic) BOOL firstConvergeHostReachable;
...
- (id)p_kFirtConvergeDomain;
- (id)p_groupNameForDomain:(id)a0;
- (id)p_findDomainKey:(id)a0;
