@class NSString, NSDictionary, IESLLLiveShelfCacheManager;
@protocol IESLLHttpTask;

@interface IESLLLiveShelfViewModel : NSObject
...
@property (weak, nonatomic) IESLLLiveShelfCacheManager *cacheManager;
