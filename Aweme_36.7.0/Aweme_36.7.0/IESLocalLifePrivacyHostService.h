...
@interface IESLocalLifePrivacyHostService : HTSService <IESLocalLifePrivacyHostService>
...
- (id)iesll_bpea_apiContext:(id)a0 fromBDXBridgeMethod:(id)a1;
- (id)iesll_bpea_pageContext:(id)a0 fromBDXBridgeMethod:(id)a1;
