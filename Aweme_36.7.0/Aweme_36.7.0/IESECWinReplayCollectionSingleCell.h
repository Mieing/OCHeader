@class CAGradientLayer, NSString, IESECLLView, IESECWinReplayCollectionObject;
@protocol IESECWinReplayCollectionCellDelegate;

@interface IESECWinReplayCollectionSingleCell : UICollectionViewCell <IESECWinReplayCollectionCellProtocol, IESECWinReplayCollectionCardViewModelDelegate> {
    IESECWinReplayCollectionObject *_object;
}

@property (retain, nonatomic) IESECLLView *llView;
@property (retain, nonatomic) CAGradientLayer *linearGradientLayer;
@property (retain, nonatomic) CAGradientLayer *radialGradientLayer1;
@property (retain, nonatomic) CAGradientLayer *radialGradientLayer2;
