@class NSString, AWEGrouponLifeFeedsLynxEmbeddedCardModel;

@interface AWEGrouponLifeFeedsLynxEmbeddedPreloadDataSource : NSObject <AWEGrouponLifeFeedsLynxEmbeddedCardDataSource>
