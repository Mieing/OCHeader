@class AWEGrouponTaskFeedPartialRefreshModel;

@interface AWEGrouponTaskFeedPartialRefresh : AWEGrouponBaseTask

@property (copy, nonatomic) id /* block */ block;
@property (retain, nonatomic) AWEGrouponTaskFeedPartialRefreshModel *refreshModel;
