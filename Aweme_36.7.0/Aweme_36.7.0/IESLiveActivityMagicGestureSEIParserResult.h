@class IESLiveInteractionCropData, NSString, NSDictionary, HTSInteractionStreamAppData, IESLiveActivityMagicGestureModel;

@interface IESLiveActivityMagicGestureSEIParserResult : NSObject <IESLiveSEIParserResult>

@property (retain, nonatomic) IESLiveActivityMagicGestureModel *magicGestureModel;
