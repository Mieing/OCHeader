@class NSString, NSArray, IESLLLiveShelfPagingDataController, IESLLLiveShelfCardElementLotteryModel, NSDictionary, IESLLLiveShelfCardElementModel, IESLLLiveShelfCardElementSoldCountModel, NSMutableAttributedString, YYWebImageOperation;

@interface IESLLLiveShelfListGoodsCellModel : NSObject
