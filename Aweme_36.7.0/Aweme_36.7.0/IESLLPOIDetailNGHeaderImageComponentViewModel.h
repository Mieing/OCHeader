@class NSString, NSArray, IESLLPOIDetailHeaderImageComponentBaseView;

@interface IESLLPOIDetailNGHeaderImageComponentViewModel : LLDitoComponentViewModel
...
@property (weak, nonatomic) IESLLPOIDetailHeaderImageComponentBaseView *componentView;
