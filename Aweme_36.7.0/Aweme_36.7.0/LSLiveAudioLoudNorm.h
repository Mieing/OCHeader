...
- (void)processAudioData:(short *)a0 channels:(int)a1 inNumberFrames:(unsigned int)a2;
- (id)initOffLineWithSample:(int)a0 channels:(int)a1 useSingleChannel:(BOOL)a2;
- (id)initWithSample:(int)a0 channels:(int)a1 useSingleChannel:(BOOL)a2;
- (void)setLoudNormParams:(id)a0 value:(float)a1;
