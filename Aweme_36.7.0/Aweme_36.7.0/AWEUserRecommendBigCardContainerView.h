@class UIView, UILongPressGestureRecognizer, NSString, AWEUserRecommendBigCardViewModel, AWEBinding, UIImageView, NSDictionary, CAGradientLayer, AWEUserRecommendBigCardView, UIViewController, AWEUserRecommendBigCardFooterView;
