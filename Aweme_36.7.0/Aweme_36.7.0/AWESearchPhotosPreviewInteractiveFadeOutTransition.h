...
@protocol AWESearchPhotosPreviewFadeInTransitionContextProvider, AWESearchPhotosPreviewFadeOutTransitionContextProvider;

@interface AWESearchPhotosPreviewInteractiveFadeOutTransition : NSObject <AWETransitionContextProvider>
...
@property (retain, nonatomic) UIViewController<AWESearchPhotosPreviewFadeOutTransitionContextProvider> *fromCP;
@property (retain, nonatomic) UIViewController<AWESearchPhotosPreviewFadeInTransitionContextProvider> *toCP;
