...
@interface AWETitleZoomOutShowState : NSObject <AWETitleInputZoomStateProtocol>
...
- (void)handleAdditionViewHideNewPreviewLayoutVersion:(id /* block */)a0;
- (void)handleAdditionViewHideOldVersion:(id /* block */)a0;
- (void).cxx_destruct;
