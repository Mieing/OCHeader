@class IESLLTempoAnimationContext, NSString, IESLLTempoContext, AWEPOITempoPOINameView, UIView, NSMutableArray;
@protocol IESLLTempoNodeProtocol, IESLLTempoWidgetProtocol;

@interface AWEPOITempoPOINameWidget : IESLLTempoBaseWidget <IESLLTempoWidgetProtocol>

@property (weak, nonatomic) AWEPOITempoPOINameView *nodeView;
