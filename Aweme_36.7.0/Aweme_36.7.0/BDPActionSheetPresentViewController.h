@class UIColor, BDPActionSheet, NSString, UIViewController;

@interface BDPActionSheetPresentViewController : UIViewController <UIViewControllerTransitioningDelegate>
...
@property (retain, nonatomic) BDPActionSheet *actionSheet;
