@class NSDictionary, IESLLLiveCardRawDataModel, NSString;

@interface IESLLLiveExpoundCardSchemaHandler : NSObject

@property (copy, nonatomic) NSDictionary *liveRoomParams;
@property (retain, nonatomic) IESLLLiveCardRawDataModel *cardInfo;
