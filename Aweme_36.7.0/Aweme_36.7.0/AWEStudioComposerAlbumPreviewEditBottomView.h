@class AWEStudioComposerAlbumEditBottomBar, NSString, UIVisualEffectView, UILabel, UIButton;

@interface AWEStudioComposerAlbumPreviewEditBottomView : UIView <CAKAlbumPreviewPageBottomViewProtocol>

@property (readonly, nonatomic) AWEStudioComposerAlbumEditBottomBar *bar;
