@class AWEGDCommonContentVOModel, NSMutableDictionary, MASViewAttribute, AWEGDCommonContentComponentViewModel, UIView, NSMutableArray;

@interface AWEGDCommonContentComponentView : DitoComponentView

@property (weak, nonatomic) AWEGDCommonContentComponentViewModel *viewModel;
