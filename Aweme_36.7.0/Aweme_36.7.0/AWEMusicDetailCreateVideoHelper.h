...
- (void)createOneClickFilmWithSchemaString:(id)a0;
...
- (void)createVideo:(id)a0 info:(id)a1 inspirationModel:(id)a2;
...
- (void)startComposerWithPropModel:(id)a0 musicModel:(id)a1 trackInfo:(id)a2;
