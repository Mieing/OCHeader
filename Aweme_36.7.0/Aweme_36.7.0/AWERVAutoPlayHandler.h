...
@protocol AWERVAutoPlayContainerProtocol, AWERVAutoPlayCardProtocol;

@interface AWERVAutoPlayHandler : NSObject <UIScrollViewDelegate>

@property (weak, nonatomic) id<AWERVAutoPlayContainerProtocol> container;
@property (weak, nonatomic) UIView<AWERVAutoPlayCardProtocol> *currentActiveView;
...
@property (weak, nonatomic) UIView<AWERVAutoPlayCardProtocol> *currentTransitionActiveView;
...
@property (weak, nonatomic) AWERVAutoPlayHandler *superHandler;
