...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_cropViewFrame:(long long)a0;
...
- (void)updateCropView:(long long)a0;
- (double)calcScalueWithCropInfo:(id)a0;
- (struct CGPoint { double x0; double x1; })calcContentOffsetWithCropInfo:(id)a0;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 cropInfo:(id)a1;
