@class UIColor, NSString, NLETextTemplateClip_OC, AEKFontResource, NLETrackSlot_OC, NLESegmentTextTemplate_OC;
@protocol AEKTextStickerClipData, AEKTextStickerClipExtraData;

@interface AEKTextStickerClipOperatorImpl : AEKBaseRenderEditor <AEKTextStickerClipData, AEKTextStickerClipOperator>
...
@property (readonly, nonatomic) id<AEKTextStickerClipExtraData> extra;
...
@property (readonly, nonatomic) id<AEKTextStickerClipData> data;
