...
@property (nonatomic) int redirectFrom;
@property (retain, nonatomic) HTSLiveChangeRoomInfo *changeRoomInfo;
@property (nonatomic) BOOL hasChangeRoomInfo;

+ (id)descriptor;

- (id)metricTrackerDataListArray;
- (id)anchorTogetherLive;
- (BOOL)hasChangeRoomInfo;
- (id)vrInfo;
- (id)groupLiveData;
