...
- (id)buildParamsOfNode:(id)a0 withSchema:(id)a1 variables:(id)a2 globalProps:(id)a3 percentEscapes:(BOOL)a4;
- (id)paramsOfNode:(id)a0 withSchema:(id)a1 variables:(id)a2 globalProps:(id)a3 percentEscapes:(BOOL)a4;
