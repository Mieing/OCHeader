@class MASConstraint, IESLLPOIDetailNGPageContext, UIImageView, UILabel, UIView, UIButton;

@interface IESLLPOIDetailNGSketchComponentView : LLDitoComponentView
...
@property (readonly, nonatomic) IESLLPOIDetailNGPageContext *ngPageContext;
