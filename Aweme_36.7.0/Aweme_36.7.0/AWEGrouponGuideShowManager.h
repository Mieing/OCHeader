...
@protocol AWEMessageReachVideoGuideDelegate, AWEGrouponGeneralGiudeHandleProtocol;

@interface AWEGrouponGuideShowManager : NSObject <AWENearbyContainerEventMessage, AWENearbyGuideBubbleProtocol, AWEMRGrouponGuideShowCheckDelegateProtocol>
...
@property (retain, nonatomic) NSMutableArray<AWEGrouponGeneralGiudeHandleProtocol> *guideHandlers;
