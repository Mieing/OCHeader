@class NSString, NSMutableDictionary, TIMXPBNConversationInfoV2;
...
@property (retain, nonatomic) NSMutableDictionary *msgTags;
@property (readonly, nonatomic) unsigned long long msgTags_Count;
