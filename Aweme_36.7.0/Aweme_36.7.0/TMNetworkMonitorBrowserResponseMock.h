@class NSDictionary, NSString, TMNetworkContentDetectItem;

@interface TMNetworkMonitorBrowserResponseMock : NSObject <TMNetworkAspectResponseProtocol>

@property (retain, nonatomic) TMNetworkContentDetectItem *originItem;
...
- (id)initWithItem:(id)a0 bid:(id)a1 params:(id)a2;
- (void).cxx_destruct;
