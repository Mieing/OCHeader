@class NSString, NSMutableDictionary, AWENearbyIconNoticeManagerEvader;

@interface AWENearbyIconNoticeManager : NSObject <AWEUGDesktopChannelGuideMessage>

@property (retain, nonatomic) AWENearbyIconNoticeManagerEvader *grouponEvader;
@property (retain, nonatomic) AWENearbyIconNoticeManagerEvader *nearbyEvader;
