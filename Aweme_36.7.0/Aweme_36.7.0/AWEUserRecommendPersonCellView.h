@class AWEMultiAvatarView, UIView, UIAccessibilityCustomAction, AWEUserRecommendPersonCellModel, AWEUserModel, AWEBinding, UIButton, AWEUserButtonStateMachine, NSString, AFDColorRingView;
@protocol AFDColorRingFacadeProtocol, AWEUserRecommendTableViewModelProtocol;
...
- (BOOL)enableShowStory25ColorRing:(id)a0;
