@interface AWEStoryImpl.StoryListControllerManager : AWEShellControllerManager <AWEBaseListUpdateDelegate, UIScrollViewDelegate, AWEStoryImpl.StoryListControllerViewLifeCycle> {
