...
@property (copy, nonatomic) NSNumber *currentPoints;
@property (copy, nonatomic) NSNumber *lastPoint;
...
@property (copy, nonatomic) NSNumber *strategyTargetProgress;
...
- (void)updateRequestProgressPoints:(id)a0;
