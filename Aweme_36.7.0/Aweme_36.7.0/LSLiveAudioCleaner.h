...
- (void)resetBufferQueue:(struct AudioBufferQueue { float *x0; unsigned int x1; } *)a0;
...
- (void)createBufferQueue:(struct AudioBufferQueue { float *x0; unsigned int x1; } *)a0;
- (void)freeBufferQueue:(struct AudioBufferQueue { float *x0; unsigned int x1; } *)a0;
- (void)pushQueue:(struct AudioBufferQueue { float *x0; unsigned int x1; } *)a0 srcData:(float *)a1 dataSize:(unsigned int)a2;
- (int)dequeue:(struct AudioBufferQueue { float *x0; unsigned int x1; } *)a0 dstData:(float *)a1 outputSize:(unsigned int)a2;
- (void).cxx_destruct;
- (void)dealloc;
