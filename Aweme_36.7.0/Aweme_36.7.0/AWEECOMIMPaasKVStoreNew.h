@class NSString, BDECPigeonKVStore;

@interface AWEECOMIMPaasKVStoreNew : NSObject <AWEECOMIMPaasKVStoreProtocol>

@property (retain, nonatomic) BDECPigeonKVStore *store;
