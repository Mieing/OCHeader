...
- (void)_flex_swizzle_b0316f63_connection:(id)a0 didFailWithError:(id)a1;
- (void)_flex_swizzle_ad3fdf39_connectionDidFinishLoading:(id)a0;
- (void)_flex_swizzle_e466c5fa_connection:(id)a0 didReceiveResponse:(id)a1;
- (void)_flex_swizzle_9d2eb9a7_connection:(id)a0 didReceiveData:(id)a1;
