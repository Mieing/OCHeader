...
- (BOOL)hasGrowthTask;
- (BOOL)hasPreviewImExtend;
- (BOOL)hasPreviewExtendArea;
- (id)chatMsgsArray;
- (id)metasArray;
- (id)etDataArray;
- (BOOL)showPreviewCards;
- (BOOL)isAwemeVideoFeed;
- (int)showNameAbbreviation;
- (int)showUvPv;
- (id)iosClientComponent;
- (id)previewIntro;
- (BOOL)hasPreviewGuide;
- (int)messageScrollIntervalMs;
- (int)messageScrollAfterMs;
- (int)scrollAfterMs;
- (int)style;
- (int)isPreviewUseWebsocket;
- (BOOL)hasEnterPublicAreaAnimation;
- (BOOL)hasSwitch_p;
- (id)previewExtendArea;
- (id)portraitData;
- (id)previewExitGuideListArray;
- (id)previewExitGuide;
- (void)setShowPreviewCards:(BOOL)a0;
- (id)feedLiveIdeaGuide;
- (id)feedPromoteLiveAnchorPoint;
- (id)previewPromotion;
- (id)enterPublicAreaAnimation;
- (void)setScrollAfterMs:(int)a0;
