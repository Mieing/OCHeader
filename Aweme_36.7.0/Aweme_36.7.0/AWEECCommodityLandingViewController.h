@class AWEECCommodityLandingBottomBar, NSString, NSArray, AWEECCommodityLandingHeaderModel, AWEECCommodityLandingConfiguration, NSDictionary, UICollectionView, TrackerService, AWEECCommodityLandingVideoManager, DUXPopover;
