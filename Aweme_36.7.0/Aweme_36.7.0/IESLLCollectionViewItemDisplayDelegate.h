...
@interface IESLLCollectionViewItemDisplayDelegate : NSProxy <UICollectionViewDelegate>

@property (nonatomic) struct __CFRunLoopObserver { } *sleepObserver;
@property (weak, nonatomic) UICollectionView *collectionView;
@property (weak, nonatomic) id<IESLLCollectionViewItemDisplayDelegateTarget> target;
