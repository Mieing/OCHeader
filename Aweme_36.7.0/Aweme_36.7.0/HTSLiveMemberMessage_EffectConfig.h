@class NSNumber, NSString, HTSLiveImage, NSMutableDictionary, HTSLiveEnterEffectConfig, NSMutableArray, GPBInt64Array, HTSLiveText;
...
@property (retain, nonatomic) NSMutableArray *badgeListArray;
