@class UITapGestureRecognizer, NSString, UILongPressGestureRecognizer, UIColor, CALayer, IESIMTextKitLabel, UIView;
@protocol IESIMTextKitSelectableDelegate;

@interface IESIMTextKitSelectable : UIView <AWEIMSelectableLabelProtocol, UIGestureRecognizerDelegate>
...
@property (weak, nonatomic) IESIMTextKitLabel *label;
@property (weak, nonatomic) CALayer *overlayer;
@property (weak, nonatomic) UIView *interactView;
...
@property (weak, nonatomic) id<IESIMTextKitSelectableDelegate> delegate;
@property (retain, nonatomic) NSString *identifier;
@property (nonatomic) BOOL enableHitTestReturnInteractView;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
