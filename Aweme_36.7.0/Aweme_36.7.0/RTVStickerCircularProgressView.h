@class UIColor, _RTVStickerCircularProgressViewKVOObject;

@interface RTVStickerCircularProgressView : UIView

@property (retain, nonatomic) _RTVStickerCircularProgressViewKVOObject *kvoObject;
