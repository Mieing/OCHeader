@class AWEAwemeModel, NSString, IESLLPOICityDetailAwemeComponentView;

@interface IESLLPOICityDetailAwemeComponentViewModel : LLDitoComponentViewModel <IESLLPOISyncFeedExtensionGetModelProtocol, IESLLPOIDetailNGViewModelZoomTransitionProtocol>

@property (nonatomic) BOOL hasTracked;
@property (nonatomic) double height;
@property (weak, nonatomic) IESLLPOICityDetailAwemeComponentView *cell;
