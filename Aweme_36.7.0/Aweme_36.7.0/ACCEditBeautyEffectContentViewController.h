@class NSArray, UICollectionView, NSString, ACCEditBeautyEffectVCContext;

@interface ACCEditBeautyEffectContentViewController : UIViewController <UICollectionViewDelegateFlowLayout, UICollectionViewDataSource>

@property (retain, nonatomic) UICollectionView *collectionView;
@property (copy, nonatomic) NSArray *cellModels;
@property (weak, nonatomic) ACCEditBeautyEffectVCContext *uiContext;
...
@property (nonatomic) BOOL isFirstShowPanelStatus;
