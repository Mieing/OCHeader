@class NSString, UIImageView, UIImage, UILabel, UIScrollView, DUXLoadingParticleView;
@protocol AWESearchPhotosPreviewCollectionViewCellDelegate;

@interface AWESearchPhotosPreviewCollectionViewCell : UICollectionViewCell <UIScrollViewDelegate>
...
@property (weak, nonatomic) id<AWESearchPhotosPreviewCollectionViewCellDelegate> delegate;
