@class NSString, IESECShopClassificationGoodsEventHandler, IESECShopEmptySectionController, IESECShopClassificationGoodsListSectionController, IESECQualityInfoV2, IESECShopFilterSectionController;

@interface IESECShopClassifyProductSectionViewController : IESECShopGoodsViewController <IESECShopProductsEnvironmentalContext> {
...
@property (copy, nonatomic) NSString *customIdVc;
