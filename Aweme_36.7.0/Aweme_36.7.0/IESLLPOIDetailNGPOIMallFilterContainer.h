@class IESLLDitoPOIMallPageContext, NSString, UIImageView, UILabel, IESLLPOIDetailNGPOIMallFilterContentView, UIButton;
@protocol IESLLPOIDetailNGPOIMallFilterClickDelegate;

@interface IESLLPOIDetailNGPOIMallFilterContainer : UIView <IESLLDitoPOIMallTableViewFilterContentViewDelegate>
...
@property (retain, nonatomic) IESLLPOIDetailNGPOIMallFilterContentView *filterTableView;
@property (retain, nonatomic) IESLLDitoPOIMallPageContext *context;
@property (nonatomic) BOOL isShow;
@property (copy, nonatomic) id /* block */ onSelectBlock;
@property (weak, nonatomic) id<IESLLPOIDetailNGPOIMallFilterClickDelegate> delegate;
