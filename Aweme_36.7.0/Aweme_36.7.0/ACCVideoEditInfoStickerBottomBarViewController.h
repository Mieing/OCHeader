...
@interface ACCVideoEditInfoStickerBottomBarViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource>
...
@property (weak, nonatomic) id<ACCVideoEditInfoStickerBottomBarVCDelegate> delegate;
