...
@interface AWERewardPermissionItem : NSObject <AWEAfterPublishAdvanceSettingItemProtocol>
...
- (void)__postRewardPermissionSetting:(id)a0 withCompletion:(id /* block */)a1;
- (void).cxx_destruct;
