@class NSString, LLDitoPageContext, NSNumber, LLDitoLynxComponentViewModelV2;

@interface IESLLPOILynxContainerViewV2 : IESLLPOILynxContainerView <LLDitoLynxContainerProtocol>

@property (weak, nonatomic) LLDitoLynxComponentViewModelV2 *lynxViewModel;
@property (retain, nonatomic) NSNumber *lastScrollViewOffsetY;
@property (weak, nonatomic) LLDitoPageContext *ditoPageContext;
...
- (void)subscribeSwitchLLDitoEvent;
- (void).cxx_destruct;
