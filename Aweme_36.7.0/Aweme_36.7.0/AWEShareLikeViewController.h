...
@protocol AWEShareSelectDelegate, AWEUserLikesDataManagerProtocol;

@interface AWEShareLikeViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>

@property (retain, nonatomic) AWEUserModel *currUser;
@property (retain, nonatomic) NSObject<AWEUserLikesDataManagerProtocol> *dataManager;
