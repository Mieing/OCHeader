@class NSArray, UICollectionView, NSString, AWEBeautyVCContext;

@interface AWEBeautyContentViewController : UIViewController <UICollectionViewDelegateFlowLayout, UICollectionViewDataSource>

@property (retain, nonatomic) UICollectionView *collectionView;
@property (copy, nonatomic) NSArray *cellModels;
@property (weak, nonatomic) AWEBeautyVCContext *uiContext;
