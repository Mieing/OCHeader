@class IESLLWaterFallCollectionController;

@interface IESLLWaterFallSectionCollectionContext : NSObject

@property (weak, nonatomic) IESLLWaterFallCollectionController *collectionController;
