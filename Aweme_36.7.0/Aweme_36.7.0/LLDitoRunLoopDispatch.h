@class LLDitoRunLoopDispatchConfig, NSMutableArray, NSObject;
@protocol OS_dispatch_semaphore;

@interface LLDitoRunLoopDispatch : NSObject
...
@property (retain, nonatomic) LLDitoRunLoopDispatchConfig *config;
