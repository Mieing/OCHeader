@class NSArray, UICollectionView, NSString, UIView, RxCollectionViewDiffableDataSource;
@protocol AWEIMInputActionBarDelegate;

@interface AWEIMInputActionBarFansGroupEntryView : UIView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AWEIMInputActionBarProtocol>
...
- (struct CGSize { double x0; double x1; })__sizeForItem:(id)a0;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 entryItems:(id)a1 isOwner:(BOOL)a2;
