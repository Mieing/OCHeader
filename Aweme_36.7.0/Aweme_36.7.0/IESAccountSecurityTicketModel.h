@class NSString, IESAccountBindMobileAlertModel;

@interface IESAccountSecurityTicketModel : MTLModel <MTLJSONSerializing>
...
@property (retain, nonatomic) IESAccountBindMobileAlertModel *bindMobileAlertModel;
