...
- (int)readPacket:(unsigned int *)a0 ioData:(struct AudioBufferList { unsigned int x0; struct AudioBuffer { unsigned int x0; unsigned int x1; void *x2; } x1[1]; } *)a1 description:(struct AudioStreamPacketDescription **)a2;
- (id)initWithURL:(id)a0 processError:(id /* block */)a1;
- (void).cxx_destruct;
