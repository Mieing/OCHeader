@class NSString, NSDictionary, AWEGrouponCommonFrequencyData;

@interface AWEGrouponInnerPushModel : MTLModel <MTLJSONSerializing>
...
@property (copy, nonatomic) AWEGrouponCommonFrequencyData *frequencyData;
