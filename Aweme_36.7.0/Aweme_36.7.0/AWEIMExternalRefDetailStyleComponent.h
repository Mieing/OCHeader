...
@interface AWEIMExternalRefDetailStyleComponent : AWEIMFlexComponent <AWEIMComponentContainer, AWEIMComponentManagerDependency, AWEIMExternalRefDetailStyleInterface>
...
- (BOOL)isNontextMateApplyReplyMsg:(id)a0;
