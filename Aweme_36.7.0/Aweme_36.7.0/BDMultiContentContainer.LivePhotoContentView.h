@interface BDMultiContentContainer.LivePhotoContentView : UIView <UIGestureRecognizerDelegate, UIScrollViewDelegate> {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_livePhotoPlayer;
