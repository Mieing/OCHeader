@class NSArray, NSString, NSDictionary, NSURL, IESEffectModel, UIImage, NSNumber;

@interface ACCBrushDVEResourceModel : NSObject <DVEResourceModelProtocol>

@property (copy, nonatomic) NSDictionary *cacheExtraDict;
@property (retain, nonatomic) IESEffectModel *effectModel;
@property (nonatomic) BOOL isBasicBrush;
@property (nonatomic) BOOL asBrushEntrance;
