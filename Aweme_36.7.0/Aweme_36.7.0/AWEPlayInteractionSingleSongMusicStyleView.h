...
@interface AWEPlayInteractionSingleSongMusicStyleView : UIView <AWEPlayInteractionMusicViewProtocol>
...
@property (retain, nonatomic) UIView *playInteractionColorMaskView;
