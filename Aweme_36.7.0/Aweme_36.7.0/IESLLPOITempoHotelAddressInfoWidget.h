@class IESLLPOITempoHotelAddressInfoView, IESLLTempoAnimationContext, IESLLTempoContext, NSString, UIView, NSMutableArray;
@protocol IESLLTempoNodeProtocol, IESLLTempoWidgetProtocol;

@interface IESLLPOITempoHotelAddressInfoWidget : IESLLTempoBaseWidget <IESLLTempoWidgetProtocol>

@property (weak, nonatomic) IESLLPOITempoHotelAddressInfoView *nodeView;
