...
- (void)handlePreloadData:(id)a0 model:(id)a1 presend:(BOOL)a2 scene:(unsigned long long)a3 error:(id)a4;
- (void)removePreloadStateForKey:(id)a0 inScene:(id)a1;
- (void)preloadRewardData:(id)a0 presend:(BOOL)a1 preferCache:(BOOL)a2 params:(id)a3 inScene:(unsigned long long)a4 completion:(id /* block */)a5;
